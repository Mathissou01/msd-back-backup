...
const LeafletMap = () => {
  ...
  async function toGeoJSON() {
    ...
    if (collection.features.length > 0) {
      console.log("GeoJSON Collection", collection);
    ...
    <div className={"c-LeafletMap"}>
      ...
      >
        ...
        <FeatureGroup ref={layerRef}>
          <EditControl position={"topright"} draw={{ rectangle: false }} />
        </FeatureGroup>
      </MapContainer>
      <button onClick={toGeoJSON} className={"c-LeafletMap__Button"}>
        Récupérer Adresses
      </button>
      ;
      <div className={"c-LeafletMap__Results"}>
