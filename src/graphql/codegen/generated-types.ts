...
export type AccessibilityBlocksDynamicZone = ComponentBlocksFile | ComponentBlocksHorizontalRule | ComponentBlocksSubHeading | ComponentBlocksWysiwyg | Error;
...
export type CguBlocksDynamicZone = ComponentBlocksFile | ComponentBlocksHorizontalRule | ComponentBlocksSubHeading | ComponentBlocksWysiwyg | Error;
...
export type ConfidentialityBlocksDynamicZone = ComponentBlocksFile | ComponentBlocksHorizontalRule | ComponentBlocksSubHeading | ComponentBlocksWysiwyg | Error;
...
export type ContactUsBlocksDynamicZone = ComponentBlocksFile | ComponentBlocksHorizontalRule | ComponentBlocksImage | ComponentBlocksSubHeading | ComponentBlocksVideo | ComponentBlocksWysiwyg | Error;
...
export type ContractAndClientContact = ClientContactCreateOutput | ContractCreateOutput;
...
export type ContractMenuInput = {
  contract?: InputMaybe<Scalars['ID']>;
  serviceLinks?: InputMaybe<Array<Scalars['ContractMenuServiceLinksDynamicZoneInput']>>;
};

export type ContractMenuServiceLinksDynamicZone = ComponentLinksAlertNotification | ComponentLinksContactUs | ComponentLinksDropOffMap | ComponentLinksEvents | ComponentLinksExternal | ComponentLinksFrees | ComponentLinksKeyMetrics | ComponentLinksMyWasteCounter | ComponentLinksNews | ComponentLinksPickUpDay | ComponentLinksQuizzes | ComponentLinksRecyclingGuide | ComponentLinksRequest | ComponentLinksTips | Error;
...
export type CookieBlocksDynamicZone = ComponentBlocksFile | ComponentBlocksHorizontalRule | ComponentBlocksSubHeading | ComponentBlocksWysiwyg | Error;
...
export type DropOffMap = {
  ...
  name?: Maybe<Scalars['String']>;
  openingHoursBlock?: Maybe<Array<Maybe<DropOffMapOpeningHoursBlockDynamicZone>>>;
  phoneNumber?: Maybe<Scalars['String']>;
  updatedAt?: Maybe<Scalars['DateTime']>;
};
...
export type DropOffMapInput = {
  ...
  description?: InputMaybe<Scalars['String']>;
  downloadableFile?: InputMaybe<Array<InputMaybe<ComponentBlocksDownloadBlockInput>>>;
  dropOffMapService?: InputMaybe<Scalars['ID']>;
  gpsCoordinates?: InputMaybe<Scalars['String']>;
  mustKnow?: InputMaybe<Scalars['String']>;
  name?: InputMaybe<Scalars['String']>;
  openingHoursBlock?: InputMaybe<Array<Scalars['DropOffMapOpeningHoursBlockDynamicZoneInput']>>;
  phoneNumber?: InputMaybe<Scalars['String']>;
};

export type DropOffMapOpeningHoursBlockDynamicZone = ComponentBlocksOpeningDay | Error;
...
export type EditoContentFiltersInput = {
  ...
  id?: InputMaybe<IdFilterInput>;
  new?: InputMaybe<NewFiltersInput>;
...
export type EventBlocksDynamicZone = ComponentBlocksFile | ComponentBlocksHorizontalRule | ComponentBlocksImage | ComponentBlocksSubHeading | ComponentBlocksVideo | ComponentBlocksWysiwyg | Error;
...
export type EventInput = {
  ...
  linkToServices?: InputMaybe<Array<Scalars['EventLinkToServicesDynamicZoneInput']>>;
  publishedDate?: InputMaybe<Scalars['DateTime']>;
...
export type EventLinkToServicesDynamicZone = ComponentLinksAlertNotification | ComponentLinksDropOffMap | ComponentLinksEditorial | ComponentLinksPickUpDay | ComponentLinksRecyclingGuide | ComponentLinksRequest | Error;
...
export type FreeContentBlocksDynamicZone = ComponentBlocksFile | ComponentBlocksHorizontalRule | ComponentBlocksImage | ComponentBlocksSubHeading | ComponentBlocksVideo | ComponentBlocksWysiwyg | Error;
...
export type FreeContentInput = {
  ...
  hasDraft?: InputMaybe<Scalars['Boolean']>;
  image?: InputMaybe<Scalars['ID']>;
  linkToServices?: InputMaybe<Array<Scalars['FreeContentLinkToServicesDynamicZoneInput']>>;
  publishedDate?: InputMaybe<Scalars['DateTime']>;
  shortDescription?: InputMaybe<Scalars['String']>;
...
export type FreeContentLinkToServicesDynamicZone = ComponentLinksAlertNotification | ComponentLinksDropOffMap | ComponentLinksEditorial | ComponentLinksPickUpDay | ComponentLinksRecyclingGuide | ComponentLinksRequest | Error;
...
export type GenericMorph = Accessibility | AccessibilitySubService | AlertNotification | AlertNotificationService | AudienceType | Cgu | CguSubService | ChannelType | City | ClientContact | CollectDoorToDoor | CollectDropOff | CollectVoluntary | ComponentBlocksAddress | ComponentBlocksAttachments | ComponentBlocksCheckbox | ComponentBlocksCommentary | ComponentBlocksCumbersome | ComponentBlocksDateChoice | ComponentBlocksDownloadBlock | ComponentBlocksFile | ComponentBlocksHorizontalRule | ComponentBlocksImage | ComponentBlocksOpeningDay | ComponentBlocksProofOfReceipt | ComponentBlocksQcm | ComponentBlocksQuestions | ComponentBlocksRequestType | ComponentBlocksSubHeading | ComponentBlocksTest | ComponentBlocksUser | ComponentBlocksVideo | ComponentBlocksWysiwyg | ComponentLinksAlertNotification | ComponentLinksContactUs | ComponentLinksDropOffMap | ComponentLinksEditorial | ComponentLinksEvents | ComponentLinksExternal | ComponentLinksFrees | ComponentLinksKeyMetrics | ComponentLinksMyWasteCounter | ComponentLinksNews | ComponentLinksPickUpDay | ComponentLinksQuizzes | ComponentLinksRecyclingGuide | ComponentLinksRequest | ComponentLinksTips | Confidentiality | ConfidentialitySubService | ContactUs | ContactUsSubService | Contract | ContractCustomization | ContractMenu | Cookie | CookiesSubService | DescriptionService | Document | DropOffMap | DropOffMapService | EditoBlock | EditoContent | EditorialService | Epci | Event | EventSubService | ExportEntity | Flow | FlowColor | Footer | FreeContent | FreeContentSubService | Global | Homepage | I18NLocale | KeyMetric | KeyMetricsService | MwCounterService | MyWasteCounter | New | NewsSubService | PickUpDay | PickUpDayService | Quiz | QuizAndTipsBlock | QuizSubService | RecyclingGuideBlock | RecyclingGuideService | Request | RequestAggregate | RequestService | SearchEngineBlock | Sectorization | ServicesBlock | Tag | Territory | TerritoryType | Tip | TipSubService | TopContent | TopContentBlock | UploadFile | UploadFolder | UsersPermissionsPermission | UsersPermissionsRole | UsersPermissionsUser | WasteFamily | WasteForm | YesWeScanService;
...
export type NewBlocksDynamicZone = ComponentBlocksFile | ComponentBlocksHorizontalRule | ComponentBlocksImage | ComponentBlocksSubHeading | ComponentBlocksVideo | ComponentBlocksWysiwyg | Error;
...
export type NewInput = {
  ...
  hasDraft?: InputMaybe<Scalars['Boolean']>;
  image?: InputMaybe<Scalars['ID']>;
  linkToServices?: InputMaybe<Array<Scalars['NewLinkToServicesDynamicZoneInput']>>;
  newsSubService?: InputMaybe<Scalars['ID']>;
  publishedDate?: InputMaybe<Scalars['DateTime']>;
  shortDescription?: InputMaybe<Scalars['String']>;
...
export type NewLinkToServicesDynamicZone = ComponentLinksAlertNotification | ComponentLinksDropOffMap | ComponentLinksEditorial | ComponentLinksPickUpDay | ComponentLinksRecyclingGuide | ComponentLinksRequest | Error;
...
export type RequestAddableBlocksDynamicZone = ComponentBlocksAddress | ComponentBlocksAttachments | ComponentBlocksCheckbox | ComponentBlocksCommentary | ComponentBlocksCumbersome | ComponentBlocksDateChoice | ComponentBlocksProofOfReceipt | ComponentBlocksQcm | ComponentBlocksQuestions | ComponentBlocksUser | Error;
...
export type ServicesBlockInput = {
  homepage?: InputMaybe<Scalars['ID']>;
  serviceLinks?: InputMaybe<Array<Scalars['ServicesBlockServiceLinksDynamicZoneInput']>>;
  titleContent?: InputMaybe<Scalars['String']>;
};

export type ServicesBlockServiceLinksDynamicZone = ComponentLinksAlertNotification | ComponentLinksContactUs | ComponentLinksDropOffMap | ComponentLinksEvents | ComponentLinksExternal | ComponentLinksFrees | ComponentLinksKeyMetrics | ComponentLinksMyWasteCounter | ComponentLinksNews | ComponentLinksPickUpDay | ComponentLinksQuizzes | ComponentLinksRecyclingGuide | ComponentLinksRequest | ComponentLinksTips | Error;
...
export type TipBlocksDynamicZone = ComponentBlocksFile | ComponentBlocksHorizontalRule | ComponentBlocksImage | ComponentBlocksSubHeading | ComponentBlocksVideo | ComponentBlocksWysiwyg | Error;
...
export type TipInput = {
  ...
  link?: InputMaybe<Scalars['String']>;
  linkToServices?: InputMaybe<Array<Scalars['TipLinkToServicesDynamicZoneInput']>>;
  publishedDate?: InputMaybe<Scalars['DateTime']>;
  shortDescription?: InputMaybe<Scalars['String']>;
...
export type TipLinkToServicesDynamicZone = ComponentLinksAlertNotification | ComponentLinksDropOffMap | ComponentLinksEditorial | ComponentLinksPickUpDay | ComponentLinksRecyclingGuide | ComponentLinksRequest | Error;
...
export type WasteFormContentBlockDynamicZone = ComponentBlocksFile | ComponentBlocksHorizontalRule | ComponentBlocksImage | ComponentBlocksSubHeading | ComponentBlocksVideo | ComponentBlocksWysiwyg | Error;
...
export type WasteFormInput = {
  contentBlock?: InputMaybe<Array<Scalars['WasteFormContentBlockDynamicZoneInput']>>;
  customId?: InputMaybe<Scalars['String']>;
  draftCreationId?: InputMaybe<Scalars['String']>;
  flow?: InputMaybe<Scalars['ID']>;
  hasDraft?: InputMaybe<Scalars['Boolean']>;
...
export type CreateNewMutation = { __typename?: 'Mutation', createNew?: { __typename?: 'NewEntityResponse', data?: { __typename?: 'NewEntity', id?: string | null, attributes?: { __typename?: 'New', customId?: string | null, title: string, shortDescription?: string | null, status?: Enum_New_Status | null, publishedDate?: any | null, unpublishedDate?: any | null, createdAt?: any | null, updatedAt?: any | null, newsSubService?: { __typename?: 'NewsSubServiceEntityResponse', data?: { __typename?: 'NewsSubServiceEntity', id?: string | null } | null } | null, tags?: { __typename?: 'TagRelationResponseCollection', data: Array<{ __typename?: 'TagEntity', id?: string | null, attributes?: { __typename?: 'Tag', name: string } | null }> } | null, image?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', id?: string | null, attributes?: { __typename?: 'UploadFile', hash: string, mime: string, name: string, provider: string, size: number, url: string, alternativeText?: string | null, ext?: string | null, height?: number | null, width?: number | null, createdAt?: any | null } | null } | null } | null, blocks?: Array<{ __typename?: 'ComponentBlocksFile', id: string, document?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', id?: string | null, attributes?: { __typename?: 'UploadFile', hash: string, mime: string, name: string, provider: string, size: number, url: string, alternativeText?: string | null, ext?: string | null, height?: number | null, width?: number | null, createdAt?: any | null } | null } | null } | null } | { __typename?: 'ComponentBlocksHorizontalRule', id: string, hr?: string | null } | { __typename?: 'ComponentBlocksImage', id: string, isDecorative?: boolean | null, altText?: string | null, picture?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', id?: string | null, attributes?: { __typename?: 'UploadFile', hash: string, mime: string, name: string, provider: string, size: number, url: string, alternativeText?: string | null, ext?: string | null, height?: number | null, width?: number | null, createdAt?: any | null } | null } | null } | null } | { __typename?: 'ComponentBlocksSubHeading', id: string, subHeadingText?: string | null, subHeadingTag?: Enum_Componentblockssubheading_Subheadingtag | null } | { __typename?: 'ComponentBlocksVideo', id: string, videoLink?: string | null, transcriptText?: string | null } | { __typename?: 'ComponentBlocksWysiwyg', id: string, textEditor?: string | null } | { __typename?: 'Error' } | null> | null } | null } | null } | null };
...
export type DeleteNewMutation = { __typename?: 'Mutation', deleteNew?: { __typename?: 'NewEntityResponse', data?: { __typename?: 'NewEntity', id?: string | null, attributes?: { __typename?: 'New', customId?: string | null, title: string, shortDescription?: string | null, status?: Enum_New_Status | null, publishedDate?: any | null, unpublishedDate?: any | null, createdAt?: any | null, updatedAt?: any | null, newsSubService?: { __typename?: 'NewsSubServiceEntityResponse', data?: { __typename?: 'NewsSubServiceEntity', id?: string | null } | null } | null, tags?: { __typename?: 'TagRelationResponseCollection', data: Array<{ __typename?: 'TagEntity', id?: string | null, attributes?: { __typename?: 'Tag', name: string } | null }> } | null, image?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', id?: string | null, attributes?: { __typename?: 'UploadFile', hash: string, mime: string, name: string, provider: string, size: number, url: string, alternativeText?: string | null, ext?: string | null, height?: number | null, width?: number | null, createdAt?: any | null } | null } | null } | null, blocks?: Array<{ __typename?: 'ComponentBlocksFile', id: string, document?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', id?: string | null, attributes?: { __typename?: 'UploadFile', hash: string, mime: string, name: string, provider: string, size: number, url: string, alternativeText?: string | null, ext?: string | null, height?: number | null, width?: number | null, createdAt?: any | null } | null } | null } | null } | { __typename?: 'ComponentBlocksHorizontalRule', id: string, hr?: string | null } | { __typename?: 'ComponentBlocksImage', id: string, isDecorative?: boolean | null, altText?: string | null, picture?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', id?: string | null, attributes?: { __typename?: 'UploadFile', hash: string, mime: string, name: string, provider: string, size: number, url: string, alternativeText?: string | null, ext?: string | null, height?: number | null, width?: number | null, createdAt?: any | null } | null } | null } | null } | { __typename?: 'ComponentBlocksSubHeading', id: string, subHeadingText?: string | null, subHeadingTag?: Enum_Componentblockssubheading_Subheadingtag | null } | { __typename?: 'ComponentBlocksVideo', id: string, videoLink?: string | null, transcriptText?: string | null } | { __typename?: 'ComponentBlocksWysiwyg', id: string, textEditor?: string | null } | { __typename?: 'Error' } | null> | null } | null } | null } | null };
...
export type GetAllVersionsOfNewsByCustomIdQuery = { __typename?: 'Query', newsCount?: { __typename?: 'NewEntityResponseCollection', meta: { __typename?: 'ResponseCollectionMeta', pagination: { __typename?: 'Pagination', total: number } } } | null, newsCountDraft?: { __typename?: 'NewEntityResponseCollection', meta: { __typename?: 'ResponseCollectionMeta', pagination: { __typename?: 'Pagination', total: number } } } | null, newsCountPublished?: { __typename?: 'NewEntityResponseCollection', meta: { __typename?: 'ResponseCollectionMeta', pagination: { __typename?: 'Pagination', total: number } } } | null, newsCountArchived?: { __typename?: 'NewEntityResponseCollection', meta: { __typename?: 'ResponseCollectionMeta', pagination: { __typename?: 'Pagination', total: number } } } | null, news?: { __typename?: 'NewEntityResponseCollection', meta: { __typename?: 'ResponseCollectionMeta', pagination: { __typename?: 'Pagination', page: number, pageSize: number, pageCount: number, total: number } }, data: Array<{ __typename?: 'NewEntity', id?: string | null, attributes?: { __typename?: 'New', versionNumber?: number | null, status?: Enum_New_Status | null, publishedDate?: any | null, updatedAt?: any | null } | null }> } | null };
...
export type GetNewByIdQuery = { __typename?: 'Query', new?: { __typename?: 'NewEntityResponse', data?: { __typename?: 'NewEntity', id?: string | null, attributes?: { __typename?: 'New', customId?: string | null, title: string, shortDescription?: string | null, status?: Enum_New_Status | null, publishedDate?: any | null, unpublishedDate?: any | null, createdAt?: any | null, updatedAt?: any | null, newsSubService?: { __typename?: 'NewsSubServiceEntityResponse', data?: { __typename?: 'NewsSubServiceEntity', id?: string | null } | null } | null, tags?: { __typename?: 'TagRelationResponseCollection', data: Array<{ __typename?: 'TagEntity', id?: string | null, attributes?: { __typename?: 'Tag', name: string } | null }> } | null, image?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', id?: string | null, attributes?: { __typename?: 'UploadFile', hash: string, mime: string, name: string, provider: string, size: number, url: string, alternativeText?: string | null, ext?: string | null, height?: number | null, width?: number | null, createdAt?: any | null } | null } | null } | null, blocks?: Array<{ __typename?: 'ComponentBlocksFile', id: string, document?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', id?: string | null, attributes?: { __typename?: 'UploadFile', hash: string, mime: string, name: string, provider: string, size: number, url: string, alternativeText?: string | null, createdAt?: any | null, ext?: string | null, width?: number | null, height?: number | null } | null } | null } | null } | { __typename?: 'ComponentBlocksHorizontalRule', id: string, hr?: string | null } | { __typename?: 'ComponentBlocksImage', id: string, isDecorative?: boolean | null, altText?: string | null, picture?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', id?: string | null, attributes?: { __typename?: 'UploadFile', hash: string, mime: string, name: string, provider: string, size: number, url: string, alternativeText?: string | null, createdAt?: any | null, ext?: string | null, width?: number | null, height?: number | null } | null } | null } | null } | { __typename?: 'ComponentBlocksSubHeading', id: string, subHeadingText?: string | null, subHeadingTag?: Enum_Componentblockssubheading_Subheadingtag | null } | { __typename?: 'ComponentBlocksVideo', id: string, videoLink?: string | null, transcriptText?: string | null } | { __typename?: 'ComponentBlocksWysiwyg', id: string, textEditor?: string | null } | { __typename?: 'Error' } | null> | null } | null } | null } | null };
...
export type GetNewDraftQuery = { __typename?: 'Query', news?: { __typename?: 'NewEntityResponseCollection', data: Array<{ __typename?: 'NewEntity', id?: string | null }> } | null };
...
export type GetNewsByContractIdQuery = { __typename?: 'Query', newsCount?: { __typename?: 'NewEntityResponseCollection', meta: { __typename?: 'ResponseCollectionMeta', pagination: { __typename?: 'Pagination', total: number } } } | null, newsCountDraft?: { __typename?: 'NewEntityResponseCollection', meta: { __typename?: 'ResponseCollectionMeta', pagination: { __typename?: 'Pagination', total: number } } } | null, newsCountPublished?: { __typename?: 'NewEntityResponseCollection', meta: { __typename?: 'ResponseCollectionMeta', pagination: { __typename?: 'Pagination', total: number } } } | null, newsCountArchived?: { __typename?: 'NewEntityResponseCollection', meta: { __typename?: 'ResponseCollectionMeta', pagination: { __typename?: 'Pagination', total: number } } } | null, news?: { __typename?: 'NewEntityResponseCollection', meta: { __typename?: 'ResponseCollectionMeta', pagination: { __typename?: 'Pagination', page: number, pageSize: number, pageCount: number, total: number } }, data: Array<{ __typename?: 'NewEntity', id?: string | null, attributes?: { __typename?: 'New', title: string, shortDescription?: string | null, status?: Enum_New_Status | null, publishedDate?: any | null, unpublishedDate?: any | null } | null }> } | null };
...
export type UpdateNewMutation = { __typename?: 'Mutation', updateNew?: { __typename?: 'NewEntityResponse', data?: { __typename?: 'NewEntity', id?: string | null, attributes?: { __typename?: 'New', customId?: string | null, title: string, shortDescription?: string | null, status?: Enum_New_Status | null, publishedDate?: any | null, unpublishedDate?: any | null, createdAt?: any | null, updatedAt?: any | null, newsSubService?: { __typename?: 'NewsSubServiceEntityResponse', data?: { __typename?: 'NewsSubServiceEntity', id?: string | null } | null } | null, tags?: { __typename?: 'TagRelationResponseCollection', data: Array<{ __typename?: 'TagEntity', id?: string | null, attributes?: { __typename?: 'Tag', name: string } | null }> } | null, image?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', id?: string | null, attributes?: { __typename?: 'UploadFile', hash: string, mime: string, name: string, provider: string, size: number, url: string, alternativeText?: string | null, ext?: string | null, height?: number | null, width?: number | null, createdAt?: any | null } | null } | null } | null, blocks?: Array<{ __typename?: 'ComponentBlocksFile', id: string, document?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', id?: string | null, attributes?: { __typename?: 'UploadFile', hash: string, mime: string, name: string, provider: string, size: number, url: string, alternativeText?: string | null, ext?: string | null, height?: number | null, width?: number | null, createdAt?: any | null } | null } | null } | null } | { __typename?: 'ComponentBlocksHorizontalRule', id: string, hr?: string | null } | { __typename?: 'ComponentBlocksImage', id: string, isDecorative?: boolean | null, altText?: string | null, picture?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', id?: string | null, attributes?: { __typename?: 'UploadFile', hash: string, mime: string, name: string, provider: string, size: number, url: string, alternativeText?: string | null, ext?: string | null, height?: number | null, width?: number | null, createdAt?: any | null } | null } | null } | null } | { __typename?: 'ComponentBlocksSubHeading', id: string, subHeadingText?: string | null, subHeadingTag?: Enum_Componentblockssubheading_Subheadingtag | null } | { __typename?: 'ComponentBlocksVideo', id: string, videoLink?: string | null, transcriptText?: string | null } | { __typename?: 'ComponentBlocksWysiwyg', id: string, textEditor?: string | null } | { __typename?: 'Error' } | null> | null } | null } | null } | null };
...
export type CreateTipMutation = { __typename?: 'Mutation', createTip?: { __typename?: 'TipEntityResponse', data?: { __typename?: 'TipEntity', id?: string | null, attributes?: { __typename?: 'Tip', title: string, shortDescription?: string | null, status?: Enum_Tip_Status | null, publishedDate?: any | null, unpublishedDate?: any | null, createdAt?: any | null, updatedAt?: any | null, tipSubService?: { __typename?: 'TipSubServiceEntityResponse', data?: { __typename?: 'TipSubServiceEntity', id?: string | null } | null } | null, tags?: { __typename?: 'TagRelationResponseCollection', data: Array<{ __typename?: 'TagEntity', id?: string | null, attributes?: { __typename?: 'Tag', name: string } | null }> } | null, image: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', id?: string | null, attributes?: { __typename?: 'UploadFile', hash: string, mime: string, name: string, provider: string, size: number, url: string, alternativeText?: string | null, ext?: string | null, height?: number | null, width?: number | null, createdAt?: any | null } | null } | null }, blocks?: Array<{ __typename?: 'ComponentBlocksFile', id: string, document?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', id?: string | null, attributes?: { __typename?: 'UploadFile', hash: string, mime: string, name: string, provider: string, size: number, url: string, alternativeText?: string | null, ext?: string | null, height?: number | null, width?: number | null, createdAt?: any | null } | null } | null } | null } | { __typename?: 'ComponentBlocksHorizontalRule', id: string, hr?: string | null } | { __typename?: 'ComponentBlocksImage', id: string, isDecorative?: boolean | null, altText?: string | null, picture?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', id?: string | null, attributes?: { __typename?: 'UploadFile', hash: string, mime: string, name: string, provider: string, size: number, url: string, alternativeText?: string | null, ext?: string | null, height?: number | null, width?: number | null, createdAt?: any | null } | null } | null } | null } | { __typename?: 'ComponentBlocksSubHeading', id: string, subHeadingText?: string | null, subHeadingTag?: Enum_Componentblockssubheading_Subheadingtag | null } | { __typename?: 'ComponentBlocksVideo', id: string, videoLink?: string | null, transcriptText?: string | null } | { __typename?: 'ComponentBlocksWysiwyg', id: string, textEditor?: string | null } | { __typename?: 'Error' } | null> | null } | null } | null } | null };
...
export type DeleteTipMutation = { __typename?: 'Mutation', deleteTip?: { __typename?: 'TipEntityResponse', data?: { __typename?: 'TipEntity', id?: string | null, attributes?: { __typename?: 'Tip', title: string, shortDescription?: string | null, status?: Enum_Tip_Status | null, publishedDate?: any | null, unpublishedDate?: any | null, createdAt?: any | null, updatedAt?: any | null, tipSubService?: { __typename?: 'TipSubServiceEntityResponse', data?: { __typename?: 'TipSubServiceEntity', id?: string | null } | null } | null, tags?: { __typename?: 'TagRelationResponseCollection', data: Array<{ __typename?: 'TagEntity', id?: string | null, attributes?: { __typename?: 'Tag', name: string } | null }> } | null, image: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', id?: string | null, attributes?: { __typename?: 'UploadFile', hash: string, mime: string, name: string, provider: string, size: number, url: string, alternativeText?: string | null, ext?: string | null, height?: number | null, width?: number | null, createdAt?: any | null } | null } | null }, blocks?: Array<{ __typename?: 'ComponentBlocksFile', id: string, document?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', id?: string | null, attributes?: { __typename?: 'UploadFile', hash: string, mime: string, name: string, provider: string, size: number, url: string, alternativeText?: string | null, ext?: string | null, height?: number | null, width?: number | null, createdAt?: any | null } | null } | null } | null } | { __typename?: 'ComponentBlocksHorizontalRule', id: string, hr?: string | null } | { __typename?: 'ComponentBlocksImage', id: string, isDecorative?: boolean | null, altText?: string | null, picture?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', id?: string | null, attributes?: { __typename?: 'UploadFile', hash: string, mime: string, name: string, provider: string, size: number, url: string, alternativeText?: string | null, ext?: string | null, height?: number | null, width?: number | null, createdAt?: any | null } | null } | null } | null } | { __typename?: 'ComponentBlocksSubHeading', id: string, subHeadingText?: string | null, subHeadingTag?: Enum_Componentblockssubheading_Subheadingtag | null } | { __typename?: 'ComponentBlocksVideo', id: string, videoLink?: string | null, transcriptText?: string | null } | { __typename?: 'ComponentBlocksWysiwyg', id: string, textEditor?: string | null } | { __typename?: 'Error' } | null> | null } | null } | null } | null };
...
export type GetTipByIdQuery = { __typename?: 'Query', tip?: { __typename?: 'TipEntityResponse', data?: { __typename?: 'TipEntity', id?: string | null, attributes?: { __typename?: 'Tip', customId?: string | null, title: string, shortDescription?: string | null, status?: Enum_Tip_Status | null, publishedDate?: any | null, unpublishedDate?: any | null, createdAt?: any | null, updatedAt?: any | null, tipSubService?: { __typename?: 'TipSubServiceEntityResponse', data?: { __typename?: 'TipSubServiceEntity', id?: string | null } | null } | null, tags?: { __typename?: 'TagRelationResponseCollection', data: Array<{ __typename?: 'TagEntity', id?: string | null, attributes?: { __typename?: 'Tag', name: string } | null }> } | null, image: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', id?: string | null, attributes?: { __typename?: 'UploadFile', hash: string, mime: string, name: string, provider: string, size: number, url: string, alternativeText?: string | null, ext?: string | null, height?: number | null, width?: number | null, createdAt?: any | null } | null } | null }, blocks?: Array<{ __typename?: 'ComponentBlocksFile', id: string, document?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', id?: string | null, attributes?: { __typename?: 'UploadFile', hash: string, mime: string, name: string, provider: string, size: number, url: string, alternativeText?: string | null, createdAt?: any | null, ext?: string | null, width?: number | null, height?: number | null } | null } | null } | null } | { __typename?: 'ComponentBlocksHorizontalRule', id: string, hr?: string | null } | { __typename?: 'ComponentBlocksImage', id: string, isDecorative?: boolean | null, altText?: string | null, picture?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', id?: string | null, attributes?: { __typename?: 'UploadFile', hash: string, mime: string, name: string, provider: string, size: number, url: string, alternativeText?: string | null, createdAt?: any | null, ext?: string | null, width?: number | null, height?: number | null } | null } | null } | null } | { __typename?: 'ComponentBlocksSubHeading', id: string, subHeadingText?: string | null, subHeadingTag?: Enum_Componentblockssubheading_Subheadingtag | null } | { __typename?: 'ComponentBlocksVideo', id: string, videoLink?: string | null, transcriptText?: string | null } | { __typename?: 'ComponentBlocksWysiwyg', id: string, textEditor?: string | null } | { __typename?: 'Error' } | null> | null } | null } | null } | null };
...
export type GetTipsByContractIdQuery = { __typename?: 'Query', tipsCount?: { __typename?: 'TipEntityResponseCollection', meta: { __typename?: 'ResponseCollectionMeta', pagination: { __typename?: 'Pagination', total: number } } } | null, tipsCountDraft?: { __typename?: 'TipEntityResponseCollection', meta: { __typename?: 'ResponseCollectionMeta', pagination: { __typename?: 'Pagination', total: number } } } | null, tipsCountPublished?: { __typename?: 'TipEntityResponseCollection', meta: { __typename?: 'ResponseCollectionMeta', pagination: { __typename?: 'Pagination', total: number } } } | null, tipsCountArchived?: { __typename?: 'TipEntityResponseCollection', meta: { __typename?: 'ResponseCollectionMeta', pagination: { __typename?: 'Pagination', total: number } } } | null, tips?: { __typename?: 'TipEntityResponseCollection', meta: { __typename?: 'ResponseCollectionMeta', pagination: { __typename?: 'Pagination', page: number, pageSize: number, pageCount: number, total: number } }, data: Array<{ __typename?: 'TipEntity', id?: string | null, attributes?: { __typename?: 'Tip', title: string, shortDescription?: string | null, status?: Enum_Tip_Status | null, publishedDate?: any | null, unpublishedDate?: any | null } | null }> } | null };
...
export type UpdateTipMutation = { __typename?: 'Mutation', updateTip?: { __typename?: 'TipEntityResponse', data?: { __typename?: 'TipEntity', id?: string | null, attributes?: { __typename?: 'Tip', title: string, shortDescription?: string | null, status?: Enum_Tip_Status | null, publishedDate?: any | null, unpublishedDate?: any | null, createdAt?: any | null, updatedAt?: any | null, tipSubService?: { __typename?: 'TipSubServiceEntityResponse', data?: { __typename?: 'TipSubServiceEntity', id?: string | null } | null } | null, tags?: { __typename?: 'TagRelationResponseCollection', data: Array<{ __typename?: 'TagEntity', id?: string | null, attributes?: { __typename?: 'Tag', name: string } | null }> } | null, image: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', id?: string | null, attributes?: { __typename?: 'UploadFile', hash: string, mime: string, name: string, provider: string, size: number, url: string, alternativeText?: string | null, ext?: string | null, height?: number | null, width?: number | null, createdAt?: any | null } | null } | null }, blocks?: Array<{ __typename?: 'ComponentBlocksFile', id: string, document?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', id?: string | null, attributes?: { __typename?: 'UploadFile', hash: string, mime: string, name: string, provider: string, size: number, url: string, alternativeText?: string | null, ext?: string | null, height?: number | null, width?: number | null, createdAt?: any | null } | null } | null } | null } | { __typename?: 'ComponentBlocksHorizontalRule', id: string, hr?: string | null } | { __typename?: 'ComponentBlocksImage', id: string, isDecorative?: boolean | null, altText?: string | null, picture?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', id?: string | null, attributes?: { __typename?: 'UploadFile', hash: string, mime: string, name: string, provider: string, size: number, url: string, alternativeText?: string | null, ext?: string | null, height?: number | null, width?: number | null, createdAt?: any | null } | null } | null } | null } | { __typename?: 'ComponentBlocksSubHeading', id: string, subHeadingText?: string | null, subHeadingTag?: Enum_Componentblockssubheading_Subheadingtag | null } | { __typename?: 'ComponentBlocksVideo', id: string, videoLink?: string | null, transcriptText?: string | null } | { __typename?: 'ComponentBlocksWysiwyg', id: string, textEditor?: string | null } | { __typename?: 'Error' } | null> | null } | null } | null } | null };
...
export type CreateNewFolderMutation = { __typename?: 'Mutation', createNewFolder?: { __typename?: 'RequestFolderEntity', id?: string | null, name?: string | null, path?: string | null, pathId?: string | null } | null };
...
export type GetAllFoldersHierarchyQuery = { __typename?: 'Query', getAllFoldersHierarchy?: Array<{ __typename?: 'RequestFolders', id?: string | null, name?: string | null, path?: string | null, pathId?: string | null } | null> | null };
...
export type GetFilesPaginationByPathIdQuery = { __typename?: 'Query', uploadFiles?: { __typename?: 'UploadFileEntityResponseCollection', data: Array<{ __typename?: 'UploadFileEntity', id?: string | null, attributes?: { __typename?: 'UploadFile', name: string, mime: string, size: number, width?: number | null, height?: number | null, createdAt?: any | null, url: string, ext?: string | null, alternativeText?: string | null } | null }>, meta: { __typename?: 'ResponseCollectionMeta', pagination: { __typename?: 'Pagination', total: number, pageSize: number, pageCount: number, page: number } } } | null };
...
export type GetFolderAndChildrenByIdQuery = { __typename?: 'Query', uploadFolders?: { __typename?: 'UploadFolderEntityResponseCollection', data: Array<{ __typename?: 'UploadFolderEntity', id?: string | null, attributes?: { __typename?: 'UploadFolder', name: string, pathId: number, path: string, files?: { __typename?: 'UploadFileRelationResponseCollection', data: Array<{ __typename?: 'UploadFileEntity', id?: string | null }> } | null, children?: { __typename?: 'UploadFolderRelationResponseCollection', data: Array<{ __typename?: 'UploadFolderEntity', id?: string | null, attributes?: { __typename?: 'UploadFolder', name: string, pathId: number, path: string, files?: { __typename?: 'UploadFileRelationResponseCollection', data: Array<{ __typename?: 'UploadFileEntity', id?: string | null }> } | null, children?: { __typename?: 'UploadFolderRelationResponseCollection', data: Array<{ __typename?: 'UploadFolderEntity', id?: string | null }> } | null } | null }> } | null } | null }> } | null };
...
export type GetFolderBreadcrumbQuery = { __typename?: 'Query', libraryBreadcrumbTrail?: Array<{ __typename?: 'Folders', id?: string | null, name?: string | null, path?: string | null, pathId?: string | null } | null> | null };
...
export type GetFolderByPathIdQuery = { __typename?: 'Query', uploadFolders?: { __typename?: 'UploadFolderEntityResponseCollection', data: Array<{ __typename?: 'UploadFolderEntity', id?: string | null, attributes?: { __typename?: 'UploadFolder', name: string, pathId: number, path: string } | null }> } | null };
...
export type UpdateUploadFileMutation = { __typename?: 'Mutation', updateUploadFile?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', id?: string | null, attributes?: { __typename?: 'UploadFile', createdAt?: any | null, hash: string, mime: string, name: string, provider: string, size: number, url: string, alternativeText?: string | null, ext?: string | null, height?: number | null, width?: number | null, related?: Array<{ __typename?: 'Accessibility' } | { __typename?: 'AccessibilitySubService' } | { __typename?: 'AlertNotification' } | { __typename?: 'AlertNotificationService' } | { __typename?: 'AudienceType' } | { __typename?: 'Cgu' } | { __typename?: 'CguSubService' } | { __typename?: 'ChannelType' } | { __typename?: 'City' } | { __typename?: 'ClientContact' } | { __typename?: 'CollectDoorToDoor' } | { __typename?: 'CollectDropOff' } | { __typename?: 'CollectVoluntary' } | { __typename?: 'ComponentBlocksAddress' } | { __typename?: 'ComponentBlocksAttachments' } | { __typename?: 'ComponentBlocksCheckbox' } | { __typename?: 'ComponentBlocksCommentary' } | { __typename?: 'ComponentBlocksCumbersome' } | { __typename?: 'ComponentBlocksDateChoice' } | { __typename?: 'ComponentBlocksDownloadBlock' } | { __typename?: 'ComponentBlocksFile' } | { __typename?: 'ComponentBlocksHorizontalRule' } | { __typename?: 'ComponentBlocksImage' } | { __typename?: 'ComponentBlocksOpeningDay' } | { __typename?: 'ComponentBlocksProofOfReceipt' } | { __typename?: 'ComponentBlocksQcm' } | { __typename?: 'ComponentBlocksQuestions' } | { __typename?: 'ComponentBlocksRequestType' } | { __typename?: 'ComponentBlocksSubHeading' } | { __typename?: 'ComponentBlocksTest' } | { __typename?: 'ComponentBlocksUser' } | { __typename?: 'ComponentBlocksVideo' } | { __typename?: 'ComponentBlocksWysiwyg' } | { __typename?: 'ComponentLinksAlertNotification' } | { __typename?: 'ComponentLinksContactUs' } | { __typename?: 'ComponentLinksDropOffMap' } | { __typename?: 'ComponentLinksEditorial' } | { __typename?: 'ComponentLinksEvents' } | { __typename?: 'ComponentLinksExternal' } | { __typename?: 'ComponentLinksFrees' } | { __typename?: 'ComponentLinksKeyMetrics' } | { __typename?: 'ComponentLinksMyWasteCounter' } | { __typename?: 'ComponentLinksNews' } | { __typename?: 'ComponentLinksPickUpDay' } | { __typename?: 'ComponentLinksQuizzes' } | { __typename?: 'ComponentLinksRecyclingGuide' } | { __typename?: 'ComponentLinksRequest' } | { __typename?: 'ComponentLinksTips' } | { __typename?: 'Confidentiality' } | { __typename?: 'ConfidentialitySubService' } | { __typename?: 'ContactUs' } | { __typename?: 'ContactUsSubService' } | { __typename?: 'Contract' } | { __typename?: 'ContractCustomization' } | { __typename?: 'ContractMenu' } | { __typename?: 'Cookie' } | { __typename?: 'CookiesSubService' } | { __typename?: 'DescriptionService' } | { __typename?: 'Document' } | { __typename?: 'DropOffMap' } | { __typename?: 'DropOffMapService' } | { __typename?: 'EditoBlock' } | { __typename?: 'EditoContent' } | { __typename?: 'EditorialService' } | { __typename?: 'Epci' } | { __typename?: 'Event' } | { __typename?: 'EventSubService' } | { __typename?: 'ExportEntity' } | { __typename?: 'Flow' } | { __typename?: 'FlowColor' } | { __typename?: 'Footer' } | { __typename?: 'FreeContent' } | { __typename?: 'FreeContentSubService' } | { __typename?: 'Global' } | { __typename?: 'Homepage' } | { __typename?: 'I18NLocale' } | { __typename?: 'KeyMetric' } | { __typename?: 'KeyMetricsService' } | { __typename?: 'MwCounterService' } | { __typename?: 'MyWasteCounter' } | { __typename?: 'New' } | { __typename?: 'NewsSubService' } | { __typename?: 'PickUpDay' } | { __typename?: 'PickUpDayService' } | { __typename?: 'Quiz' } | { __typename?: 'QuizAndTipsBlock' } | { __typename?: 'QuizSubService' } | { __typename?: 'RecyclingGuideBlock' } | { __typename?: 'RecyclingGuideService' } | { __typename?: 'Request' } | { __typename?: 'RequestAggregate' } | { __typename?: 'RequestService' } | { __typename?: 'SearchEngineBlock' } | { __typename?: 'Sectorization' } | { __typename?: 'ServicesBlock' } | { __typename?: 'Tag' } | { __typename?: 'Territory' } | { __typename?: 'TerritoryType' } | { __typename?: 'Tip' } | { __typename?: 'TipSubService' } | { __typename?: 'TopContent' } | { __typename?: 'TopContentBlock' } | { __typename?: 'UploadFile' } | { __typename?: 'UploadFolder', name: string, path: string, pathId: number } | { __typename?: 'UsersPermissionsPermission' } | { __typename?: 'UsersPermissionsRole' } | { __typename?: 'UsersPermissionsUser' } | { __typename?: 'WasteFamily' } | { __typename?: 'WasteForm' } | { __typename?: 'YesWeScanService' } | null> | null } | null } | null } | null };
...
export type UpdateUploadFolderMutation = { __typename?: 'Mutation', updateUploadFolder?: { __typename?: 'UploadFolderEntityResponse', data?: { __typename?: 'UploadFolderEntity', id?: string | null, attributes?: { __typename?: 'UploadFolder', pathId: number, updatedAt?: any | null, name: string, path: string, children?: { __typename?: 'UploadFolderRelationResponseCollection', data: Array<{ __typename?: 'UploadFolderEntity', id?: string | null, attributes?: { __typename?: 'UploadFolder', name: string, path: string, pathId: number, children?: { __typename?: 'UploadFolderRelationResponseCollection', data: Array<{ __typename?: 'UploadFolderEntity', id?: string | null }> } | null } | null }> } | null } | null } | null } | null };
...
export type UploadGraphQlMutation = { __typename?: 'Mutation', uploadGraphQL?: boolean | null };
...
export type GetContactUsByIdQuery = { __typename?: 'Query', contactUs?: { __typename?: 'ContactUsEntityResponse', data?: { __typename?: 'ContactUsEntity', id?: string | null, attributes?: { __typename?: 'ContactUs', customId?: string | null, title: string, status?: Enum_Contactus_Status | null, publishedDate?: any | null, unpublishedDate?: any | null, createdAt?: any | null, updatedAt?: any | null, tags?: { __typename?: 'TagRelationResponseCollection', data: Array<{ __typename?: 'TagEntity', id?: string | null, attributes?: { __typename?: 'Tag', name: string } | null }> } | null, blocks?: Array<{ __typename?: 'ComponentBlocksFile', id: string, document?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', id?: string | null, attributes?: { __typename?: 'UploadFile', hash: string, mime: string, name: string, provider: string, size: number, url: string, alternativeText?: string | null, createdAt?: any | null, ext?: string | null, width?: number | null, height?: number | null } | null } | null } | null } | { __typename?: 'ComponentBlocksHorizontalRule', id: string, hr?: string | null } | { __typename?: 'ComponentBlocksImage', id: string, isDecorative?: boolean | null, altText?: string | null, picture?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', id?: string | null, attributes?: { __typename?: 'UploadFile', hash: string, mime: string, name: string, provider: string, size: number, url: string, alternativeText?: string | null, createdAt?: any | null, ext?: string | null, width?: number | null, height?: number | null } | null } | null } | null } | { __typename?: 'ComponentBlocksSubHeading', id: string, subHeadingText?: string | null, subHeadingTag?: Enum_Componentblockssubheading_Subheadingtag | null } | { __typename?: 'ComponentBlocksVideo', id: string, videoLink?: string | null, transcriptText?: string | null } | { __typename?: 'ComponentBlocksWysiwyg', id: string, textEditor?: string | null } | { __typename?: 'Error' } | null> | null } | null } | null } | null };
...
export type GetContactUsesByContractIdQuery = { __typename?: 'Query', contactUsSubServices?: { __typename?: 'ContactUsSubServiceEntityResponseCollection', data: Array<{ __typename?: 'ContactUsSubServiceEntity', id?: string | null, attributes?: { __typename?: 'ContactUsSubService', name: string, isActivated?: boolean | null, contactUses?: { __typename?: 'ContactUsRelationResponseCollection', data: Array<{ __typename?: 'ContactUsEntity', id?: string | null }> } | null } | null }> } | null };
...
export type UpdateContactUsMutation = { __typename?: 'Mutation', updateContactUs?: { __typename?: 'ContactUsEntityResponse', data?: { __typename?: 'ContactUsEntity', id?: string | null, attributes?: { __typename?: 'ContactUs', title: string, status?: Enum_Contactus_Status | null, publishedDate?: any | null, unpublishedDate?: any | null, createdAt?: any | null, updatedAt?: any | null, tags?: { __typename?: 'TagRelationResponseCollection', data: Array<{ __typename?: 'TagEntity', id?: string | null, attributes?: { __typename?: 'Tag', name: string } | null }> } | null, blocks?: Array<{ __typename?: 'ComponentBlocksFile', id: string, document?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', id?: string | null, attributes?: { __typename?: 'UploadFile', hash: string, mime: string, name: string, provider: string, size: number, url: string, alternativeText?: string | null, ext?: string | null, height?: number | null, width?: number | null, createdAt?: any | null } | null } | null } | null } | { __typename?: 'ComponentBlocksHorizontalRule', id: string, hr?: string | null } | { __typename?: 'ComponentBlocksImage', id: string, isDecorative?: boolean | null, altText?: string | null, picture?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', id?: string | null, attributes?: { __typename?: 'UploadFile', hash: string, mime: string, name: string, provider: string, size: number, url: string, alternativeText?: string | null, ext?: string | null, height?: number | null, width?: number | null, createdAt?: any | null } | null } | null } | null } | { __typename?: 'ComponentBlocksSubHeading', id: string, subHeadingText?: string | null, subHeadingTag?: Enum_Componentblockssubheading_Subheadingtag | null } | { __typename?: 'ComponentBlocksVideo', id: string, videoLink?: string | null, transcriptText?: string | null } | { __typename?: 'ComponentBlocksWysiwyg', id: string, textEditor?: string | null } | { __typename?: 'Error' } | null> | null } | null } | null } | null };
...
export type CreateFreeContentMutation = { __typename?: 'Mutation', createFreeContent?: { __typename?: 'FreeContentEntityResponse', data?: { __typename?: 'FreeContentEntity', id?: string | null, attributes?: { __typename?: 'FreeContent', title: string, shortDescription?: string | null, status?: Enum_Freecontent_Status | null, publishedDate?: any | null, unpublishedDate?: any | null, createdAt?: any | null, updatedAt?: any | null, freeContentSubService?: { __typename?: 'FreeContentSubServiceEntityResponse', data?: { __typename?: 'FreeContentSubServiceEntity', id?: string | null } | null } | null, tags?: { __typename?: 'TagRelationResponseCollection', data: Array<{ __typename?: 'TagEntity', id?: string | null, attributes?: { __typename?: 'Tag', name: string } | null }> } | null, image: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', id?: string | null, attributes?: { __typename?: 'UploadFile', hash: string, mime: string, name: string, provider: string, size: number, url: string, alternativeText?: string | null, ext?: string | null, height?: number | null, width?: number | null, createdAt?: any | null } | null } | null }, blocks?: Array<{ __typename?: 'ComponentBlocksFile', id: string, document?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', id?: string | null, attributes?: { __typename?: 'UploadFile', hash: string, mime: string, name: string, provider: string, size: number, url: string, alternativeText?: string | null, ext?: string | null, height?: number | null, width?: number | null, createdAt?: any | null } | null } | null } | null } | { __typename?: 'ComponentBlocksHorizontalRule', id: string, hr?: string | null } | { __typename?: 'ComponentBlocksImage', id: string, isDecorative?: boolean | null, altText?: string | null, picture?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', id?: string | null, attributes?: { __typename?: 'UploadFile', hash: string, mime: string, name: string, provider: string, size: number, url: string, alternativeText?: string | null, ext?: string | null, height?: number | null, width?: number | null, createdAt?: any | null } | null } | null } | null } | { __typename?: 'ComponentBlocksSubHeading', id: string, subHeadingText?: string | null, subHeadingTag?: Enum_Componentblockssubheading_Subheadingtag | null } | { __typename?: 'ComponentBlocksVideo', id: string, videoLink?: string | null, transcriptText?: string | null } | { __typename?: 'ComponentBlocksWysiwyg', id: string, textEditor?: string | null } | { __typename?: 'Error' } | null> | null } | null } | null } | null };
...
export type DeleteFreeContentMutation = { __typename?: 'Mutation', deleteFreeContent?: { __typename?: 'FreeContentEntityResponse', data?: { __typename?: 'FreeContentEntity', id?: string | null, attributes?: { __typename?: 'FreeContent', title: string, shortDescription?: string | null, status?: Enum_Freecontent_Status | null, publishedDate?: any | null, unpublishedDate?: any | null, createdAt?: any | null, updatedAt?: any | null, freeContentSubService?: { __typename?: 'FreeContentSubServiceEntityResponse', data?: { __typename?: 'FreeContentSubServiceEntity', id?: string | null } | null } | null, tags?: { __typename?: 'TagRelationResponseCollection', data: Array<{ __typename?: 'TagEntity', id?: string | null, attributes?: { __typename?: 'Tag', name: string } | null }> } | null, image: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', id?: string | null, attributes?: { __typename?: 'UploadFile', hash: string, mime: string, name: string, provider: string, size: number, url: string, alternativeText?: string | null, ext?: string | null, height?: number | null, width?: number | null, createdAt?: any | null } | null } | null }, blocks?: Array<{ __typename?: 'ComponentBlocksFile', id: string, document?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', id?: string | null, attributes?: { __typename?: 'UploadFile', hash: string, mime: string, name: string, provider: string, size: number, url: string, alternativeText?: string | null, ext?: string | null, height?: number | null, width?: number | null, createdAt?: any | null } | null } | null } | null } | { __typename?: 'ComponentBlocksHorizontalRule', id: string, hr?: string | null } | { __typename?: 'ComponentBlocksImage', id: string, isDecorative?: boolean | null, altText?: string | null, picture?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', id?: string | null, attributes?: { __typename?: 'UploadFile', hash: string, mime: string, name: string, provider: string, size: number, url: string, alternativeText?: string | null, ext?: string | null, height?: number | null, width?: number | null, createdAt?: any | null } | null } | null } | null } | { __typename?: 'ComponentBlocksSubHeading', id: string, subHeadingText?: string | null, subHeadingTag?: Enum_Componentblockssubheading_Subheadingtag | null } | { __typename?: 'ComponentBlocksVideo', id: string, videoLink?: string | null, transcriptText?: string | null } | { __typename?: 'ComponentBlocksWysiwyg', id: string, textEditor?: string | null } | { __typename?: 'Error' } | null> | null } | null } | null } | null };
...
export type GetFreeContentByIdQuery = { __typename?: 'Query', freeContent?: { __typename?: 'FreeContentEntityResponse', data?: { __typename?: 'FreeContentEntity', id?: string | null, attributes?: { __typename?: 'FreeContent', customId?: string | null, title: string, shortDescription?: string | null, status?: Enum_Freecontent_Status | null, publishedDate?: any | null, unpublishedDate?: any | null, createdAt?: any | null, updatedAt?: any | null, freeContentSubService?: { __typename?: 'FreeContentSubServiceEntityResponse', data?: { __typename?: 'FreeContentSubServiceEntity', id?: string | null } | null } | null, tags?: { __typename?: 'TagRelationResponseCollection', data: Array<{ __typename?: 'TagEntity', id?: string | null, attributes?: { __typename?: 'Tag', name: string } | null }> } | null, image: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', id?: string | null, attributes?: { __typename?: 'UploadFile', hash: string, mime: string, name: string, provider: string, size: number, url: string, alternativeText?: string | null, ext?: string | null, height?: number | null, width?: number | null, createdAt?: any | null } | null } | null }, blocks?: Array<{ __typename?: 'ComponentBlocksFile', id: string, document?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', id?: string | null, attributes?: { __typename?: 'UploadFile', hash: string, mime: string, name: string, provider: string, size: number, url: string, alternativeText?: string | null, createdAt?: any | null, ext?: string | null, width?: number | null, height?: number | null } | null } | null } | null } | { __typename?: 'ComponentBlocksHorizontalRule', id: string, hr?: string | null } | { __typename?: 'ComponentBlocksImage', id: string, isDecorative?: boolean | null, altText?: string | null, picture?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', id?: string | null, attributes?: { __typename?: 'UploadFile', hash: string, mime: string, name: string, provider: string, size: number, url: string, alternativeText?: string | null, createdAt?: any | null, ext?: string | null, width?: number | null, height?: number | null } | null } | null } | null } | { __typename?: 'ComponentBlocksSubHeading', id: string, subHeadingText?: string | null, subHeadingTag?: Enum_Componentblockssubheading_Subheadingtag | null } | { __typename?: 'ComponentBlocksVideo', id: string, videoLink?: string | null, transcriptText?: string | null } | { __typename?: 'ComponentBlocksWysiwyg', id: string, textEditor?: string | null } | { __typename?: 'Error' } | null> | null } | null } | null } | null };
...
export type GetFreeContentSubServiceByIdQuery = { __typename?: 'Query', freeContentSubService?: { __typename?: 'FreeContentSubServiceEntityResponse', data?: { __typename?: 'FreeContentSubServiceEntity', id?: string | null, attributes?: { __typename?: 'FreeContentSubService', name: string, isActivated: boolean } | null } | null } | null };
...
export type GetFreeContentsBySubServiceIdQuery = { __typename?: 'Query', freeContentsCount?: { __typename?: 'FreeContentEntityResponseCollection', meta: { __typename?: 'ResponseCollectionMeta', pagination: { __typename?: 'Pagination', total: number } } } | null, freeContentsCountDraft?: { __typename?: 'FreeContentEntityResponseCollection', meta: { __typename?: 'ResponseCollectionMeta', pagination: { __typename?: 'Pagination', total: number } } } | null, freeContentsCountPublished?: { __typename?: 'FreeContentEntityResponseCollection', meta: { __typename?: 'ResponseCollectionMeta', pagination: { __typename?: 'Pagination', total: number } } } | null, freeContentsCountArchived?: { __typename?: 'FreeContentEntityResponseCollection', meta: { __typename?: 'ResponseCollectionMeta', pagination: { __typename?: 'Pagination', total: number } } } | null, freeContents?: { __typename?: 'FreeContentEntityResponseCollection', meta: { __typename?: 'ResponseCollectionMeta', pagination: { __typename?: 'Pagination', page: number, pageSize: number, pageCount: number, total: number } }, data: Array<{ __typename?: 'FreeContentEntity', id?: string | null, attributes?: { __typename?: 'FreeContent', title: string, shortDescription?: string | null, status?: Enum_Freecontent_Status | null, publishedDate?: any | null, unpublishedDate?: any | null } | null }> } | null };
...
export type UpdateFreeContentMutation = { __typename?: 'Mutation', updateFreeContent?: { __typename?: 'FreeContentEntityResponse', data?: { __typename?: 'FreeContentEntity', id?: string | null, attributes?: { __typename?: 'FreeContent', title: string, shortDescription?: string | null, status?: Enum_Freecontent_Status | null, publishedDate?: any | null, unpublishedDate?: any | null, createdAt?: any | null, updatedAt?: any | null, freeContentSubService?: { __typename?: 'FreeContentSubServiceEntityResponse', data?: { __typename?: 'FreeContentSubServiceEntity', id?: string | null } | null } | null, tags?: { __typename?: 'TagRelationResponseCollection', data: Array<{ __typename?: 'TagEntity', id?: string | null, attributes?: { __typename?: 'Tag', name: string } | null }> } | null, image: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', id?: string | null, attributes?: { __typename?: 'UploadFile', hash: string, mime: string, name: string, provider: string, size: number, url: string, alternativeText?: string | null, ext?: string | null, height?: number | null, width?: number | null, createdAt?: any | null } | null } | null }, blocks?: Array<{ __typename?: 'ComponentBlocksFile', id: string, document?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', id?: string | null, attributes?: { __typename?: 'UploadFile', hash: string, mime: string, name: string, provider: string, size: number, url: string, alternativeText?: string | null, ext?: string | null, height?: number | null, width?: number | null, createdAt?: any | null } | null } | null } | null } | { __typename?: 'ComponentBlocksHorizontalRule', id: string, hr?: string | null } | { __typename?: 'ComponentBlocksImage', id: string, isDecorative?: boolean | null, altText?: string | null, picture?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', id?: string | null, attributes?: { __typename?: 'UploadFile', hash: string, mime: string, name: string, provider: string, size: number, url: string, alternativeText?: string | null, ext?: string | null, height?: number | null, width?: number | null, createdAt?: any | null } | null } | null } | null } | { __typename?: 'ComponentBlocksSubHeading', id: string, subHeadingText?: string | null, subHeadingTag?: Enum_Componentblockssubheading_Subheadingtag | null } | { __typename?: 'ComponentBlocksVideo', id: string, videoLink?: string | null, transcriptText?: string | null } | { __typename?: 'ComponentBlocksWysiwyg', id: string, textEditor?: string | null } | { __typename?: 'Error' } | null> | null } | null } | null } | null };
...
export type GetTagsByContractIdQuery = { __typename?: 'Query', tags?: { __typename?: 'TagEntityResponseCollection', data: Array<{ __typename?: 'TagEntity', id?: string | null, attributes?: { __typename?: 'Tag', name: string } | null }> } | null };
...
export type CountContentPerTagQuery = { __typename?: 'Query', countContentPerTag?: Array<{ __typename?: 'totalCountPerTag', id: string, name: string, count: number } | null> | null };
...
export type CreateNewTagMutation = { __typename?: 'Mutation', createNewTag?: { __typename?: 'RequestTagEntity', contractId?: string | null, id?: string | null, name?: string | null } | null };
...
export type DeleteTagMutation = { __typename?: 'Mutation', deleteTag?: { __typename?: 'TagEntityResponse', data?: { __typename?: 'TagEntity', id?: string | null, attributes?: { __typename?: 'Tag', name: string, createdAt?: any | null } | null } | null } | null };
...
export type UpdateTagMutation = { __typename?: 'Mutation', updateTag?: { __typename?: 'TagEntityResponse', data?: { __typename?: 'TagEntity', id?: string | null, attributes?: { __typename?: 'Tag', name: string, createdAt?: any | null } | null } | null } | null };
...
export type CreateContentTypeMutation = { __typename?: 'Mutation', createContentTypeForContractId?: { __typename?: 'FreeContentSubServiceEntity', id?: string | null } | null };
...
export type GetContentTypeDtOsQuery = { __typename?: 'Query', getContentTypeDTOs?: Array<{ __typename?: 'ContentTypeDTO', subServiceId: string, type: string, name: string, description?: string | null } | null> | null };
...
export type UpdateContentTypeCookiesMutation = { __typename?: 'Mutation', updateCookiesSubService?: { __typename?: 'CookiesSubServiceEntityResponse', data?: { __typename?: 'CookiesSubServiceEntity', id?: string | null, attributes?: { __typename?: 'CookiesSubService', name: string, description?: string | null } | null } | null } | null };
...
export type UpdateContentTypeAccessibilityMutation = { __typename?: 'Mutation', updateAccessibilitySubService?: { __typename?: 'AccessibilitySubServiceEntityResponse', data?: { __typename?: 'AccessibilitySubServiceEntity', id?: string | null, attributes?: { __typename?: 'AccessibilitySubService', name: string, description?: string | null } | null } | null } | null };
...
export type UpdateContentTypeContactUsMutation = { __typename?: 'Mutation', updateContactUsSubService?: { __typename?: 'ContactUsSubServiceEntityResponse', data?: { __typename?: 'ContactUsSubServiceEntity', id?: string | null, attributes?: { __typename?: 'ContactUsSubService', name: string, description?: string | null } | null } | null } | null };
...
export type UpdateContentTypeCguMutation = { __typename?: 'Mutation', updateCguSubService?: { __typename?: 'CguSubServiceEntityResponse', data?: { __typename?: 'CguSubServiceEntity', id?: string | null, attributes?: { __typename?: 'CguSubService', name: string, description?: string | null } | null } | null } | null };
...
export type UpdateContentTypeConfidentialityMutation = { __typename?: 'Mutation', updateConfidentialitySubService?: { __typename?: 'ConfidentialitySubServiceEntityResponse', data?: { __typename?: 'ConfidentialitySubServiceEntity', id?: string | null, attributes?: { __typename?: 'ConfidentialitySubService', name: string, description?: string | null } | null } | null } | null };
...
export type UpdateContentTypeNewsMutation = { __typename?: 'Mutation', updateNewsSubService?: { __typename?: 'NewsSubServiceEntityResponse', data?: { __typename?: 'NewsSubServiceEntity', id?: string | null, attributes?: { __typename?: 'NewsSubService', name: string, description?: string | null } | null } | null } | null };
...
export type UpdateContentTypeTipMutation = { __typename?: 'Mutation', updateTipSubService?: { __typename?: 'TipSubServiceEntityResponse', data?: { __typename?: 'TipSubServiceEntity', id?: string | null, attributes?: { __typename?: 'TipSubService', name: string, description?: string | null } | null } | null } | null };
...
export type UpdateContentTypeQuizMutation = { __typename?: 'Mutation', updateQuizSubService?: { __typename?: 'QuizSubServiceEntityResponse', data?: { __typename?: 'QuizSubServiceEntity', id?: string | null, attributes?: { __typename?: 'QuizSubService', name: string, description?: string | null } | null } | null } | null };
...
export type UpdateContentTypeEventMutation = { __typename?: 'Mutation', updateEventSubService?: { __typename?: 'EventSubServiceEntityResponse', data?: { __typename?: 'EventSubServiceEntity', id?: string | null, attributes?: { __typename?: 'EventSubService', name: string, description?: string | null } | null } | null } | null };
...
export type UpdateContentTypeFreeContentMutation = { __typename?: 'Mutation', updateFreeContentSubService?: { __typename?: 'FreeContentSubServiceEntityResponse', data?: { __typename?: 'FreeContentSubServiceEntity', id?: string | null, attributes?: { __typename?: 'FreeContentSubService', name: string, description?: string | null } | null } | null } | null };
...
export type GetCollectionMethodsByContractIdQuery = { __typename?: 'Query', collectDoorToDoors?: { __typename?: 'CollectDoorToDoorEntityResponseCollection', data: Array<{ __typename?: 'CollectDoorToDoorEntity', id?: string | null, attributes?: { __typename?: 'CollectDoorToDoor', name?: string | null } | null }> } | null, collectDropOffs?: { __typename?: 'CollectDropOffEntityResponseCollection', data: Array<{ __typename?: 'CollectDropOffEntity', id?: string | null, attributes?: { __typename?: 'CollectDropOff', name?: string | null } | null }> } | null, collectVoluntaries?: { __typename?: 'CollectVoluntaryEntityResponseCollection', data: Array<{ __typename?: 'CollectVoluntaryEntity', id?: string | null, attributes?: { __typename?: 'CollectVoluntary', name?: string | null } | null }> } | null };
...
export type GetColorsQuery = { __typename?: 'Query', flowColors?: { __typename?: 'FlowColorEntityResponseCollection', data: Array<{ __typename?: 'FlowColorEntity', id?: string | null, attributes?: { __typename?: 'FlowColor', name: string, hexaCode: string, shouldChangeHexaCode: boolean } | null }> } | null };
...
export type GetFlowsByContractIdQuery = { __typename?: 'Query', flows?: { __typename?: 'FlowEntityResponseCollection', data: Array<{ __typename?: 'FlowEntity', id?: string | null, attributes?: { __typename?: 'Flow', name?: string | null, isActivated?: boolean | null, createdAt?: any | null, recyclingGesture: Enum_Flow_Recyclinggesture, code?: string | null, wasteForms?: { __typename?: 'WasteFormRelationResponseCollection', data: Array<{ __typename?: 'WasteFormEntity', id?: string | null, attributes?: { __typename?: 'WasteForm', name?: string | null } | null }> } | null, color?: { __typename?: 'FlowColorEntityResponse', data?: { __typename?: 'FlowColorEntity', id?: string | null, attributes?: { __typename?: 'FlowColor', hexaCode: string, name: string } | null } | null } | null, collectVoluntaries?: { __typename?: 'CollectVoluntaryRelationResponseCollection', data: Array<{ __typename?: 'CollectVoluntaryEntity', id?: string | null, attributes?: { __typename?: 'CollectVoluntary', name?: string | null } | null }> } | null, collectDoorToDoors?: { __typename?: 'CollectDoorToDoorRelationResponseCollection', data: Array<{ __typename?: 'CollectDoorToDoorEntity', id?: string | null, attributes?: { __typename?: 'CollectDoorToDoor', name?: string | null } | null }> } | null, collectDropOffs?: { __typename?: 'CollectDropOffRelationResponseCollection', data: Array<{ __typename?: 'CollectDropOffEntity', id?: string | null, attributes?: { __typename?: 'CollectDropOff', name?: string | null } | null }> } | null } | null }> } | null };
...
export type UpdateFlowMutation = { __typename?: 'Mutation', updateFlow?: { __typename?: 'FlowEntityResponse', data?: { __typename?: 'FlowEntity', id?: string | null, attributes?: { __typename?: 'Flow', name?: string | null, isActivated?: boolean | null, recyclingGesture: Enum_Flow_Recyclinggesture, code?: string | null, color?: { __typename?: 'FlowColorEntityResponse', data?: { __typename?: 'FlowColorEntity', id?: string | null, attributes?: { __typename?: 'FlowColor', hexaCode: string, name: string } | null } | null } | null, collectDoorToDoors?: { __typename?: 'CollectDoorToDoorRelationResponseCollection', data: Array<{ __typename?: 'CollectDoorToDoorEntity', id?: string | null, attributes?: { __typename?: 'CollectDoorToDoor', name?: string | null } | null }> } | null, collectDropOffs?: { __typename?: 'CollectDropOffRelationResponseCollection', data: Array<{ __typename?: 'CollectDropOffEntity', id?: string | null, attributes?: { __typename?: 'CollectDropOff', name?: string | null } | null }> } | null, collectVoluntaries?: { __typename?: 'CollectVoluntaryRelationResponseCollection', data: Array<{ __typename?: 'CollectVoluntaryEntity', id?: string | null, attributes?: { __typename?: 'CollectVoluntary', name?: string | null } | null }> } | null } | null } | null } | null };
...
export type GetContractByIdQuery = { __typename?: 'Query', contract?: { __typename?: 'ContractEntityResponse', data?: { __typename?: 'ContractEntity', id?: string | null, attributes?: { __typename?: 'Contract', clientName: string, clientType: Enum_Contract_Clienttype, contractStatus: Enum_Contract_Contractstatus, siret?: any | null, clear?: any | null, ccap?: any | null, isNonExclusive: boolean, isRVFrance: boolean, pathId?: any | null, logo: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', id?: string | null, attributes?: { __typename?: 'UploadFile', hash: string, mime: string, name: string, provider: string, size: number, url: string, alternativeText?: string | null } | null } | null }, channelType?: { __typename?: 'ChannelTypeEntityResponse', data?: { __typename?: 'ChannelTypeEntity', id?: string | null, attributes?: { __typename?: 'ChannelType', hasWebApp?: boolean | null, hasWebSite?: boolean | null } | null } | null } | null, clientContact?: { __typename?: 'ClientContactEntityResponse', data?: { __typename?: 'ClientContactEntity', id?: string | null, attributes?: { __typename?: 'ClientContact', firstName: string, lastName: string, email: string, phoneNumber: string } | null } | null } | null, contractCustomization?: { __typename?: 'ContractCustomizationEntityResponse', data?: { __typename?: 'ContractCustomizationEntity', id?: string | null, attributes?: { __typename?: 'ContractCustomization', primaryColor: string, secondaryColor?: string | null, textContrast: string } | null } | null } | null, editorialService?: { __typename?: 'EditorialServiceEntityResponse', data?: { __typename?: 'EditorialServiceEntity', id?: string | null, attributes?: { __typename?: 'EditorialService', eventSubService?: { __typename?: 'EventSubServiceEntityResponse', data?: { __typename?: 'EventSubServiceEntity', id?: string | null, attributes?: { __typename?: 'EventSubService', name: string, isActivated: boolean } | null } | null } | null, freeContentSubServices?: { __typename?: 'FreeContentSubServiceRelationResponseCollection', data: Array<{ __typename?: 'FreeContentSubServiceEntity', id?: string | null, attributes?: { __typename?: 'FreeContentSubService', name: string, isActivated: boolean } | null }> } | null, newsSubService?: { __typename?: 'NewsSubServiceEntityResponse', data?: { __typename?: 'NewsSubServiceEntity', id?: string | null, attributes?: { __typename?: 'NewsSubService', name: string, isActivated: boolean } | null } | null } | null, quizSubService?: { __typename?: 'QuizSubServiceEntityResponse', data?: { __typename?: 'QuizSubServiceEntity', id?: string | null, attributes?: { __typename?: 'QuizSubService', name: string, isActivated: boolean } | null } | null } | null, tipSubService?: { __typename?: 'TipSubServiceEntityResponse', data?: { __typename?: 'TipSubServiceEntity', id?: string | null, attributes?: { __typename?: 'TipSubService', name: string, isActivated: boolean } | null } | null } | null } | null } | null } | null, recyclingGuideService?: { __typename?: 'RecyclingGuideServiceEntityResponse', data?: { __typename?: 'RecyclingGuideServiceEntity', id?: string | null, attributes?: { __typename?: 'RecyclingGuideService', name: string, isActivated: boolean, memoName: string } | null } | null } | null, pickUpDayService?: { __typename?: 'PickUpDayServiceEntityResponse', data?: { __typename?: 'PickUpDayServiceEntity', id?: string | null, attributes?: { __typename?: 'PickUpDayService', name: string, isActivated: boolean } | null } | null } | null, dropOffMapService?: { __typename?: 'DropOffMapServiceEntityResponse', data?: { __typename?: 'DropOffMapServiceEntity', id?: string | null, attributes?: { __typename?: 'DropOffMapService', name?: string | null, isActivated: boolean } | null } | null } | null, requestService?: { __typename?: 'RequestServiceEntityResponse', data?: { __typename?: 'RequestServiceEntity', id?: string | null, attributes?: { __typename?: 'RequestService', name: string, isActivated: boolean } | null } | null } | null } | null } | null } | null };

export type GetContractsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetContractsQuery = { __typename?: 'Query', contracts?: { __typename?: 'ContractEntityResponseCollection', data: Array<{ __typename?: 'ContractEntity', id?: string | null, attributes?: { __typename?: 'Contract', clientName: string, contractStatus: Enum_Contract_Contractstatus, dueDate?: any | null, hasYesWeScan?: boolean | null, clientType: Enum_Contract_Clienttype, isNonExclusive: boolean, isRVFrance: boolean, logo: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', id?: string | null, attributes?: { __typename?: 'UploadFile', hash: string, mime: string, name: string, provider: string, size: number, url: string, alternativeText?: string | null } | null } | null }, channelType?: { __typename?: 'ChannelTypeEntityResponse', data?: { __typename?: 'ChannelTypeEntity', id?: string | null, attributes?: { __typename?: 'ChannelType', hasWebApp?: boolean | null, hasWebSite?: boolean | null } | null } | null } | null } | null }> } | null };
...
export type GetServicesActiveQuery = { __typename?: 'Query', editorialServices?: { __typename?: 'EditorialServiceEntityResponseCollection', data: Array<{ __typename?: 'EditorialServiceEntity', attributes?: { __typename?: 'EditorialService', eventSubService?: { __typename?: 'EventSubServiceEntityResponse', data?: { __typename?: 'EventSubServiceEntity', attributes?: { __typename?: 'EventSubService', isActivated: boolean } | null } | null } | null, newsSubService?: { __typename?: 'NewsSubServiceEntityResponse', data?: { __typename?: 'NewsSubServiceEntity', attributes?: { __typename?: 'NewsSubService', isActivated: boolean } | null } | null } | null, quizSubService?: { __typename?: 'QuizSubServiceEntityResponse', data?: { __typename?: 'QuizSubServiceEntity', attributes?: { __typename?: 'QuizSubService', isActivated: boolean } | null } | null } | null, tipSubService?: { __typename?: 'TipSubServiceEntityResponse', data?: { __typename?: 'TipSubServiceEntity', attributes?: { __typename?: 'TipSubService', isActivated: boolean } | null } | null } | null, freeContentSubServices?: { __typename?: 'FreeContentSubServiceRelationResponseCollection', data: Array<{ __typename?: 'FreeContentSubServiceEntity', attributes?: { __typename?: 'FreeContentSubService', isActivated: boolean } | null }> } | null, contactUsSubService?: { __typename?: 'ContactUsSubServiceEntityResponse', data?: { __typename?: 'ContactUsSubServiceEntity', attributes?: { __typename?: 'ContactUsSubService', isActivated?: boolean | null } | null } | null } | null } | null }> } | null, recyclingGuideServices?: { __typename?: 'RecyclingGuideServiceEntityResponseCollection', data: Array<{ __typename?: 'RecyclingGuideServiceEntity', attributes?: { __typename?: 'RecyclingGuideService', isActivated: boolean } | null }> } | null, requestServices?: { __typename?: 'RequestServiceEntityResponseCollection', data: Array<{ __typename?: 'RequestServiceEntity', attributes?: { __typename?: 'RequestService', isActivated: boolean } | null }> } | null };
...
export type GetEditoBlockTabQuery = { __typename?: 'Query', getEditoBlockDTO?: { __typename?: 'EditoBlockDTO', id: string, displayBlock: boolean, titleContent: string, editoContents?: Array<{ __typename?: 'EditoContentDTO', id: string, contentType: string, typeName: string, attributes: { __typename?: 'EditoContentDTOAttributes', title: string, status?: Enum_Editocontentdto_Status | null, publishedDate?: any | null } } | null> | null } | null, getEditoContentDTOs?: Array<{ __typename?: 'EditoContentDTO', id: string, contentType: string, typeName: string, attributes: { __typename?: 'EditoContentDTOAttributes', title: string, status?: Enum_Editocontentdto_Status | null, publishedDate?: any | null } } | null> | null };
...
export type GetQuizAndTipsBlockTabQuery = { __typename?: 'Query', contractCustomizations?: { __typename?: 'ContractCustomizationEntityResponseCollection', data: Array<{ __typename?: 'ContractCustomizationEntity', attributes?: { __typename?: 'ContractCustomization', homepage?: { __typename?: 'HomepageEntityResponse', data?: { __typename?: 'HomepageEntity', attributes?: { __typename?: 'Homepage', quizAndTipsBlock?: { __typename?: 'QuizAndTipsBlockEntityResponse', data?: { __typename?: 'QuizAndTipsBlockEntity', id?: string | null, attributes?: { __typename?: 'QuizAndTipsBlock', titleContent: string, displayBlock: boolean, displayQuiz: boolean, displayTips: boolean, quiz?: { __typename?: 'QuizEntityResponse', data?: { __typename?: 'QuizEntity', id?: string | null, attributes?: { __typename?: 'Quiz', title?: string | null, status?: Enum_Quiz_Status | null, publishedDate?: any | null } | null } | null } | null, tips?: { __typename?: 'TipRelationResponseCollection', data: Array<{ __typename?: 'TipEntity', id?: string | null, attributes?: { __typename?: 'Tip', title: string, status?: Enum_Tip_Status | null, publishedDate?: any | null, image: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', attributes?: { __typename?: 'UploadFile', hash: string, mime: string, name: string, provider: string, size: number, url: string, alternativeText?: string | null } | null } | null } } | null }> } | null } | null } | null } | null } | null } | null } | null } | null }> } | null, quizSubServices?: { __typename?: 'QuizSubServiceEntityResponseCollection', data: Array<{ __typename?: 'QuizSubServiceEntity', attributes?: { __typename?: 'QuizSubService', quizzes?: { __typename?: 'QuizRelationResponseCollection', data: Array<{ __typename?: 'QuizEntity', id?: string | null, attributes?: { __typename?: 'Quiz', title?: string | null, status?: Enum_Quiz_Status | null, publishedDate?: any | null } | null }> } | null } | null }> } | null, tipSubServices?: { __typename?: 'TipSubServiceEntityResponseCollection', data: Array<{ __typename?: 'TipSubServiceEntity', attributes?: { __typename?: 'TipSubService', tips?: { __typename?: 'TipRelationResponseCollection', data: Array<{ __typename?: 'TipEntity', id?: string | null, attributes?: { __typename?: 'Tip', title: string, status?: Enum_Tip_Status | null, publishedDate?: any | null, image: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', attributes?: { __typename?: 'UploadFile', hash: string, mime: string, name: string, provider: string, size: number, url: string, alternativeText?: string | null } | null } | null } } | null }> } | null } | null }> } | null };
...
export type GetRecyclingGuideBlockTabQuery = { __typename?: 'Query', contractCustomizations?: { __typename?: 'ContractCustomizationEntityResponseCollection', data: Array<{ __typename?: 'ContractCustomizationEntity', attributes?: { __typename?: 'ContractCustomization', homepage?: { __typename?: 'HomepageEntityResponse', data?: { __typename?: 'HomepageEntity', attributes?: { __typename?: 'Homepage', recyclingGuideBlock?: { __typename?: 'RecyclingGuideBlockEntityResponse', data?: { __typename?: 'RecyclingGuideBlockEntity', id?: string | null, attributes?: { __typename?: 'RecyclingGuideBlock', titleContent: string, subtitleContent: string, recyclingGuideDisplayContent: string, tags?: { __typename?: 'TagRelationResponseCollection', data: Array<{ __typename?: 'TagEntity', attributes?: { __typename?: 'Tag', name: string } | null }> } | null } | null } | null } | null } | null } | null } | null } | null }> } | null };
...
export type GetSearchEngineBlockTabQuery = { __typename?: 'Query', contractCustomizations?: { __typename?: 'ContractCustomizationEntityResponseCollection', data: Array<{ __typename?: 'ContractCustomizationEntity', attributes?: { __typename?: 'ContractCustomization', homepage?: { __typename?: 'HomepageEntityResponse', data?: { __typename?: 'HomepageEntity', attributes?: { __typename?: 'Homepage', searchEngineBlock?: { __typename?: 'SearchEngineBlockEntityResponse', data?: { __typename?: 'SearchEngineBlockEntity', id?: string | null, attributes?: { __typename?: 'SearchEngineBlock', titleContent: string } | null } | null } | null } | null } | null } | null } | null }> } | null };
...
export type GetServicesBlockTabQuery = { __typename?: 'Query', contractCustomizations?: { __typename?: 'ContractCustomizationEntityResponseCollection', data: Array<{ __typename?: 'ContractCustomizationEntity', id?: string | null, attributes?: { __typename?: 'ContractCustomization', homepage?: { __typename?: 'HomepageEntityResponse', data?: { __typename?: 'HomepageEntity', attributes?: { __typename?: 'Homepage', servicesBlock?: { __typename?: 'ServicesBlockEntityResponse', data?: { __typename?: 'ServicesBlockEntity', id?: string | null, attributes?: { __typename?: 'ServicesBlock', titleContent: string, serviceLinks?: Array<{ __typename?: 'ComponentLinksAlertNotification' } | { __typename?: 'ComponentLinksContactUs', id: string, name?: string | null, isDisplayed: boolean, picto?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', attributes?: { __typename?: 'UploadFile', url: string } | null } | null } | null } | { __typename?: 'ComponentLinksDropOffMap', id: string, name?: string | null, isDisplayed: boolean, picto?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', attributes?: { __typename?: 'UploadFile', url: string } | null } | null } | null } | { __typename?: 'ComponentLinksEvents', id: string, name?: string | null, isDisplayed: boolean, picto?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', attributes?: { __typename?: 'UploadFile', url: string } | null } | null } | null } | { __typename?: 'ComponentLinksExternal', id: string, name?: string | null, isDisplayed: boolean, externalLink?: string | null, picto?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', attributes?: { __typename?: 'UploadFile', url: string } | null } | null } | null } | { __typename?: 'ComponentLinksFrees', id: string, name?: string | null, isDisplayed: boolean, picto?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', attributes?: { __typename?: 'UploadFile', url: string } | null } | null } | null } | { __typename?: 'ComponentLinksKeyMetrics' } | { __typename?: 'ComponentLinksMyWasteCounter' } | { __typename?: 'ComponentLinksNews', id: string, name?: string | null, isDisplayed: boolean, picto?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', attributes?: { __typename?: 'UploadFile', url: string } | null } | null } | null } | { __typename?: 'ComponentLinksPickUpDay', id: string, name?: string | null, isDisplayed: boolean, picto?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', attributes?: { __typename?: 'UploadFile', url: string } | null } | null } | null } | { __typename?: 'ComponentLinksQuizzes', id: string, name?: string | null, isDisplayed: boolean, picto?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', attributes?: { __typename?: 'UploadFile', url: string } | null } | null } | null } | { __typename?: 'ComponentLinksRecyclingGuide', id: string, name?: string | null, isDisplayed: boolean, picto?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', attributes?: { __typename?: 'UploadFile', url: string } | null } | null } | null } | { __typename?: 'ComponentLinksRequest', id: string, name?: string | null, isDisplayed: boolean, picto?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', attributes?: { __typename?: 'UploadFile', url: string } | null } | null } | null } | { __typename?: 'ComponentLinksTips', id: string, name?: string | null, isDisplayed: boolean, picto?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', attributes?: { __typename?: 'UploadFile', url: string } | null } | null } | null } | { __typename?: 'Error' } | null> | null } | null } | null } | null } | null } | null } | null } | null }> } | null };
...
export type GetTopContentBlockTabQuery = { __typename?: 'Query', getTopContentBlockDTO?: { __typename?: 'TopContentBlockDTO', id: string, displayBlock: boolean, displayLastThreeContents: boolean, hasTopContent: boolean, titleContent: string, topContent?: { __typename?: 'TopContentDTO', id: string, contentType: string, typeName: string, attributes: { __typename?: 'TopContentDTOAttributes', title: string, status?: Enum_Topcontentdto_Status | null, publishedDate?: any | null } } | null } | null, getTopContentDTOs?: Array<{ __typename?: 'TopContentDTO', id: string, contentType: string, typeName: string, attributes: { __typename?: 'TopContentDTOAttributes', title: string, status?: Enum_Topcontentdto_Status | null, publishedDate?: any | null } } | null> | null };
...
export type UpdateEditoBlockTabMutation = { __typename?: 'Mutation', updateEditoBlock?: { __typename?: 'EditoBlockEntityResponse', data?: { __typename?: 'EditoBlockEntity', id?: string | null, attributes?: { __typename?: 'EditoBlock', displayBlock: boolean, titleContent: string, editoContents?: { __typename?: 'EditoContentRelationResponseCollection', data: Array<{ __typename?: 'EditoContentEntity', id?: string | null }> } | null } | null } | null } | null };
...
export type UpdateQuizAndTipsBlockTabMutation = { __typename?: 'Mutation', updateQuizAndTipsBlock?: { __typename?: 'QuizAndTipsBlockEntityResponse', data?: { __typename?: 'QuizAndTipsBlockEntity', attributes?: { __typename?: 'QuizAndTipsBlock', titleContent: string, displayBlock: boolean, displayQuiz: boolean, displayTips: boolean, quiz?: { __typename?: 'QuizEntityResponse', data?: { __typename?: 'QuizEntity', id?: string | null } | null } | null, tips?: { __typename?: 'TipRelationResponseCollection', data: Array<{ __typename?: 'TipEntity', id?: string | null }> } | null } | null } | null } | null };
...
export type UpdateRecyclingGuideTabMutation = { __typename?: 'Mutation', updateRecyclingGuideBlock?: { __typename?: 'RecyclingGuideBlockEntityResponse', data?: { __typename?: 'RecyclingGuideBlockEntity', attributes?: { __typename?: 'RecyclingGuideBlock', titleContent: string, subtitleContent: string, recyclingGuideDisplayContent: string, tags?: { __typename?: 'TagRelationResponseCollection', data: Array<{ __typename?: 'TagEntity', attributes?: { __typename?: 'Tag', name: string } | null }> } | null } | null } | null } | null };
...
export type UpdateSearchEngineBlockTabMutation = { __typename?: 'Mutation', updateSearchEngineBlock?: { __typename?: 'SearchEngineBlockEntityResponse', data?: { __typename?: 'SearchEngineBlockEntity', attributes?: { __typename?: 'SearchEngineBlock', titleContent: string } | null } | null } | null };
...
export type UpdateServicesBlockTabMutation = { __typename?: 'Mutation', updateServicesBlock?: { __typename?: 'ServicesBlockEntityResponse', data?: { __typename?: 'ServicesBlockEntity', id?: string | null, attributes?: { __typename?: 'ServicesBlock', homepage?: { __typename?: 'HomepageEntityResponse', data?: { __typename?: 'HomepageEntity', attributes?: { __typename?: 'Homepage', servicesBlock?: { __typename?: 'ServicesBlockEntityResponse', data?: { __typename?: 'ServicesBlockEntity', id?: string | null, attributes?: { __typename?: 'ServicesBlock', titleContent: string, serviceLinks?: Array<{ __typename?: 'ComponentLinksAlertNotification' } | { __typename?: 'ComponentLinksContactUs', id: string, name?: string | null, isDisplayed: boolean, picto?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', attributes?: { __typename?: 'UploadFile', url: string } | null } | null } | null } | { __typename?: 'ComponentLinksDropOffMap', id: string, name?: string | null, isDisplayed: boolean, picto?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', attributes?: { __typename?: 'UploadFile', url: string } | null } | null } | null } | { __typename?: 'ComponentLinksEvents', id: string, name?: string | null, isDisplayed: boolean, picto?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', attributes?: { __typename?: 'UploadFile', url: string } | null } | null } | null } | { __typename?: 'ComponentLinksExternal', id: string, name?: string | null, isDisplayed: boolean, externalLink?: string | null, picto?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', attributes?: { __typename?: 'UploadFile', url: string } | null } | null } | null } | { __typename?: 'ComponentLinksFrees', id: string, name?: string | null, isDisplayed: boolean, picto?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', attributes?: { __typename?: 'UploadFile', url: string } | null } | null } | null } | { __typename?: 'ComponentLinksKeyMetrics' } | { __typename?: 'ComponentLinksMyWasteCounter' } | { __typename?: 'ComponentLinksNews', id: string, name?: string | null, isDisplayed: boolean, picto?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', attributes?: { __typename?: 'UploadFile', url: string } | null } | null } | null } | { __typename?: 'ComponentLinksPickUpDay', id: string, name?: string | null, isDisplayed: boolean, picto?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', attributes?: { __typename?: 'UploadFile', url: string } | null } | null } | null } | { __typename?: 'ComponentLinksQuizzes', id: string, name?: string | null, isDisplayed: boolean, picto?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', attributes?: { __typename?: 'UploadFile', url: string } | null } | null } | null } | { __typename?: 'ComponentLinksRecyclingGuide', id: string, name?: string | null, isDisplayed: boolean, picto?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', attributes?: { __typename?: 'UploadFile', url: string } | null } | null } | null } | { __typename?: 'ComponentLinksRequest', id: string, name?: string | null, isDisplayed: boolean, picto?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', attributes?: { __typename?: 'UploadFile', url: string } | null } | null } | null } | { __typename?: 'ComponentLinksTips', id: string, name?: string | null, isDisplayed: boolean, picto?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', attributes?: { __typename?: 'UploadFile', url: string } | null } | null } | null } | { __typename?: 'Error' } | null> | null } | null } | null } | null } | null } | null } | null } | null } | null } | null };
...
export type UpdateTopContentBlockTabMutation = { __typename?: 'Mutation', updateTopContentBlock?: { __typename?: 'TopContentBlockEntityResponse', data?: { __typename?: 'TopContentBlockEntity', attributes?: { __typename?: 'TopContentBlock', homepage?: { __typename?: 'HomepageEntityResponse', data?: { __typename?: 'HomepageEntity', attributes?: { __typename?: 'Homepage', topContentBlock?: { __typename?: 'TopContentBlockEntityResponse', data?: { __typename?: 'TopContentBlockEntity', attributes?: { __typename?: 'TopContentBlock', displayBlock: boolean, titleContent: string, hasTopContent: boolean, displayLastThreeContents: boolean, topContent?: { __typename?: 'TopContentEntityResponse', data?: { __typename?: 'TopContentEntity', attributes?: { __typename?: 'TopContent', event?: { __typename?: 'EventEntityResponse', data?: { __typename?: 'EventEntity', attributes?: { __typename?: 'Event', title: string } | null } | null } | null, new?: { __typename?: 'NewEntityResponse', data?: { __typename?: 'NewEntity', attributes?: { __typename?: 'New', title: string } | null } | null } | null } | null } | null } | null } | null } | null } | null } | null } | null } | null } | null } | null } | null };
...
export type UpdateContractCustomizationMutation = { __typename?: 'Mutation', updateContractCustomization?: { __typename?: 'ContractCustomizationEntityResponse', data?: { __typename?: 'ContractCustomizationEntity', attributes?: { __typename?: 'ContractCustomization', primaryColor: string, secondaryColor?: string | null, textContrast: string } | null } | null } | null };
...
export type GetContractCustomizationByIdQuery = { __typename?: 'Query', contract?: { __typename?: 'ContractEntityResponse', data?: { __typename?: 'ContractEntity', id?: string | null, attributes?: { __typename?: 'Contract', logo: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', id?: string | null, attributes?: { __typename?: 'UploadFile', hash: string, mime: string, name: string, provider: string, size: number, url: string, alternativeText?: string | null } | null } | null }, contractCustomization?: { __typename?: 'ContractCustomizationEntityResponse', data?: { __typename?: 'ContractCustomizationEntity', id?: string | null, attributes?: { __typename?: 'ContractCustomization', primaryColor: string, secondaryColor?: string | null, textContrast: string } | null } | null } | null } | null } | null } | null };
...
export type UpdateContractCustomizationByIdMutation = { __typename?: 'Mutation', updateContract?: { __typename?: 'ContractEntityResponse', data?: { __typename?: 'ContractEntity', id?: string | null, attributes?: { __typename?: 'Contract', logo: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', id?: string | null, attributes?: { __typename?: 'UploadFile', name: string, alternativeText?: string | null, hash: string, mime: string, size: number, url: string, provider: string } | null } | null }, contractCustomization?: { __typename?: 'ContractCustomizationEntityResponse', data?: { __typename?: 'ContractCustomizationEntity', id?: string | null, attributes?: { __typename?: 'ContractCustomization', primaryColor: string, secondaryColor?: string | null, textContrast: string } | null } | null } | null } | null } | null } | null };
...
export type GetFooterPageQuery = { __typename?: 'Query', contractCustomizations?: { __typename?: 'ContractCustomizationEntityResponseCollection', data: Array<{ __typename?: 'ContractCustomizationEntity', attributes?: { __typename?: 'ContractCustomization', footer?: { __typename?: 'FooterEntityResponse', data?: { __typename?: 'FooterEntity', id?: string | null, attributes?: { __typename?: 'Footer', accessibilityLevel?: Enum_Footer_Accessibilitylevel | null, cguSubService?: { __typename?: 'CguSubServiceEntityResponse', data?: { __typename?: 'CguSubServiceEntity', id?: string | null, attributes?: { __typename?: 'CguSubService', link?: string | null } | null } | null } | null, accessibilitySubService?: { __typename?: 'AccessibilitySubServiceEntityResponse', data?: { __typename?: 'AccessibilitySubServiceEntity', id?: string | null, attributes?: { __typename?: 'AccessibilitySubService', link?: string | null } | null } | null } | null, confidentialitySubService?: { __typename?: 'ConfidentialitySubServiceEntityResponse', data?: { __typename?: 'ConfidentialitySubServiceEntity', id?: string | null, attributes?: { __typename?: 'ConfidentialitySubService', link?: string | null } | null } | null } | null, cookiesSubService?: { __typename?: 'CookiesSubServiceEntityResponse', data?: { __typename?: 'CookiesSubServiceEntity', id?: string | null, attributes?: { __typename?: 'CookiesSubService', link?: string | null } | null } | null } | null, contactUsSubService?: { __typename?: 'ContactUsSubServiceEntityResponse', data?: { __typename?: 'ContactUsSubServiceEntity', id?: string | null, attributes?: { __typename?: 'ContactUsSubService', label: string, link?: string | null } | null } | null } | null } | null } | null } | null } | null }> } | null };
...
export type UpdateFooterPageMutation = { __typename?: 'Mutation', updateFooter?: { __typename?: 'FooterEntityResponse', data?: { __typename?: 'FooterEntity', id?: string | null, attributes?: { __typename?: 'Footer', accessibilityLevel?: Enum_Footer_Accessibilitylevel | null } | null } | null } | null, updateContactUsSubService?: { __typename?: 'ContactUsSubServiceEntityResponse', data?: { __typename?: 'ContactUsSubServiceEntity', attributes?: { __typename?: 'ContactUsSubService', label: string, link?: string | null } | null } | null } | null, updateCguSubService?: { __typename?: 'CguSubServiceEntityResponse', data?: { __typename?: 'CguSubServiceEntity', attributes?: { __typename?: 'CguSubService', link?: string | null } | null } | null } | null, updateAccessibilitySubService?: { __typename?: 'AccessibilitySubServiceEntityResponse', data?: { __typename?: 'AccessibilitySubServiceEntity', attributes?: { __typename?: 'AccessibilitySubService', link?: string | null } | null } | null } | null, updateConfidentialitySubService?: { __typename?: 'ConfidentialitySubServiceEntityResponse', data?: { __typename?: 'ConfidentialitySubServiceEntity', attributes?: { __typename?: 'ConfidentialitySubService', link?: string | null } | null } | null } | null, updateCookiesSubService?: { __typename?: 'CookiesSubServiceEntityResponse', data?: { __typename?: 'CookiesSubServiceEntity', attributes?: { __typename?: 'CookiesSubService', link?: string | null } | null } | null } | null };
...
export type GetMenuPageQuery = { __typename?: 'Query', contract?: { __typename?: 'ContractEntityResponse', data?: { __typename?: 'ContractEntity', attributes?: { __typename?: 'Contract', contractMenu?: { __typename?: 'ContractMenuEntityResponse', data?: { __typename?: 'ContractMenuEntity', id?: string | null, attributes?: { __typename?: 'ContractMenu', serviceLinks?: Array<{ __typename?: 'ComponentLinksAlertNotification' } | { __typename?: 'ComponentLinksContactUs', id: string, name?: string | null, isDisplayed: boolean, picto?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', attributes?: { __typename?: 'UploadFile', url: string } | null } | null } | null } | { __typename?: 'ComponentLinksDropOffMap', id: string, name?: string | null, isDisplayed: boolean, picto?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', attributes?: { __typename?: 'UploadFile', url: string } | null } | null } | null } | { __typename?: 'ComponentLinksEvents', id: string, name?: string | null, isDisplayed: boolean, picto?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', attributes?: { __typename?: 'UploadFile', url: string } | null } | null } | null } | { __typename?: 'ComponentLinksExternal', id: string, name?: string | null, isDisplayed: boolean, externalLink?: string | null, picto?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', attributes?: { __typename?: 'UploadFile', url: string } | null } | null } | null } | { __typename?: 'ComponentLinksFrees', id: string, name?: string | null, isDisplayed: boolean, picto?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', attributes?: { __typename?: 'UploadFile', url: string } | null } | null } | null } | { __typename?: 'ComponentLinksKeyMetrics' } | { __typename?: 'ComponentLinksMyWasteCounter', id: string, name?: string | null, isDisplayed: boolean, picto?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', attributes?: { __typename?: 'UploadFile', url: string } | null } | null } | null } | { __typename?: 'ComponentLinksNews', id: string, name?: string | null, isDisplayed: boolean, picto?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', attributes?: { __typename?: 'UploadFile', url: string } | null } | null } | null } | { __typename?: 'ComponentLinksPickUpDay', id: string, name?: string | null, isDisplayed: boolean, picto?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', attributes?: { __typename?: 'UploadFile', url: string } | null } | null } | null } | { __typename?: 'ComponentLinksQuizzes', id: string, name?: string | null, isDisplayed: boolean, picto?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', attributes?: { __typename?: 'UploadFile', url: string } | null } | null } | null } | { __typename?: 'ComponentLinksRecyclingGuide', id: string, name?: string | null, isDisplayed: boolean, picto?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', attributes?: { __typename?: 'UploadFile', url: string } | null } | null } | null } | { __typename?: 'ComponentLinksRequest', id: string, name?: string | null, isDisplayed: boolean, picto?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', attributes?: { __typename?: 'UploadFile', url: string } | null } | null } | null } | { __typename?: 'ComponentLinksTips', id: string, name?: string | null, isDisplayed: boolean, picto?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', attributes?: { __typename?: 'UploadFile', url: string } | null } | null } | null } | { __typename?: 'Error' } | null> | null } | null } | null } | null } | null } | null } | null };
...
export type UpdateMenuPageMutation = { __typename?: 'Mutation', updateContractMenu?: { __typename?: 'ContractMenuEntityResponse', data?: { __typename?: 'ContractMenuEntity', attributes?: { __typename?: 'ContractMenu', serviceLinks?: Array<{ __typename?: 'ComponentLinksAlertNotification' } | { __typename?: 'ComponentLinksContactUs', id: string, name?: string | null, isDisplayed: boolean, picto?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', attributes?: { __typename?: 'UploadFile', url: string } | null } | null } | null } | { __typename?: 'ComponentLinksDropOffMap', id: string, name?: string | null, isDisplayed: boolean, picto?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', attributes?: { __typename?: 'UploadFile', url: string } | null } | null } | null } | { __typename?: 'ComponentLinksEvents', id: string, name?: string | null, isDisplayed: boolean, picto?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', attributes?: { __typename?: 'UploadFile', url: string } | null } | null } | null } | { __typename?: 'ComponentLinksExternal', id: string, name?: string | null, isDisplayed: boolean, externalLink?: string | null, picto?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', attributes?: { __typename?: 'UploadFile', url: string } | null } | null } | null } | { __typename?: 'ComponentLinksFrees', id: string, name?: string | null, isDisplayed: boolean, picto?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', attributes?: { __typename?: 'UploadFile', url: string } | null } | null } | null } | { __typename?: 'ComponentLinksKeyMetrics' } | { __typename?: 'ComponentLinksMyWasteCounter' } | { __typename?: 'ComponentLinksNews', id: string, name?: string | null, isDisplayed: boolean, picto?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', attributes?: { __typename?: 'UploadFile', url: string } | null } | null } | null } | { __typename?: 'ComponentLinksPickUpDay', id: string, name?: string | null, isDisplayed: boolean, picto?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', attributes?: { __typename?: 'UploadFile', url: string } | null } | null } | null } | { __typename?: 'ComponentLinksQuizzes', id: string, name?: string | null, isDisplayed: boolean, picto?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', attributes?: { __typename?: 'UploadFile', url: string } | null } | null } | null } | { __typename?: 'ComponentLinksRecyclingGuide', id: string, name?: string | null, isDisplayed: boolean, picto?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', attributes?: { __typename?: 'UploadFile', url: string } | null } | null } | null } | { __typename?: 'ComponentLinksRequest', id: string, name?: string | null, isDisplayed: boolean, picto?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', attributes?: { __typename?: 'UploadFile', url: string } | null } | null } | null } | { __typename?: 'ComponentLinksTips', id: string, name?: string | null, isDisplayed: boolean, picto?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', attributes?: { __typename?: 'UploadFile', url: string } | null } | null } | null } | { __typename?: 'Error' } | null> | null } | null } | null } | null };
...
export type CreateSectorizationMutation = { __typename?: 'Mutation', createSectorization?: { __typename?: 'SectorizationEntityResponse', data?: { __typename?: 'SectorizationEntity', id?: string | null, attributes?: { __typename?: 'Sectorization', createdAt?: any | null, description: string, name: string, polygonCoordinates?: any | null, updatedAt?: any | null } | null } | null } | null };
...
export type DeleteSectorizationMutation = { __typename?: 'Mutation', deleteSectorization?: { __typename?: 'SectorizationEntityResponse', data?: { __typename?: 'SectorizationEntity', id?: string | null, attributes?: { __typename?: 'Sectorization', createdAt?: any | null, description: string, name: string, polygonCoordinates?: any | null, updatedAt?: any | null } | null } | null } | null };
...
export type GetSectorizationByCityQuery = { __typename?: 'Query', sectorizationByCity?: { __typename?: 'CitySectorization', GeoJson?: string | null } | null };
...
export type GetSectorizationByContractIdQuery = { __typename?: 'Query', sectorization?: { __typename?: 'SectorizationEntityResponse', data?: { __typename?: 'SectorizationEntity', attributes?: { __typename?: 'Sectorization', name: string, description: string, polygonCoordinates?: any | null } | null } | null } | null };
...
export type GetSectorizationsByContractIdQuery = { __typename?: 'Query', sectorizations?: { __typename?: 'SectorizationEntityResponseCollection', data: Array<{ __typename?: 'SectorizationEntity', id?: string | null, attributes?: { __typename?: 'Sectorization', createdAt?: any | null, description: string, name: string, updatedAt?: any | null, polygonCoordinates?: any | null } | null }>, meta: { __typename?: 'ResponseCollectionMeta', pagination: { __typename?: 'Pagination', total: number, pageSize: number, page: number, pageCount: number } } } | null };
...
export type UpdateSectorizationMutation = { __typename?: 'Mutation', updateSectorization?: { __typename?: 'SectorizationEntityResponse', data?: { __typename?: 'SectorizationEntity', id?: string | null, attributes?: { __typename?: 'Sectorization', name: string, description: string, polygonCoordinates?: any | null, updatedAt?: any | null, createdAt?: any | null } | null } | null } | null };
...
export type CreateDropOffMapMutation = { __typename?: 'Mutation', createDropOffMap?: { __typename?: 'DropOffMapEntityResponse', data?: { __typename?: 'DropOffMapEntity', id?: string | null, attributes?: { __typename?: 'DropOffMap', name?: string | null, description?: string | null, phoneNumber?: string | null, mustKnow?: string | null, address?: string | null, gpsCoordinates?: string | null, downloadableFile?: Array<{ __typename?: 'ComponentBlocksDownloadBlock', id: string, linkText: string, file: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', id?: string | null, attributes?: { __typename?: 'UploadFile', name: string, hash: string, mime: string, size: number, url: string, provider: string, alternativeText?: string | null } | null } | null } } | null> | null, dropOffMapService?: { __typename?: 'DropOffMapServiceEntityResponse', data?: { __typename?: 'DropOffMapServiceEntity', id?: string | null, attributes?: { __typename?: 'DropOffMapService', name?: string | null, isActivated: boolean, startDate?: any | null, endDate?: any | null } | null } | null } | null, openingHoursBlock?: Array<{ __typename?: 'ComponentBlocksOpeningDay', id: string, weekDay: Enum_Componentblocksopeningday_Weekday, morningStart?: any | null, morningEnd?: any | null, afterNoonStart?: any | null, afterNoonEnd?: any | null } | { __typename?: 'Error', code: string, message?: string | null } | null> | null, collectDropOff?: { __typename?: 'CollectDropOffEntityResponse', data?: { __typename?: 'CollectDropOffEntity', id?: string | null, attributes?: { __typename?: 'CollectDropOff', name?: string | null } | null } | null } | null, collectVoluntary?: { __typename?: 'CollectVoluntaryEntityResponse', data?: { __typename?: 'CollectVoluntaryEntity', id?: string | null, attributes?: { __typename?: 'CollectVoluntary', name?: string | null } | null } | null } | null } | null } | null } | null };
...
export type DeleteDropOffMapMutation = { __typename?: 'Mutation', deleteDropOffMap?: { __typename?: 'DropOffMapEntityResponse', data?: { __typename?: 'DropOffMapEntity', id?: string | null, attributes?: { __typename?: 'DropOffMap', createdAt?: any | null, description?: string | null, name?: string | null, updatedAt?: any | null } | null } | null } | null };
...
export type GetDropOffMapByContractIdQuery = { __typename?: 'Query', dropOffMaps?: { __typename?: 'DropOffMapEntityResponseCollection', data: Array<{ __typename?: 'DropOffMapEntity', id?: string | null, attributes?: { __typename?: 'DropOffMap', createdAt?: any | null, description?: string | null, name?: string | null, updatedAt?: any | null, address?: string | null, gpsCoordinates?: string | null, city?: string | null, collectDropOff?: { __typename?: 'CollectDropOffEntityResponse', data?: { __typename?: 'CollectDropOffEntity', attributes?: { __typename?: 'CollectDropOff', name?: string | null } | null } | null } | null, collectVoluntary?: { __typename?: 'CollectVoluntaryEntityResponse', data?: { __typename?: 'CollectVoluntaryEntity', id?: string | null, attributes?: { __typename?: 'CollectVoluntary', name?: string | null } | null } | null } | null } | null }>, meta: { __typename?: 'ResponseCollectionMeta', pagination: { __typename?: 'Pagination', total: number, pageSize: number, page: number, pageCount: number } } } | null };
...
export type GetWasteFamiliesQuery = { __typename?: 'Query', recyclingGuideService?: { __typename?: 'RecyclingGuideServiceEntityResponse', data?: { __typename?: 'RecyclingGuideServiceEntity', id?: string | null, attributes?: { __typename?: 'RecyclingGuideService', wasteFamilies?: { __typename?: 'WasteFamilyRelationResponseCollection', data: Array<{ __typename?: 'WasteFamilyEntity', id?: string | null, attributes?: { __typename?: 'WasteFamily', familyName: string, isSystem: boolean, wasteForms?: { __typename?: 'WasteFormRelationResponseCollection', data: Array<{ __typename?: 'WasteFormEntity', id?: string | null, attributes?: { __typename?: 'WasteForm', name?: string | null } | null }> } | null } | null }> } | null } | null } | null } | null };
...
export type GetWasteFamiliesByContractIdQuery = { __typename?: 'Query', recyclingGuideService?: { __typename?: 'RecyclingGuideServiceEntityResponse', data?: { __typename?: 'RecyclingGuideServiceEntity', id?: string | null, attributes?: { __typename?: 'RecyclingGuideService', wasteFamilies?: { __typename?: 'WasteFamilyRelationResponseCollection', data: Array<{ __typename?: 'WasteFamilyEntity', id?: string | null, attributes?: { __typename?: 'WasteFamily', familyName: string, isSystem: boolean } | null }> } | null } | null } | null } | null };
...
export type UpdateWasteFamilyMutation = { __typename?: 'Mutation', updateWasteFamily?: { __typename?: 'WasteFamilyEntityResponse', data?: { __typename?: 'WasteFamilyEntity', id?: string | null, attributes?: { __typename?: 'WasteFamily', familyName: string, createdAt?: any | null, updatedAt?: any | null, isSystem: boolean } | null } | null } | null };
...
export type GetFlowsFilterByContractIdQuery = { __typename?: 'Query', flows?: { __typename?: 'FlowEntityResponseCollection', data: Array<{ __typename?: 'FlowEntity', id?: string | null, attributes?: { __typename?: 'Flow', name?: string | null, recyclingGesture: Enum_Flow_Recyclinggesture } | null }> } | null };
...
export type GetWasteFormByIdQuery = { __typename?: 'Query', wasteForm?: { __typename?: 'WasteFormEntityResponse', data?: { __typename?: 'WasteFormEntity', id?: string | null, attributes?: { __typename?: 'WasteForm', customId?: string | null, name?: string | null, updatedAt?: any | null, status?: Enum_Wasteform_Status | null, createdAt?: any | null, publishedDate?: any | null, unpublishedDate?: any | null, versionNumber?: number | null, draftCreationId?: string | null, isHidden?: boolean | null, recyclingGestureText?: string | null, tags?: { __typename?: 'TagRelationResponseCollection', data: Array<{ __typename?: 'TagEntity', id?: string | null, attributes?: { __typename?: 'Tag', name: string } | null }> } | null, flow?: { __typename?: 'FlowEntityResponse', data?: { __typename?: 'FlowEntity', id?: string | null, attributes?: { __typename?: 'Flow', name?: string | null, recyclingGesture: Enum_Flow_Recyclinggesture } | null } | null } | null, picto?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', id?: string | null, attributes?: { __typename?: 'UploadFile', hash: string, mime: string, name: string, provider: string, size: number, url: string, alternativeText?: string | null, createdAt?: any | null, ext?: string | null, width?: number | null, height?: number | null } | null } | null } | null, wasteFamily?: { __typename?: 'WasteFamilyEntityResponse', data?: { __typename?: 'WasteFamilyEntity', id?: string | null, attributes?: { __typename?: 'WasteFamily', familyName: string, isSystem: boolean, createdAt?: any | null, updatedAt?: any | null } | null } | null } | null, contentBlock?: Array<{ __typename?: 'ComponentBlocksFile', id: string, document?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', id?: string | null, attributes?: { __typename?: 'UploadFile', hash: string, mime: string, name: string, provider: string, size: number, url: string, alternativeText?: string | null, createdAt?: any | null, ext?: string | null, width?: number | null, height?: number | null } | null } | null } | null } | { __typename?: 'ComponentBlocksHorizontalRule', hr?: string | null, id: string } | { __typename?: 'ComponentBlocksImage', id: string, altText?: string | null, isDecorative?: boolean | null, picture?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', id?: string | null, attributes?: { __typename?: 'UploadFile', hash: string, mime: string, name: string, provider: string, size: number, url: string, alternativeText?: string | null, createdAt?: any | null, ext?: string | null, width?: number | null, height?: number | null } | null } | null } | null } | { __typename?: 'ComponentBlocksSubHeading', id: string, subHeadingTag?: Enum_Componentblockssubheading_Subheadingtag | null, subHeadingText?: string | null } | { __typename?: 'ComponentBlocksVideo', id: string, transcriptText?: string | null, videoLink?: string | null } | { __typename?: 'ComponentBlocksWysiwyg', id: string, textEditor?: string | null } | { __typename?: 'Error' } | null> | null } | null } | null } | null };
...
export type GetWasteFormsByContractIdQuery = { __typename?: 'Query', wasteFormsCount?: { __typename?: 'WasteFormEntityResponseCollection', meta: { __typename?: 'ResponseCollectionMeta', pagination: { __typename?: 'Pagination', total: number } } } | null, wasteFormsDraftCount?: { __typename?: 'WasteFormEntityResponseCollection', meta: { __typename?: 'ResponseCollectionMeta', pagination: { __typename?: 'Pagination', total: number } } } | null, wasteFormsPublishedCount?: { __typename?: 'WasteFormEntityResponseCollection', meta: { __typename?: 'ResponseCollectionMeta', pagination: { __typename?: 'Pagination', total: number } } } | null, wasteFormsArchivedCount?: { __typename?: 'WasteFormEntityResponseCollection', meta: { __typename?: 'ResponseCollectionMeta', pagination: { __typename?: 'Pagination', total: number } } } | null, wasteForms?: { __typename?: 'WasteFormEntityResponseCollection', meta: { __typename?: 'ResponseCollectionMeta', pagination: { __typename?: 'Pagination', page: number, pageSize: number, pageCount: number, total: number } }, data: Array<{ __typename?: 'WasteFormEntity', id?: string | null, attributes?: { __typename?: 'WasteForm', name?: string | null, status?: Enum_Wasteform_Status | null, updatedAt?: any | null, isHidden?: boolean | null } | null }> } | null };
...
export type UpdateWasteFormMutation = { __typename?: 'Mutation', updateWasteForm?: { __typename?: 'WasteFormEntityResponse', data?: { __typename?: 'WasteFormEntity', id?: string | null, attributes?: { __typename?: 'WasteForm', isHidden?: boolean | null } | null } | null } | null };
...
export type GetRecyclingGuideServiceByContractIdQuery = { __typename?: 'Query', recyclingGuideServices?: { __typename?: 'RecyclingGuideServiceEntityResponseCollection', data: Array<{ __typename?: 'RecyclingGuideServiceEntity', id?: string | null, attributes?: { __typename?: 'RecyclingGuideService', name: string, endDate?: any | null, memoName: string, memoDesc?: string | null, isActivated: boolean, orderExtension?: boolean | null, wasteFamilies?: { __typename?: 'WasteFamilyRelationResponseCollection', data: Array<{ __typename?: 'WasteFamilyEntity', id?: string | null, attributes?: { __typename?: 'WasteFamily', createdAt?: any | null, familyName: string, isSystem: boolean, updatedAt?: any | null, wasteForms?: { __typename?: 'WasteFormRelationResponseCollection', data: Array<{ __typename?: 'WasteFormEntity', id?: string | null, attributes?: { __typename?: 'WasteForm', name?: string | null } | null }> } | null } | null }> } | null, memoFile?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', id?: string | null, attributes?: { __typename?: 'UploadFile', name: string, hash: string, mime: string, size: number, url: string, provider: string } | null } | null } | null } | null }> } | null };
...
export type GetRecyclingGuideServiceByIdQuery = { __typename?: 'Query', recyclingGuideService?: { __typename?: 'RecyclingGuideServiceEntityResponse', data?: { __typename?: 'RecyclingGuideServiceEntity', id?: string | null, attributes?: { __typename?: 'RecyclingGuideService', orderExtension?: boolean | null, memoName: string, memoDesc?: string | null, memoFile?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', id?: string | null, attributes?: { __typename?: 'UploadFile', hash: string, mime: string, name: string, provider: string, size: number, url: string, alternativeText?: string | null, ext?: string | null, height?: number | null, width?: number | null, createdAt?: any | null } | null } | null } | null } | null } | null } | null };
...
export type UpdateMemoTriMutation = { __typename?: 'Mutation', updateRecyclingGuideService?: { __typename?: 'RecyclingGuideServiceEntityResponse', data?: { __typename?: 'RecyclingGuideServiceEntity', id?: string | null, attributes?: { __typename?: 'RecyclingGuideService', name: string, isActivated: boolean, memoName: string, memoDesc?: string | null, memoFile?: { __typename?: 'UploadFileEntityResponse', data?: { __typename?: 'UploadFileEntity', id?: string | null } | null } | null } | null } | null } | null };
...
export type UpdateRecyclingGuideServiceMutation = { __typename?: 'Mutation', updateRecyclingGuideService?: { __typename?: 'RecyclingGuideServiceEntityResponse', data?: { __typename?: 'RecyclingGuideServiceEntity', id?: string | null, attributes?: { __typename?: 'RecyclingGuideService', orderExtension?: boolean | null } | null } | null } | null };
...
export type CreatePickUpDayByIdMutation = { __typename?: 'Mutation', createPickUpDay?: { __typename?: 'PickUpDayEntityResponse', data?: { __typename?: 'PickUpDayEntity', id?: string | null, attributes?: { __typename?: 'PickUpDay', createdAt?: any | null, description?: string | null, name: string, updatedAt?: any | null, pickUpDayService?: { __typename?: 'PickUpDayServiceEntityResponse', data?: { __typename?: 'PickUpDayServiceEntity', id?: string | null, attributes?: { __typename?: 'PickUpDayService', name: string } | null } | null } | null, flow?: { __typename?: 'FlowEntityResponse', data?: { __typename?: 'FlowEntity', id?: string | null, attributes?: { __typename?: 'Flow', name?: string | null, isActivated?: boolean | null } | null } | null } | null, sectorizations?: { __typename?: 'SectorizationRelationResponseCollection', data: Array<{ __typename?: 'SectorizationEntity', attributes?: { __typename?: 'Sectorization', name: string } | null }> } | null } | null } | null } | null };
...
export type GetPickUpDayByIdQuery = { __typename?: 'Query', pickUpDay?: { __typename?: 'PickUpDayEntityResponse', data?: { __typename?: 'PickUpDayEntity', id?: string | null, attributes?: { __typename?: 'PickUpDay', createdAt?: any | null, description?: string | null, name: string, updatedAt?: any | null } | null } | null } | null };
...
export type GetPickUpDaysByContractIdQuery = { __typename?: 'Query', pickUpDays?: { __typename?: 'PickUpDayEntityResponseCollection', data: Array<{ __typename?: 'PickUpDayEntity', id?: string | null, attributes?: { __typename?: 'PickUpDay', name: string, updatedAt?: any | null, flow?: { __typename?: 'FlowEntityResponse', data?: { __typename?: 'FlowEntity', attributes?: { __typename?: 'Flow', name?: string | null } | null } | null } | null, sectorizations?: { __typename?: 'SectorizationRelationResponseCollection', data: Array<{ __typename?: 'SectorizationEntity', attributes?: { __typename?: 'Sectorization', name: string } | null }> } | null } | null }>, meta: { __typename?: 'ResponseCollectionMeta', pagination: { __typename?: 'Pagination', page: number, pageCount: number, pageSize: number, total: number } } } | null };
...
export type UpdatePickUpDayMutation = { __typename?: 'Mutation', updatePickUpDay?: { __typename?: 'PickUpDayEntityResponse', data?: { __typename?: 'PickUpDayEntity', id?: string | null, attributes?: { __typename?: 'PickUpDay', name: string, pickUpDayService?: { __typename?: 'PickUpDayServiceEntityResponse', data?: { __typename?: 'PickUpDayServiceEntity', id?: string | null } | null } | null } | null } | null } | null };
...
export const CreateNewDocument = gql`
  ...
  createNew(data: $data) {
    ...
    `;
export type CreateNewMutationFn = Apollo.MutationFunction<CreateNewMutation, CreateNewMutationVariables>;
 ...
 * });
 */
export function useCreateNewMutation(baseOptions?: Apollo.MutationHookOptions<CreateNewMutation, CreateNewMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<CreateNewMutation, CreateNewMutationVariables>(CreateNewDocument, options);
      }
export type CreateNewMutationHookResult = ReturnType<typeof useCreateNewMutation>;
export type CreateNewMutationResult = Apollo.MutationResult<CreateNewMutation>;
export type CreateNewMutationOptions = Apollo.BaseMutationOptions<CreateNewMutation, CreateNewMutationVariables>;
export const DeleteNewDocument = gql`
  ...
  deleteNew(id: $deleteNewId) {
    ...
    `;
export type DeleteNewMutationFn = Apollo.MutationFunction<DeleteNewMutation, DeleteNewMutationVariables>;
 ...
 * });
 */
export function useDeleteNewMutation(baseOptions?: Apollo.MutationHookOptions<DeleteNewMutation, DeleteNewMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<DeleteNewMutation, DeleteNewMutationVariables>(DeleteNewDocument, options);
      }
export type DeleteNewMutationHookResult = ReturnType<typeof useDeleteNewMutation>;
export type DeleteNewMutationResult = Apollo.MutationResult<DeleteNewMutation>;
export type DeleteNewMutationOptions = Apollo.BaseMutationOptions<DeleteNewMutation, DeleteNewMutationVariables>;
export const GetAllVersionsOfNewsByCustomIdDocument = gql`
    query getAllVersionsOfNewsByCustomId($contractId: ID!, $customId: String, $statusFilter: StringFilterInput, $sort: [String], $pagination: PaginationArg) {
  newsCount: news(
    filters: {newsSubService: {editorialService: {contract: {id: {eq: $contractId}}}}, customId: {eq: $customId}}
  ) {
    meta {
      pagination {
        total
  ...
  newsCountDraft: news(
    filters: {newsSubService: {editorialService: {contract: {id: {eq: $contractId}}}}, customId: {eq: $customId}, status: {eq: "draft"}}
  ) {
    meta {
      pagination {
        total
  ...
  newsCountPublished: news(
    filters: {newsSubService: {editorialService: {contract: {id: {eq: $contractId}}}}, customId: {eq: $customId}, status: {eq: "published"}}
  ) {
    meta {
      pagination {
        total
  ...
  newsCountArchived: news(
    filters: {newsSubService: {editorialService: {contract: {id: {eq: $contractId}}}}, customId: {eq: $customId}, status: {eq: "archived"}}
  ) {
    meta {
      pagination {
        total
  ...
  news(
    filters: {newsSubService: {editorialService: {contract: {id: {eq: $contractId}}}}, customId: {eq: $customId}, status: $statusFilter}
    sort: $sort
    pagination: $pagination
  ) {
    meta {
 ...
 * });
 */
export function useGetAllVersionsOfNewsByCustomIdQuery(baseOptions: Apollo.QueryHookOptions<GetAllVersionsOfNewsByCustomIdQuery, GetAllVersionsOfNewsByCustomIdQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetAllVersionsOfNewsByCustomIdQuery, GetAllVersionsOfNewsByCustomIdQueryVariables>(GetAllVersionsOfNewsByCustomIdDocument, options);
      }
export function useGetAllVersionsOfNewsByCustomIdLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetAllVersionsOfNewsByCustomIdQuery, GetAllVersionsOfNewsByCustomIdQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetAllVersionsOfNewsByCustomIdQuery, GetAllVersionsOfNewsByCustomIdQueryVariables>(GetAllVersionsOfNewsByCustomIdDocument, options);
        }
export type GetAllVersionsOfNewsByCustomIdQueryHookResult = ReturnType<typeof useGetAllVersionsOfNewsByCustomIdQuery>;
export type GetAllVersionsOfNewsByCustomIdLazyQueryHookResult = ReturnType<typeof useGetAllVersionsOfNewsByCustomIdLazyQuery>;
export type GetAllVersionsOfNewsByCustomIdQueryResult = Apollo.QueryResult<GetAllVersionsOfNewsByCustomIdQuery, GetAllVersionsOfNewsByCustomIdQueryVariables>;
 ...
 * });
 */
export function useGetNewByIdQuery(baseOptions?: Apollo.QueryHookOptions<GetNewByIdQuery, GetNewByIdQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetNewByIdQuery, GetNewByIdQueryVariables>(GetNewByIdDocument, options);
      }
export function useGetNewByIdLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetNewByIdQuery, GetNewByIdQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetNewByIdQuery, GetNewByIdQueryVariables>(GetNewByIdDocument, options);
        }
export type GetNewByIdQueryHookResult = ReturnType<typeof useGetNewByIdQuery>;
export type GetNewByIdLazyQueryHookResult = ReturnType<typeof useGetNewByIdLazyQuery>;
export type GetNewByIdQueryResult = Apollo.QueryResult<GetNewByIdQuery, GetNewByIdQueryVariables>;
 ...
 * });
 */
export function useGetNewDraftQuery(baseOptions: Apollo.QueryHookOptions<GetNewDraftQuery, GetNewDraftQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetNewDraftQuery, GetNewDraftQueryVariables>(GetNewDraftDocument, options);
      }
export function useGetNewDraftLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetNewDraftQuery, GetNewDraftQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetNewDraftQuery, GetNewDraftQueryVariables>(GetNewDraftDocument, options);
        }
export type GetNewDraftQueryHookResult = ReturnType<typeof useGetNewDraftQuery>;
export type GetNewDraftLazyQueryHookResult = ReturnType<typeof useGetNewDraftLazyQuery>;
export type GetNewDraftQueryResult = Apollo.QueryResult<GetNewDraftQuery, GetNewDraftQueryVariables>;
export const GetNewsByContractIdDocument = gql`
    query getNewsByContractId($contractId: ID!, $statusFilter: StringFilterInput, $sort: [String], $pagination: PaginationArg) {
  newsCount: news(
    filters: {newsSubService: {editorialService: {contract: {id: {eq: $contractId}}}}}
  ) {
    meta {
      pagination {
        total
  ...
  newsCountDraft: news(
    filters: {newsSubService: {editorialService: {contract: {id: {eq: $contractId}}}}, status: {eq: "draft"}}
  ) {
    meta {
      pagination {
        total
  ...
  newsCountPublished: news(
    filters: {newsSubService: {editorialService: {contract: {id: {eq: $contractId}}}}, status: {eq: "published"}}
  ) {
    meta {
      pagination {
        total
  ...
  newsCountArchived: news(
    filters: {newsSubService: {editorialService: {contract: {id: {eq: $contractId}}}}, status: {eq: "archived"}}
  ) {
    meta {
      pagination {
        total
  ...
  news(
    filters: {newsSubService: {editorialService: {contract: {id: {eq: $contractId}}}}, status: $statusFilter}
    sort: $sort
    pagination: $pagination
  ) {
    meta {
 ...
 * });
 */
export function useGetNewsByContractIdQuery(baseOptions: Apollo.QueryHookOptions<GetNewsByContractIdQuery, GetNewsByContractIdQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetNewsByContractIdQuery, GetNewsByContractIdQueryVariables>(GetNewsByContractIdDocument, options);
      }
export function useGetNewsByContractIdLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetNewsByContractIdQuery, GetNewsByContractIdQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetNewsByContractIdQuery, GetNewsByContractIdQueryVariables>(GetNewsByContractIdDocument, options);
        }
export type GetNewsByContractIdQueryHookResult = ReturnType<typeof useGetNewsByContractIdQuery>;
export type GetNewsByContractIdLazyQueryHookResult = ReturnType<typeof useGetNewsByContractIdLazyQuery>;
export type GetNewsByContractIdQueryResult = Apollo.QueryResult<GetNewsByContractIdQuery, GetNewsByContractIdQueryVariables>;
export const UpdateNewDocument = gql`
  ...
  updateNew(id: $updateNewId, data: $data) {
    ...
    `;
export type UpdateNewMutationFn = Apollo.MutationFunction<UpdateNewMutation, UpdateNewMutationVariables>;
 ...
 * });
 */
export function useUpdateNewMutation(baseOptions?: Apollo.MutationHookOptions<UpdateNewMutation, UpdateNewMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateNewMutation, UpdateNewMutationVariables>(UpdateNewDocument, options);
      }
export type UpdateNewMutationHookResult = ReturnType<typeof useUpdateNewMutation>;
export type UpdateNewMutationResult = Apollo.MutationResult<UpdateNewMutation>;
export type UpdateNewMutationOptions = Apollo.BaseMutationOptions<UpdateNewMutation, UpdateNewMutationVariables>;
...
export const DeleteTipDocument = gql`
  ...
  deleteTip(id: $deleteTipId) {
    ...
    `;
export type DeleteTipMutationFn = Apollo.MutationFunction<DeleteTipMutation, DeleteTipMutationVariables>;
 ...
 * });
 */
export function useDeleteTipMutation(baseOptions?: Apollo.MutationHookOptions<DeleteTipMutation, DeleteTipMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<DeleteTipMutation, DeleteTipMutationVariables>(DeleteTipDocument, options);
      }
export type DeleteTipMutationHookResult = ReturnType<typeof useDeleteTipMutation>;
export type DeleteTipMutationResult = Apollo.MutationResult<DeleteTipMutation>;
export type DeleteTipMutationOptions = Apollo.BaseMutationOptions<DeleteTipMutation, DeleteTipMutationVariables>;
 ...
 * });
 */
export function useGetTipByIdQuery(baseOptions?: Apollo.QueryHookOptions<GetTipByIdQuery, GetTipByIdQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetTipByIdQuery, GetTipByIdQueryVariables>(GetTipByIdDocument, options);
      }
export function useGetTipByIdLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetTipByIdQuery, GetTipByIdQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetTipByIdQuery, GetTipByIdQueryVariables>(GetTipByIdDocument, options);
        }
export type GetTipByIdQueryHookResult = ReturnType<typeof useGetTipByIdQuery>;
export type GetTipByIdLazyQueryHookResult = ReturnType<typeof useGetTipByIdLazyQuery>;
export type GetTipByIdQueryResult = Apollo.QueryResult<GetTipByIdQuery, GetTipByIdQueryVariables>;
export const GetTipsByContractIdDocument = gql`
    query getTipsByContractId($contractId: ID!, $statusFilter: StringFilterInput, $sort: [String], $pagination: PaginationArg) {
  tipsCount: tips(
    filters: {tipSubService: {editorialService: {contract: {id: {eq: $contractId}}}}}
  ) {
    meta {
      pagination {
        total
  ...
  tipsCountDraft: tips(
    filters: {tipSubService: {editorialService: {contract: {id: {eq: $contractId}}}}, status: {eq: "draft"}}
  ) {
    meta {
      pagination {
        total
  ...
  tipsCountPublished: tips(
    filters: {tipSubService: {editorialService: {contract: {id: {eq: $contractId}}}}, status: {eq: "published"}}
  ) {
    meta {
      pagination {
        total
  ...
  tipsCountArchived: tips(
    filters: {tipSubService: {editorialService: {contract: {id: {eq: $contractId}}}}, status: {eq: "archived"}}
  ) {
    meta {
      pagination {
        total
  ...
  tips(
    filters: {tipSubService: {editorialService: {contract: {id: {eq: $contractId}}}}, status: $statusFilter}
    sort: $sort
    pagination: $pagination
  ) {
    meta {
 ...
 * });
 */
export function useGetTipsByContractIdQuery(baseOptions: Apollo.QueryHookOptions<GetTipsByContractIdQuery, GetTipsByContractIdQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetTipsByContractIdQuery, GetTipsByContractIdQueryVariables>(GetTipsByContractIdDocument, options);
      }
export function useGetTipsByContractIdLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetTipsByContractIdQuery, GetTipsByContractIdQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetTipsByContractIdQuery, GetTipsByContractIdQueryVariables>(GetTipsByContractIdDocument, options);
        }
export type GetTipsByContractIdQueryHookResult = ReturnType<typeof useGetTipsByContractIdQuery>;
export type GetTipsByContractIdLazyQueryHookResult = ReturnType<typeof useGetTipsByContractIdLazyQuery>;
export type GetTipsByContractIdQueryResult = Apollo.QueryResult<GetTipsByContractIdQuery, GetTipsByContractIdQueryVariables>;
export const UpdateTipDocument = gql`
  ...
  updateTip(id: $updateTipId, data: $data) {
    ...
    `;
export type UpdateTipMutationFn = Apollo.MutationFunction<UpdateTipMutation, UpdateTipMutationVariables>;
 ...
 * });
 */
export function useUpdateTipMutation(baseOptions?: Apollo.MutationHookOptions<UpdateTipMutation, UpdateTipMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateTipMutation, UpdateTipMutationVariables>(UpdateTipDocument, options);
      }
export type UpdateTipMutationHookResult = ReturnType<typeof useUpdateTipMutation>;
export type UpdateTipMutationResult = Apollo.MutationResult<UpdateTipMutation>;
export type UpdateTipMutationOptions = Apollo.BaseMutationOptions<UpdateTipMutation, UpdateTipMutationVariables>;
export const CreateNewFolderDocument = gql`
    mutation createNewFolder($name: String!, $parentFolderPath: String!, $parentFolderPathId: ID!) {
  createNewFolder(
    name: $name
    ...
    `;
export type CreateNewFolderMutationFn = Apollo.MutationFunction<CreateNewFolderMutation, CreateNewFolderMutationVariables>;
 ...
 * });
 */
export function useCreateNewFolderMutation(baseOptions?: Apollo.MutationHookOptions<CreateNewFolderMutation, CreateNewFolderMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<CreateNewFolderMutation, CreateNewFolderMutationVariables>(CreateNewFolderDocument, options);
      }
export type CreateNewFolderMutationHookResult = ReturnType<typeof useCreateNewFolderMutation>;
export type CreateNewFolderMutationResult = Apollo.MutationResult<CreateNewFolderMutation>;
export type CreateNewFolderMutationOptions = Apollo.BaseMutationOptions<CreateNewFolderMutation, CreateNewFolderMutationVariables>;
 ...
 * });
 */
export function useGetAllFoldersHierarchyQuery(baseOptions: Apollo.QueryHookOptions<GetAllFoldersHierarchyQuery, GetAllFoldersHierarchyQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetAllFoldersHierarchyQuery, GetAllFoldersHierarchyQueryVariables>(GetAllFoldersHierarchyDocument, options);
      }
export function useGetAllFoldersHierarchyLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetAllFoldersHierarchyQuery, GetAllFoldersHierarchyQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetAllFoldersHierarchyQuery, GetAllFoldersHierarchyQueryVariables>(GetAllFoldersHierarchyDocument, options);
        }
export type GetAllFoldersHierarchyQueryHookResult = ReturnType<typeof useGetAllFoldersHierarchyQuery>;
export type GetAllFoldersHierarchyLazyQueryHookResult = ReturnType<typeof useGetAllFoldersHierarchyLazyQuery>;
export type GetAllFoldersHierarchyQueryResult = Apollo.QueryResult<GetAllFoldersHierarchyQuery, GetAllFoldersHierarchyQueryVariables>;
export const GetFilesPaginationByPathIdDocument = gql`
    query getFilesPaginationByPathId($filters: UploadFileFiltersInput, $pagination: PaginationArg, $sort: [String]) {
 ...
 * });
 */
export function useGetFilesPaginationByPathIdQuery(baseOptions?: Apollo.QueryHookOptions<GetFilesPaginationByPathIdQuery, GetFilesPaginationByPathIdQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetFilesPaginationByPathIdQuery, GetFilesPaginationByPathIdQueryVariables>(GetFilesPaginationByPathIdDocument, options);
      }
export function useGetFilesPaginationByPathIdLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetFilesPaginationByPathIdQuery, GetFilesPaginationByPathIdQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetFilesPaginationByPathIdQuery, GetFilesPaginationByPathIdQueryVariables>(GetFilesPaginationByPathIdDocument, options);
        }
export type GetFilesPaginationByPathIdQueryHookResult = ReturnType<typeof useGetFilesPaginationByPathIdQuery>;
export type GetFilesPaginationByPathIdLazyQueryHookResult = ReturnType<typeof useGetFilesPaginationByPathIdLazyQuery>;
export type GetFilesPaginationByPathIdQueryResult = Apollo.QueryResult<GetFilesPaginationByPathIdQuery, GetFilesPaginationByPathIdQueryVariables>;
 ...
 * });
 */
export function useGetFolderAndChildrenByIdQuery(baseOptions?: Apollo.QueryHookOptions<GetFolderAndChildrenByIdQuery, GetFolderAndChildrenByIdQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetFolderAndChildrenByIdQuery, GetFolderAndChildrenByIdQueryVariables>(GetFolderAndChildrenByIdDocument, options);
      }
export function useGetFolderAndChildrenByIdLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetFolderAndChildrenByIdQuery, GetFolderAndChildrenByIdQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetFolderAndChildrenByIdQuery, GetFolderAndChildrenByIdQueryVariables>(GetFolderAndChildrenByIdDocument, options);
        }
export type GetFolderAndChildrenByIdQueryHookResult = ReturnType<typeof useGetFolderAndChildrenByIdQuery>;
export type GetFolderAndChildrenByIdLazyQueryHookResult = ReturnType<typeof useGetFolderAndChildrenByIdLazyQuery>;
export type GetFolderAndChildrenByIdQueryResult = Apollo.QueryResult<GetFolderAndChildrenByIdQuery, GetFolderAndChildrenByIdQueryVariables>;
 ...
 * });
 */
export function useGetFolderBreadcrumbQuery(baseOptions: Apollo.QueryHookOptions<GetFolderBreadcrumbQuery, GetFolderBreadcrumbQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetFolderBreadcrumbQuery, GetFolderBreadcrumbQueryVariables>(GetFolderBreadcrumbDocument, options);
      }
export function useGetFolderBreadcrumbLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetFolderBreadcrumbQuery, GetFolderBreadcrumbQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetFolderBreadcrumbQuery, GetFolderBreadcrumbQueryVariables>(GetFolderBreadcrumbDocument, options);
        }
export type GetFolderBreadcrumbQueryHookResult = ReturnType<typeof useGetFolderBreadcrumbQuery>;
export type GetFolderBreadcrumbLazyQueryHookResult = ReturnType<typeof useGetFolderBreadcrumbLazyQuery>;
export type GetFolderBreadcrumbQueryResult = Apollo.QueryResult<GetFolderBreadcrumbQuery, GetFolderBreadcrumbQueryVariables>;
 ...
 * });
 */
export function useGetFolderByPathIdQuery(baseOptions: Apollo.QueryHookOptions<GetFolderByPathIdQuery, GetFolderByPathIdQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetFolderByPathIdQuery, GetFolderByPathIdQueryVariables>(GetFolderByPathIdDocument, options);
      }
export function useGetFolderByPathIdLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetFolderByPathIdQuery, GetFolderByPathIdQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetFolderByPathIdQuery, GetFolderByPathIdQueryVariables>(GetFolderByPathIdDocument, options);
        }
export type GetFolderByPathIdQueryHookResult = ReturnType<typeof useGetFolderByPathIdQuery>;
export type GetFolderByPathIdLazyQueryHookResult = ReturnType<typeof useGetFolderByPathIdLazyQuery>;
export type GetFolderByPathIdQueryResult = Apollo.QueryResult<GetFolderByPathIdQuery, GetFolderByPathIdQueryVariables>;
...
export type UpdateUploadFileMutationOptions = Apollo.BaseMutationOptions<UpdateUploadFileMutation, UpdateUploadFileMutationVariables>;
export const UpdateUploadFolderDocument = gql`
    mutation updateUploadFolder($updateUploadFolderId: ID!, $data: UploadFolderInput!) {
  updateUploadFolder(id: $updateUploadFolderId, data: $data) {
    ...
    `;
export type UpdateUploadFolderMutationFn = Apollo.MutationFunction<UpdateUploadFolderMutation, UpdateUploadFolderMutationVariables>;
 ...
 * });
 */
export function useUpdateUploadFolderMutation(baseOptions?: Apollo.MutationHookOptions<UpdateUploadFolderMutation, UpdateUploadFolderMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateUploadFolderMutation, UpdateUploadFolderMutationVariables>(UpdateUploadFolderDocument, options);
      }
export type UpdateUploadFolderMutationHookResult = ReturnType<typeof useUpdateUploadFolderMutation>;
export type UpdateUploadFolderMutationResult = Apollo.MutationResult<UpdateUploadFolderMutation>;
export type UpdateUploadFolderMutationOptions = Apollo.BaseMutationOptions<UpdateUploadFolderMutation, UpdateUploadFolderMutationVariables>;
export const UploadGraphQlDocument = gql`
    mutation uploadGraphQL($refId: ID, $ref: String, $field: String, $info: FileInfoInput, $file: Upload!) {
  uploadGraphQL(refId: $refId, ref: $ref, field: $field, info: $info, file: $file)
}
    `;
export type UploadGraphQlMutationFn = Apollo.MutationFunction<UploadGraphQlMutation, UploadGraphQlMutationVariables>;
 ...
 * });
 */
export function useUploadGraphQlMutation(baseOptions?: Apollo.MutationHookOptions<UploadGraphQlMutation, UploadGraphQlMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UploadGraphQlMutation, UploadGraphQlMutationVariables>(UploadGraphQlDocument, options);
      }
export type UploadGraphQlMutationHookResult = ReturnType<typeof useUploadGraphQlMutation>;
export type UploadGraphQlMutationResult = Apollo.MutationResult<UploadGraphQlMutation>;
export type UploadGraphQlMutationOptions = Apollo.BaseMutationOptions<UploadGraphQlMutation, UploadGraphQlMutationVariables>;
 ...
 * });
 */
export function useGetContactUsByIdQuery(baseOptions?: Apollo.QueryHookOptions<GetContactUsByIdQuery, GetContactUsByIdQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetContactUsByIdQuery, GetContactUsByIdQueryVariables>(GetContactUsByIdDocument, options);
      }
export function useGetContactUsByIdLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetContactUsByIdQuery, GetContactUsByIdQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetContactUsByIdQuery, GetContactUsByIdQueryVariables>(GetContactUsByIdDocument, options);
        }
export type GetContactUsByIdQueryHookResult = ReturnType<typeof useGetContactUsByIdQuery>;
export type GetContactUsByIdLazyQueryHookResult = ReturnType<typeof useGetContactUsByIdLazyQuery>;
export type GetContactUsByIdQueryResult = Apollo.QueryResult<GetContactUsByIdQuery, GetContactUsByIdQueryVariables>;
 ...
 * });
 */
export function useGetContactUsesByContractIdQuery(baseOptions: Apollo.QueryHookOptions<GetContactUsesByContractIdQuery, GetContactUsesByContractIdQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetContactUsesByContractIdQuery, GetContactUsesByContractIdQueryVariables>(GetContactUsesByContractIdDocument, options);
      }
export function useGetContactUsesByContractIdLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetContactUsesByContractIdQuery, GetContactUsesByContractIdQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetContactUsesByContractIdQuery, GetContactUsesByContractIdQueryVariables>(GetContactUsesByContractIdDocument, options);
        }
export type GetContactUsesByContractIdQueryHookResult = ReturnType<typeof useGetContactUsesByContractIdQuery>;
export type GetContactUsesByContractIdLazyQueryHookResult = ReturnType<typeof useGetContactUsesByContractIdLazyQuery>;
export type GetContactUsesByContractIdQueryResult = Apollo.QueryResult<GetContactUsesByContractIdQuery, GetContactUsesByContractIdQueryVariables>;
...
export const CreateFreeContentDocument = gql`
  ...
  createFreeContent(data: $data) {
    ...
    `;
export type CreateFreeContentMutationFn = Apollo.MutationFunction<CreateFreeContentMutation, CreateFreeContentMutationVariables>;
 ...
 * });
 */
export function useCreateFreeContentMutation(baseOptions?: Apollo.MutationHookOptions<CreateFreeContentMutation, CreateFreeContentMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<CreateFreeContentMutation, CreateFreeContentMutationVariables>(CreateFreeContentDocument, options);
      }
export type CreateFreeContentMutationHookResult = ReturnType<typeof useCreateFreeContentMutation>;
export type CreateFreeContentMutationResult = Apollo.MutationResult<CreateFreeContentMutation>;
export type CreateFreeContentMutationOptions = Apollo.BaseMutationOptions<CreateFreeContentMutation, CreateFreeContentMutationVariables>;
export const DeleteFreeContentDocument = gql`
  ...
  deleteFreeContent(id: $deleteFreeContentId) {
    ...
    `;
export type DeleteFreeContentMutationFn = Apollo.MutationFunction<DeleteFreeContentMutation, DeleteFreeContentMutationVariables>;
 ...
 * });
 */
export function useDeleteFreeContentMutation(baseOptions?: Apollo.MutationHookOptions<DeleteFreeContentMutation, DeleteFreeContentMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<DeleteFreeContentMutation, DeleteFreeContentMutationVariables>(DeleteFreeContentDocument, options);
      }
export type DeleteFreeContentMutationHookResult = ReturnType<typeof useDeleteFreeContentMutation>;
export type DeleteFreeContentMutationResult = Apollo.MutationResult<DeleteFreeContentMutation>;
export type DeleteFreeContentMutationOptions = Apollo.BaseMutationOptions<DeleteFreeContentMutation, DeleteFreeContentMutationVariables>;
 ...
 * });
 */
export function useGetFreeContentByIdQuery(baseOptions?: Apollo.QueryHookOptions<GetFreeContentByIdQuery, GetFreeContentByIdQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetFreeContentByIdQuery, GetFreeContentByIdQueryVariables>(GetFreeContentByIdDocument, options);
      }
export function useGetFreeContentByIdLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetFreeContentByIdQuery, GetFreeContentByIdQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetFreeContentByIdQuery, GetFreeContentByIdQueryVariables>(GetFreeContentByIdDocument, options);
        }
export type GetFreeContentByIdQueryHookResult = ReturnType<typeof useGetFreeContentByIdQuery>;
export type GetFreeContentByIdLazyQueryHookResult = ReturnType<typeof useGetFreeContentByIdLazyQuery>;
export type GetFreeContentByIdQueryResult = Apollo.QueryResult<GetFreeContentByIdQuery, GetFreeContentByIdQueryVariables>;
 ...
 * });
 */
export function useGetFreeContentSubServiceByIdQuery(baseOptions?: Apollo.QueryHookOptions<GetFreeContentSubServiceByIdQuery, GetFreeContentSubServiceByIdQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetFreeContentSubServiceByIdQuery, GetFreeContentSubServiceByIdQueryVariables>(GetFreeContentSubServiceByIdDocument, options);
      }
export function useGetFreeContentSubServiceByIdLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetFreeContentSubServiceByIdQuery, GetFreeContentSubServiceByIdQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetFreeContentSubServiceByIdQuery, GetFreeContentSubServiceByIdQueryVariables>(GetFreeContentSubServiceByIdDocument, options);
        }
export type GetFreeContentSubServiceByIdQueryHookResult = ReturnType<typeof useGetFreeContentSubServiceByIdQuery>;
export type GetFreeContentSubServiceByIdLazyQueryHookResult = ReturnType<typeof useGetFreeContentSubServiceByIdLazyQuery>;
export type GetFreeContentSubServiceByIdQueryResult = Apollo.QueryResult<GetFreeContentSubServiceByIdQuery, GetFreeContentSubServiceByIdQueryVariables>;
export const GetFreeContentsBySubServiceIdDocument = gql`
    query getFreeContentsBySubServiceId($freeContentSubServiceId: ID!, $statusFilter: StringFilterInput, $sort: [String], $pagination: PaginationArg) {
  ...
  freeContentsCountDraft: freeContents(
    filters: {freeContentSubService: {id: {eq: $freeContentSubServiceId}}, status: {eq: "draft"}}
  ) {
    meta {
      pagination {
        total
  ...
  freeContentsCountPublished: freeContents(
    filters: {freeContentSubService: {id: {eq: $freeContentSubServiceId}}, status: {eq: "published"}}
  ) {
    meta {
      pagination {
        total
  ...
  freeContentsCountArchived: freeContents(
    filters: {freeContentSubService: {id: {eq: $freeContentSubServiceId}}, status: {eq: "archived"}}
  ) {
    meta {
      pagination {
        total
  ...
  freeContents(
    filters: {freeContentSubService: {id: {eq: $freeContentSubServiceId}}, status: $statusFilter}
    sort: $sort
    pagination: $pagination
  ) {
    meta {
 ...
 * });
 */
export function useGetFreeContentsBySubServiceIdQuery(baseOptions: Apollo.QueryHookOptions<GetFreeContentsBySubServiceIdQuery, GetFreeContentsBySubServiceIdQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetFreeContentsBySubServiceIdQuery, GetFreeContentsBySubServiceIdQueryVariables>(GetFreeContentsBySubServiceIdDocument, options);
      }
export function useGetFreeContentsBySubServiceIdLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetFreeContentsBySubServiceIdQuery, GetFreeContentsBySubServiceIdQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetFreeContentsBySubServiceIdQuery, GetFreeContentsBySubServiceIdQueryVariables>(GetFreeContentsBySubServiceIdDocument, options);
        }
export type GetFreeContentsBySubServiceIdQueryHookResult = ReturnType<typeof useGetFreeContentsBySubServiceIdQuery>;
export type GetFreeContentsBySubServiceIdLazyQueryHookResult = ReturnType<typeof useGetFreeContentsBySubServiceIdLazyQuery>;
export type GetFreeContentsBySubServiceIdQueryResult = Apollo.QueryResult<GetFreeContentsBySubServiceIdQuery, GetFreeContentsBySubServiceIdQueryVariables>;
export const UpdateFreeContentDocument = gql`
    mutation updateFreeContent($updateFreeContentId: ID!, $data: FreeContentInput!) {
  updateFreeContent(id: $updateFreeContentId, data: $data) {
    ...
    `;
export type UpdateFreeContentMutationFn = Apollo.MutationFunction<UpdateFreeContentMutation, UpdateFreeContentMutationVariables>;
 ...
 * });
 */
export function useUpdateFreeContentMutation(baseOptions?: Apollo.MutationHookOptions<UpdateFreeContentMutation, UpdateFreeContentMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateFreeContentMutation, UpdateFreeContentMutationVariables>(UpdateFreeContentDocument, options);
      }
export type UpdateFreeContentMutationHookResult = ReturnType<typeof useUpdateFreeContentMutation>;
export type UpdateFreeContentMutationResult = Apollo.MutationResult<UpdateFreeContentMutation>;
export type UpdateFreeContentMutationOptions = Apollo.BaseMutationOptions<UpdateFreeContentMutation, UpdateFreeContentMutationVariables>;
 ...
 * });
 */
export function useGetTagsByContractIdQuery(baseOptions?: Apollo.QueryHookOptions<GetTagsByContractIdQuery, GetTagsByContractIdQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetTagsByContractIdQuery, GetTagsByContractIdQueryVariables>(GetTagsByContractIdDocument, options);
      }
export function useGetTagsByContractIdLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetTagsByContractIdQuery, GetTagsByContractIdQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetTagsByContractIdQuery, GetTagsByContractIdQueryVariables>(GetTagsByContractIdDocument, options);
        }
export type GetTagsByContractIdQueryHookResult = ReturnType<typeof useGetTagsByContractIdQuery>;
export type GetTagsByContractIdLazyQueryHookResult = ReturnType<typeof useGetTagsByContractIdLazyQuery>;
export type GetTagsByContractIdQueryResult = Apollo.QueryResult<GetTagsByContractIdQuery, GetTagsByContractIdQueryVariables>;
 ...
 * });
 */
export function useCountContentPerTagQuery(baseOptions: Apollo.QueryHookOptions<CountContentPerTagQuery, CountContentPerTagQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<CountContentPerTagQuery, CountContentPerTagQueryVariables>(CountContentPerTagDocument, options);
      }
export function useCountContentPerTagLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<CountContentPerTagQuery, CountContentPerTagQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<CountContentPerTagQuery, CountContentPerTagQueryVariables>(CountContentPerTagDocument, options);
        }
export type CountContentPerTagQueryHookResult = ReturnType<typeof useCountContentPerTagQuery>;
export type CountContentPerTagLazyQueryHookResult = ReturnType<typeof useCountContentPerTagLazyQuery>;
export type CountContentPerTagQueryResult = Apollo.QueryResult<CountContentPerTagQuery, CountContentPerTagQueryVariables>;
...
export const CreateContentTypeDocument = gql`
    mutation createContentType($contractId: ID, $name: String, $description: String) {
...
export function useCreateContentTypeMutation(baseOptions?: Apollo.MutationHookOptions<CreateContentTypeMutation, CreateContentTypeMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<CreateContentTypeMutation, CreateContentTypeMutationVariables>(CreateContentTypeDocument, options);
      }
 ...
 * });
 */
export function useGetContentTypeDtOsQuery(baseOptions: Apollo.QueryHookOptions<GetContentTypeDtOsQuery, GetContentTypeDtOsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetContentTypeDtOsQuery, GetContentTypeDtOsQueryVariables>(GetContentTypeDtOsDocument, options);
      }
export function useGetContentTypeDtOsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetContentTypeDtOsQuery, GetContentTypeDtOsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetContentTypeDtOsQuery, GetContentTypeDtOsQueryVariables>(GetContentTypeDtOsDocument, options);
        }
export type GetContentTypeDtOsQueryHookResult = ReturnType<typeof useGetContentTypeDtOsQuery>;
export type GetContentTypeDtOsLazyQueryHookResult = ReturnType<typeof useGetContentTypeDtOsLazyQuery>;
export type GetContentTypeDtOsQueryResult = Apollo.QueryResult<GetContentTypeDtOsQuery, GetContentTypeDtOsQueryVariables>;
export const UpdateContentTypeCookiesDocument = gql`
    mutation updateContentTypeCookies($updateSubServiceId: ID!, $data: CookiesSubServiceInput!) {
  updateCookiesSubService(id: $updateSubServiceId, data: $data) {
    ...
    `;
export type UpdateContentTypeCookiesMutationFn = Apollo.MutationFunction<UpdateContentTypeCookiesMutation, UpdateContentTypeCookiesMutationVariables>;
 ...
 * });
 */
export function useUpdateContentTypeCookiesMutation(baseOptions?: Apollo.MutationHookOptions<UpdateContentTypeCookiesMutation, UpdateContentTypeCookiesMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateContentTypeCookiesMutation, UpdateContentTypeCookiesMutationVariables>(UpdateContentTypeCookiesDocument, options);
      }
export type UpdateContentTypeCookiesMutationHookResult = ReturnType<typeof useUpdateContentTypeCookiesMutation>;
export type UpdateContentTypeCookiesMutationResult = Apollo.MutationResult<UpdateContentTypeCookiesMutation>;
export type UpdateContentTypeCookiesMutationOptions = Apollo.BaseMutationOptions<UpdateContentTypeCookiesMutation, UpdateContentTypeCookiesMutationVariables>;
export const UpdateContentTypeAccessibilityDocument = gql`
    mutation updateContentTypeAccessibility($updateSubServiceId: ID!, $data: AccessibilitySubServiceInput!) {
  updateAccessibilitySubService(id: $updateSubServiceId, data: $data) {
    ...
    `;
export type UpdateContentTypeAccessibilityMutationFn = Apollo.MutationFunction<UpdateContentTypeAccessibilityMutation, UpdateContentTypeAccessibilityMutationVariables>;
 ...
 * });
 */
export function useUpdateContentTypeAccessibilityMutation(baseOptions?: Apollo.MutationHookOptions<UpdateContentTypeAccessibilityMutation, UpdateContentTypeAccessibilityMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateContentTypeAccessibilityMutation, UpdateContentTypeAccessibilityMutationVariables>(UpdateContentTypeAccessibilityDocument, options);
      }
export type UpdateContentTypeAccessibilityMutationHookResult = ReturnType<typeof useUpdateContentTypeAccessibilityMutation>;
export type UpdateContentTypeAccessibilityMutationResult = Apollo.MutationResult<UpdateContentTypeAccessibilityMutation>;
export type UpdateContentTypeAccessibilityMutationOptions = Apollo.BaseMutationOptions<UpdateContentTypeAccessibilityMutation, UpdateContentTypeAccessibilityMutationVariables>;
export const UpdateContentTypeContactUsDocument = gql`
    mutation updateContentTypeContactUs($updateSubServiceId: ID!, $data: ContactUsSubServiceInput!) {
  updateContactUsSubService(id: $updateSubServiceId, data: $data) {
    ...
    `;
export type UpdateContentTypeContactUsMutationFn = Apollo.MutationFunction<UpdateContentTypeContactUsMutation, UpdateContentTypeContactUsMutationVariables>;
 ...
 * });
 */
export function useUpdateContentTypeContactUsMutation(baseOptions?: Apollo.MutationHookOptions<UpdateContentTypeContactUsMutation, UpdateContentTypeContactUsMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateContentTypeContactUsMutation, UpdateContentTypeContactUsMutationVariables>(UpdateContentTypeContactUsDocument, options);
      }
export type UpdateContentTypeContactUsMutationHookResult = ReturnType<typeof useUpdateContentTypeContactUsMutation>;
export type UpdateContentTypeContactUsMutationResult = Apollo.MutationResult<UpdateContentTypeContactUsMutation>;
export type UpdateContentTypeContactUsMutationOptions = Apollo.BaseMutationOptions<UpdateContentTypeContactUsMutation, UpdateContentTypeContactUsMutationVariables>;
export const UpdateContentTypeCguDocument = gql`
    mutation updateContentTypeCGU($updateSubServiceId: ID!, $data: CguSubServiceInput!) {
  updateCguSubService(id: $updateSubServiceId, data: $data) {
    ...
    `;
export type UpdateContentTypeCguMutationFn = Apollo.MutationFunction<UpdateContentTypeCguMutation, UpdateContentTypeCguMutationVariables>;
 ...
 * });
 */
export function useUpdateContentTypeCguMutation(baseOptions?: Apollo.MutationHookOptions<UpdateContentTypeCguMutation, UpdateContentTypeCguMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateContentTypeCguMutation, UpdateContentTypeCguMutationVariables>(UpdateContentTypeCguDocument, options);
      }
export type UpdateContentTypeCguMutationHookResult = ReturnType<typeof useUpdateContentTypeCguMutation>;
export type UpdateContentTypeCguMutationResult = Apollo.MutationResult<UpdateContentTypeCguMutation>;
export type UpdateContentTypeCguMutationOptions = Apollo.BaseMutationOptions<UpdateContentTypeCguMutation, UpdateContentTypeCguMutationVariables>;
export const UpdateContentTypeConfidentialityDocument = gql`
    mutation updateContentTypeConfidentiality($updateSubServiceId: ID!, $data: ConfidentialitySubServiceInput!) {
  updateConfidentialitySubService(id: $updateSubServiceId, data: $data) {
    ...
    `;
export type UpdateContentTypeConfidentialityMutationFn = Apollo.MutationFunction<UpdateContentTypeConfidentialityMutation, UpdateContentTypeConfidentialityMutationVariables>;
 ...
 * });
 */
export function useUpdateContentTypeConfidentialityMutation(baseOptions?: Apollo.MutationHookOptions<UpdateContentTypeConfidentialityMutation, UpdateContentTypeConfidentialityMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateContentTypeConfidentialityMutation, UpdateContentTypeConfidentialityMutationVariables>(UpdateContentTypeConfidentialityDocument, options);
      }
export type UpdateContentTypeConfidentialityMutationHookResult = ReturnType<typeof useUpdateContentTypeConfidentialityMutation>;
export type UpdateContentTypeConfidentialityMutationResult = Apollo.MutationResult<UpdateContentTypeConfidentialityMutation>;
export type UpdateContentTypeConfidentialityMutationOptions = Apollo.BaseMutationOptions<UpdateContentTypeConfidentialityMutation, UpdateContentTypeConfidentialityMutationVariables>;
export const UpdateContentTypeNewsDocument = gql`
    mutation updateContentTypeNews($updateSubServiceId: ID!, $data: NewsSubServiceInput!) {
  updateNewsSubService(id: $updateSubServiceId, data: $data) {
    ...
    `;
export type UpdateContentTypeNewsMutationFn = Apollo.MutationFunction<UpdateContentTypeNewsMutation, UpdateContentTypeNewsMutationVariables>;
 ...
 * });
 */
export function useUpdateContentTypeNewsMutation(baseOptions?: Apollo.MutationHookOptions<UpdateContentTypeNewsMutation, UpdateContentTypeNewsMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateContentTypeNewsMutation, UpdateContentTypeNewsMutationVariables>(UpdateContentTypeNewsDocument, options);
      }
export type UpdateContentTypeNewsMutationHookResult = ReturnType<typeof useUpdateContentTypeNewsMutation>;
export type UpdateContentTypeNewsMutationResult = Apollo.MutationResult<UpdateContentTypeNewsMutation>;
export type UpdateContentTypeNewsMutationOptions = Apollo.BaseMutationOptions<UpdateContentTypeNewsMutation, UpdateContentTypeNewsMutationVariables>;
export const UpdateContentTypeTipDocument = gql`
    mutation updateContentTypeTip($updateSubServiceId: ID!, $data: TipSubServiceInput!) {
  updateTipSubService(id: $updateSubServiceId, data: $data) {
    ...
    `;
export type UpdateContentTypeTipMutationFn = Apollo.MutationFunction<UpdateContentTypeTipMutation, UpdateContentTypeTipMutationVariables>;
 ...
 * });
 */
export function useUpdateContentTypeTipMutation(baseOptions?: Apollo.MutationHookOptions<UpdateContentTypeTipMutation, UpdateContentTypeTipMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateContentTypeTipMutation, UpdateContentTypeTipMutationVariables>(UpdateContentTypeTipDocument, options);
      }
export type UpdateContentTypeTipMutationHookResult = ReturnType<typeof useUpdateContentTypeTipMutation>;
export type UpdateContentTypeTipMutationResult = Apollo.MutationResult<UpdateContentTypeTipMutation>;
export type UpdateContentTypeTipMutationOptions = Apollo.BaseMutationOptions<UpdateContentTypeTipMutation, UpdateContentTypeTipMutationVariables>;
export const UpdateContentTypeQuizDocument = gql`
    mutation updateContentTypeQuiz($updateSubServiceId: ID!, $data: QuizSubServiceInput!) {
  updateQuizSubService(id: $updateSubServiceId, data: $data) {
    ...
    `;
export type UpdateContentTypeQuizMutationFn = Apollo.MutationFunction<UpdateContentTypeQuizMutation, UpdateContentTypeQuizMutationVariables>;
 ...
 * });
 */
export function useUpdateContentTypeQuizMutation(baseOptions?: Apollo.MutationHookOptions<UpdateContentTypeQuizMutation, UpdateContentTypeQuizMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateContentTypeQuizMutation, UpdateContentTypeQuizMutationVariables>(UpdateContentTypeQuizDocument, options);
      }
export type UpdateContentTypeQuizMutationHookResult = ReturnType<typeof useUpdateContentTypeQuizMutation>;
export type UpdateContentTypeQuizMutationResult = Apollo.MutationResult<UpdateContentTypeQuizMutation>;
export type UpdateContentTypeQuizMutationOptions = Apollo.BaseMutationOptions<UpdateContentTypeQuizMutation, UpdateContentTypeQuizMutationVariables>;
export const UpdateContentTypeEventDocument = gql`
    mutation updateContentTypeEvent($updateSubServiceId: ID!, $data: EventSubServiceInput!) {
  updateEventSubService(id: $updateSubServiceId, data: $data) {
    ...
    `;
export type UpdateContentTypeEventMutationFn = Apollo.MutationFunction<UpdateContentTypeEventMutation, UpdateContentTypeEventMutationVariables>;
 ...
 * });
 */
export function useUpdateContentTypeEventMutation(baseOptions?: Apollo.MutationHookOptions<UpdateContentTypeEventMutation, UpdateContentTypeEventMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateContentTypeEventMutation, UpdateContentTypeEventMutationVariables>(UpdateContentTypeEventDocument, options);
      }
export type UpdateContentTypeEventMutationHookResult = ReturnType<typeof useUpdateContentTypeEventMutation>;
export type UpdateContentTypeEventMutationResult = Apollo.MutationResult<UpdateContentTypeEventMutation>;
export type UpdateContentTypeEventMutationOptions = Apollo.BaseMutationOptions<UpdateContentTypeEventMutation, UpdateContentTypeEventMutationVariables>;
export const UpdateContentTypeFreeContentDocument = gql`
    mutation updateContentTypeFreeContent($updateSubServiceId: ID!, $data: FreeContentSubServiceInput!) {
  updateFreeContentSubService(id: $updateSubServiceId, data: $data) {
    ...
    `;
export type UpdateContentTypeFreeContentMutationFn = Apollo.MutationFunction<UpdateContentTypeFreeContentMutation, UpdateContentTypeFreeContentMutationVariables>;
 ...
 * });
 */
export function useUpdateContentTypeFreeContentMutation(baseOptions?: Apollo.MutationHookOptions<UpdateContentTypeFreeContentMutation, UpdateContentTypeFreeContentMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateContentTypeFreeContentMutation, UpdateContentTypeFreeContentMutationVariables>(UpdateContentTypeFreeContentDocument, options);
      }
export type UpdateContentTypeFreeContentMutationHookResult = ReturnType<typeof useUpdateContentTypeFreeContentMutation>;
export type UpdateContentTypeFreeContentMutationResult = Apollo.MutationResult<UpdateContentTypeFreeContentMutation>;
export type UpdateContentTypeFreeContentMutationOptions = Apollo.BaseMutationOptions<UpdateContentTypeFreeContentMutation, UpdateContentTypeFreeContentMutationVariables>;
export const GetCollectionMethodsByContractIdDocument = gql`
    query getCollectionMethodsByContractId($filters: CollectDoorToDoorFiltersInput) {
 ...
 * });
 */
export function useGetCollectionMethodsByContractIdQuery(baseOptions?: Apollo.QueryHookOptions<GetCollectionMethodsByContractIdQuery, GetCollectionMethodsByContractIdQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetCollectionMethodsByContractIdQuery, GetCollectionMethodsByContractIdQueryVariables>(GetCollectionMethodsByContractIdDocument, options);
      }
export function useGetCollectionMethodsByContractIdLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetCollectionMethodsByContractIdQuery, GetCollectionMethodsByContractIdQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetCollectionMethodsByContractIdQuery, GetCollectionMethodsByContractIdQueryVariables>(GetCollectionMethodsByContractIdDocument, options);
        }
export type GetCollectionMethodsByContractIdQueryHookResult = ReturnType<typeof useGetCollectionMethodsByContractIdQuery>;
export type GetCollectionMethodsByContractIdLazyQueryHookResult = ReturnType<typeof useGetCollectionMethodsByContractIdLazyQuery>;
export type GetCollectionMethodsByContractIdQueryResult = Apollo.QueryResult<GetCollectionMethodsByContractIdQuery, GetCollectionMethodsByContractIdQueryVariables>;
 ...
 * });
 */
export function useGetFlowsByContractIdQuery(baseOptions?: Apollo.QueryHookOptions<GetFlowsByContractIdQuery, GetFlowsByContractIdQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetFlowsByContractIdQuery, GetFlowsByContractIdQueryVariables>(GetFlowsByContractIdDocument, options);
      }
export function useGetFlowsByContractIdLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetFlowsByContractIdQuery, GetFlowsByContractIdQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetFlowsByContractIdQuery, GetFlowsByContractIdQueryVariables>(GetFlowsByContractIdDocument, options);
        }
export type GetFlowsByContractIdQueryHookResult = ReturnType<typeof useGetFlowsByContractIdQuery>;
export type GetFlowsByContractIdLazyQueryHookResult = ReturnType<typeof useGetFlowsByContractIdLazyQuery>;
export type GetFlowsByContractIdQueryResult = Apollo.QueryResult<GetFlowsByContractIdQuery, GetFlowsByContractIdQueryVariables>;
 ...
 * });
 */
export function useGetServicesActiveQuery(baseOptions: Apollo.QueryHookOptions<GetServicesActiveQuery, GetServicesActiveQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetServicesActiveQuery, GetServicesActiveQueryVariables>(GetServicesActiveDocument, options);
      }
export function useGetServicesActiveLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetServicesActiveQuery, GetServicesActiveQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetServicesActiveQuery, GetServicesActiveQueryVariables>(GetServicesActiveDocument, options);
        }
export type GetServicesActiveQueryHookResult = ReturnType<typeof useGetServicesActiveQuery>;
export type GetServicesActiveLazyQueryHookResult = ReturnType<typeof useGetServicesActiveLazyQuery>;
export type GetServicesActiveQueryResult = Apollo.QueryResult<GetServicesActiveQuery, GetServicesActiveQueryVariables>;
export const GetEditoBlockTabDocument = gql`
    query getEditoBlockTab($contractId: ID!, $status: ENUM_EDITOCONTENTDTO_STATUS) {
 ...
 * });
 */
export function useGetEditoBlockTabQuery(baseOptions: Apollo.QueryHookOptions<GetEditoBlockTabQuery, GetEditoBlockTabQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetEditoBlockTabQuery, GetEditoBlockTabQueryVariables>(GetEditoBlockTabDocument, options);
      }
export function useGetEditoBlockTabLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetEditoBlockTabQuery, GetEditoBlockTabQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetEditoBlockTabQuery, GetEditoBlockTabQueryVariables>(GetEditoBlockTabDocument, options);
        }
export type GetEditoBlockTabQueryHookResult = ReturnType<typeof useGetEditoBlockTabQuery>;
export type GetEditoBlockTabLazyQueryHookResult = ReturnType<typeof useGetEditoBlockTabLazyQuery>;
export type GetEditoBlockTabQueryResult = Apollo.QueryResult<GetEditoBlockTabQuery, GetEditoBlockTabQueryVariables>;
export const GetQuizAndTipsBlockTabDocument = gql`
  ...
  tipSubServices(filters: {editorialService: {contract: {id: {eq: $contractId}}}}) {
    data {
      attributes {
 ...
 * });
 */
export function useGetQuizAndTipsBlockTabQuery(baseOptions: Apollo.QueryHookOptions<GetQuizAndTipsBlockTabQuery, GetQuizAndTipsBlockTabQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetQuizAndTipsBlockTabQuery, GetQuizAndTipsBlockTabQueryVariables>(GetQuizAndTipsBlockTabDocument, options);
      }
export function useGetQuizAndTipsBlockTabLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetQuizAndTipsBlockTabQuery, GetQuizAndTipsBlockTabQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetQuizAndTipsBlockTabQuery, GetQuizAndTipsBlockTabQueryVariables>(GetQuizAndTipsBlockTabDocument, options);
        }
export type GetQuizAndTipsBlockTabQueryHookResult = ReturnType<typeof useGetQuizAndTipsBlockTabQuery>;
export type GetQuizAndTipsBlockTabLazyQueryHookResult = ReturnType<typeof useGetQuizAndTipsBlockTabLazyQuery>;
export type GetQuizAndTipsBlockTabQueryResult = Apollo.QueryResult<GetQuizAndTipsBlockTabQuery, GetQuizAndTipsBlockTabQueryVariables>;
 ...
 * });
 */
export function useGetRecyclingGuideBlockTabQuery(baseOptions: Apollo.QueryHookOptions<GetRecyclingGuideBlockTabQuery, GetRecyclingGuideBlockTabQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetRecyclingGuideBlockTabQuery, GetRecyclingGuideBlockTabQueryVariables>(GetRecyclingGuideBlockTabDocument, options);
      }
export function useGetRecyclingGuideBlockTabLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetRecyclingGuideBlockTabQuery, GetRecyclingGuideBlockTabQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetRecyclingGuideBlockTabQuery, GetRecyclingGuideBlockTabQueryVariables>(GetRecyclingGuideBlockTabDocument, options);
        }
export type GetRecyclingGuideBlockTabQueryHookResult = ReturnType<typeof useGetRecyclingGuideBlockTabQuery>;
export type GetRecyclingGuideBlockTabLazyQueryHookResult = ReturnType<typeof useGetRecyclingGuideBlockTabLazyQuery>;
export type GetRecyclingGuideBlockTabQueryResult = Apollo.QueryResult<GetRecyclingGuideBlockTabQuery, GetRecyclingGuideBlockTabQueryVariables>;
 ...
 * });
 */
export function useGetSearchEngineBlockTabQuery(baseOptions: Apollo.QueryHookOptions<GetSearchEngineBlockTabQuery, GetSearchEngineBlockTabQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetSearchEngineBlockTabQuery, GetSearchEngineBlockTabQueryVariables>(GetSearchEngineBlockTabDocument, options);
      }
export function useGetSearchEngineBlockTabLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetSearchEngineBlockTabQuery, GetSearchEngineBlockTabQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetSearchEngineBlockTabQuery, GetSearchEngineBlockTabQueryVariables>(GetSearchEngineBlockTabDocument, options);
        }
export type GetSearchEngineBlockTabQueryHookResult = ReturnType<typeof useGetSearchEngineBlockTabQuery>;
export type GetSearchEngineBlockTabLazyQueryHookResult = ReturnType<typeof useGetSearchEngineBlockTabLazyQuery>;
export type GetSearchEngineBlockTabQueryResult = Apollo.QueryResult<GetSearchEngineBlockTabQuery, GetSearchEngineBlockTabQueryVariables>;
 ...
 * });
 */
export function useGetServicesBlockTabQuery(baseOptions: Apollo.QueryHookOptions<GetServicesBlockTabQuery, GetServicesBlockTabQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetServicesBlockTabQuery, GetServicesBlockTabQueryVariables>(GetServicesBlockTabDocument, options);
      }
export function useGetServicesBlockTabLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetServicesBlockTabQuery, GetServicesBlockTabQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetServicesBlockTabQuery, GetServicesBlockTabQueryVariables>(GetServicesBlockTabDocument, options);
        }
export type GetServicesBlockTabQueryHookResult = ReturnType<typeof useGetServicesBlockTabQuery>;
export type GetServicesBlockTabLazyQueryHookResult = ReturnType<typeof useGetServicesBlockTabLazyQuery>;
export type GetServicesBlockTabQueryResult = Apollo.QueryResult<GetServicesBlockTabQuery, GetServicesBlockTabQueryVariables>;
export const GetTopContentBlockTabDocument = gql`
    query getTopContentBlockTab($contractId: ID!, $status: ENUM_TOPCONTENTDTO_STATUS) {
 ...
 * });
 */
export function useGetTopContentBlockTabQuery(baseOptions: Apollo.QueryHookOptions<GetTopContentBlockTabQuery, GetTopContentBlockTabQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetTopContentBlockTabQuery, GetTopContentBlockTabQueryVariables>(GetTopContentBlockTabDocument, options);
      }
export function useGetTopContentBlockTabLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetTopContentBlockTabQuery, GetTopContentBlockTabQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetTopContentBlockTabQuery, GetTopContentBlockTabQueryVariables>(GetTopContentBlockTabDocument, options);
        }
export type GetTopContentBlockTabQueryHookResult = ReturnType<typeof useGetTopContentBlockTabQuery>;
export type GetTopContentBlockTabLazyQueryHookResult = ReturnType<typeof useGetTopContentBlockTabLazyQuery>;
export type GetTopContentBlockTabQueryResult = Apollo.QueryResult<GetTopContentBlockTabQuery, GetTopContentBlockTabQueryVariables>;
export const UpdateEditoBlockTabDocument = gql`
    mutation updateEditoBlockTab($updateEditoBlockId: ID!, $data: EditoBlockInput!) {
  updateEditoBlock(id: $updateEditoBlockId, data: $data) {
    ...
    `;
export type UpdateEditoBlockTabMutationFn = Apollo.MutationFunction<UpdateEditoBlockTabMutation, UpdateEditoBlockTabMutationVariables>;
 ...
 * });
 */
export function useUpdateEditoBlockTabMutation(baseOptions?: Apollo.MutationHookOptions<UpdateEditoBlockTabMutation, UpdateEditoBlockTabMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateEditoBlockTabMutation, UpdateEditoBlockTabMutationVariables>(UpdateEditoBlockTabDocument, options);
      }
export type UpdateEditoBlockTabMutationHookResult = ReturnType<typeof useUpdateEditoBlockTabMutation>;
export type UpdateEditoBlockTabMutationResult = Apollo.MutationResult<UpdateEditoBlockTabMutation>;
export type UpdateEditoBlockTabMutationOptions = Apollo.BaseMutationOptions<UpdateEditoBlockTabMutation, UpdateEditoBlockTabMutationVariables>;
export const UpdateQuizAndTipsBlockTabDocument = gql`
    mutation updateQuizAndTipsBlockTab($quizAndTipsBlockId: ID!, $data: QuizAndTipsBlockInput!) {
  updateQuizAndTipsBlock(id: $quizAndTipsBlockId, data: $data) {
    ...
    `;
export type UpdateQuizAndTipsBlockTabMutationFn = Apollo.MutationFunction<UpdateQuizAndTipsBlockTabMutation, UpdateQuizAndTipsBlockTabMutationVariables>;
 ...
 * });
 */
export function useUpdateQuizAndTipsBlockTabMutation(baseOptions?: Apollo.MutationHookOptions<UpdateQuizAndTipsBlockTabMutation, UpdateQuizAndTipsBlockTabMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateQuizAndTipsBlockTabMutation, UpdateQuizAndTipsBlockTabMutationVariables>(UpdateQuizAndTipsBlockTabDocument, options);
      }
export type UpdateQuizAndTipsBlockTabMutationHookResult = ReturnType<typeof useUpdateQuizAndTipsBlockTabMutation>;
export type UpdateQuizAndTipsBlockTabMutationResult = Apollo.MutationResult<UpdateQuizAndTipsBlockTabMutation>;
export type UpdateQuizAndTipsBlockTabMutationOptions = Apollo.BaseMutationOptions<UpdateQuizAndTipsBlockTabMutation, UpdateQuizAndTipsBlockTabMutationVariables>;
export const UpdateRecyclingGuideTabDocument = gql`
    mutation updateRecyclingGuideTab($updateRecyclingGuideBlockId: ID!, $data: RecyclingGuideBlockInput!) {
  updateRecyclingGuideBlock(id: $updateRecyclingGuideBlockId, data: $data) {
    ...
    `;
export type UpdateRecyclingGuideTabMutationFn = Apollo.MutationFunction<UpdateRecyclingGuideTabMutation, UpdateRecyclingGuideTabMutationVariables>;
 ...
 * });
 */
export function useUpdateRecyclingGuideTabMutation(baseOptions?: Apollo.MutationHookOptions<UpdateRecyclingGuideTabMutation, UpdateRecyclingGuideTabMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateRecyclingGuideTabMutation, UpdateRecyclingGuideTabMutationVariables>(UpdateRecyclingGuideTabDocument, options);
      }
export type UpdateRecyclingGuideTabMutationHookResult = ReturnType<typeof useUpdateRecyclingGuideTabMutation>;
export type UpdateRecyclingGuideTabMutationResult = Apollo.MutationResult<UpdateRecyclingGuideTabMutation>;
export type UpdateRecyclingGuideTabMutationOptions = Apollo.BaseMutationOptions<UpdateRecyclingGuideTabMutation, UpdateRecyclingGuideTabMutationVariables>;
export const UpdateSearchEngineBlockTabDocument = gql`
    mutation updateSearchEngineBlockTab($updateSearchEngineBlockId: ID!, $data: SearchEngineBlockInput!) {
  updateSearchEngineBlock(id: $updateSearchEngineBlockId, data: $data) {
    ...
    `;
export type UpdateSearchEngineBlockTabMutationFn = Apollo.MutationFunction<UpdateSearchEngineBlockTabMutation, UpdateSearchEngineBlockTabMutationVariables>;
 ...
 * });
 */
export function useUpdateSearchEngineBlockTabMutation(baseOptions?: Apollo.MutationHookOptions<UpdateSearchEngineBlockTabMutation, UpdateSearchEngineBlockTabMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateSearchEngineBlockTabMutation, UpdateSearchEngineBlockTabMutationVariables>(UpdateSearchEngineBlockTabDocument, options);
      }
export type UpdateSearchEngineBlockTabMutationHookResult = ReturnType<typeof useUpdateSearchEngineBlockTabMutation>;
export type UpdateSearchEngineBlockTabMutationResult = Apollo.MutationResult<UpdateSearchEngineBlockTabMutation>;
export type UpdateSearchEngineBlockTabMutationOptions = Apollo.BaseMutationOptions<UpdateSearchEngineBlockTabMutation, UpdateSearchEngineBlockTabMutationVariables>;
export const UpdateServicesBlockTabDocument = gql`
    mutation updateServicesBlockTab($updateServicesBlockId: ID!, $data: ServicesBlockInput!) {
  updateServicesBlock(id: $updateServicesBlockId, data: $data) {
    ...
    `;
export type UpdateServicesBlockTabMutationFn = Apollo.MutationFunction<UpdateServicesBlockTabMutation, UpdateServicesBlockTabMutationVariables>;
 ...
 * });
 */
export function useUpdateServicesBlockTabMutation(baseOptions?: Apollo.MutationHookOptions<UpdateServicesBlockTabMutation, UpdateServicesBlockTabMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateServicesBlockTabMutation, UpdateServicesBlockTabMutationVariables>(UpdateServicesBlockTabDocument, options);
      }
export type UpdateServicesBlockTabMutationHookResult = ReturnType<typeof useUpdateServicesBlockTabMutation>;
export type UpdateServicesBlockTabMutationResult = Apollo.MutationResult<UpdateServicesBlockTabMutation>;
export type UpdateServicesBlockTabMutationOptions = Apollo.BaseMutationOptions<UpdateServicesBlockTabMutation, UpdateServicesBlockTabMutationVariables>;
export const UpdateTopContentBlockTabDocument = gql`
    mutation updateTopContentBlockTab($updateTopContentBlockId: ID!, $data: TopContentBlockInput!) {
  updateTopContentBlock(id: $updateTopContentBlockId, data: $data) {
    ...
    `;
export type UpdateTopContentBlockTabMutationFn = Apollo.MutationFunction<UpdateTopContentBlockTabMutation, UpdateTopContentBlockTabMutationVariables>;
 ...
 * });
 */
export function useUpdateTopContentBlockTabMutation(baseOptions?: Apollo.MutationHookOptions<UpdateTopContentBlockTabMutation, UpdateTopContentBlockTabMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateTopContentBlockTabMutation, UpdateTopContentBlockTabMutationVariables>(UpdateTopContentBlockTabDocument, options);
      }
export type UpdateTopContentBlockTabMutationHookResult = ReturnType<typeof useUpdateTopContentBlockTabMutation>;
export type UpdateTopContentBlockTabMutationResult = Apollo.MutationResult<UpdateTopContentBlockTabMutation>;
export type UpdateTopContentBlockTabMutationOptions = Apollo.BaseMutationOptions<UpdateTopContentBlockTabMutation, UpdateTopContentBlockTabMutationVariables>;
export const UpdateContractCustomizationDocument = gql`
    mutation UpdateContractCustomization($updateContractCustomizationId: ID!, $data: ContractCustomizationInput!) {
  updateContractCustomization(id: $updateContractCustomizationId, data: $data) {
    data {
      attributes {
        primaryColor
        secondaryColor
    ...
    `;
export type UpdateContractCustomizationMutationFn = Apollo.MutationFunction<UpdateContractCustomizationMutation, UpdateContractCustomizationMutationVariables>;
 ...
 * });
 */
export function useUpdateContractCustomizationMutation(baseOptions?: Apollo.MutationHookOptions<UpdateContractCustomizationMutation, UpdateContractCustomizationMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateContractCustomizationMutation, UpdateContractCustomizationMutationVariables>(UpdateContractCustomizationDocument, options);
      }
export type UpdateContractCustomizationMutationHookResult = ReturnType<typeof useUpdateContractCustomizationMutation>;
export type UpdateContractCustomizationMutationResult = Apollo.MutationResult<UpdateContractCustomizationMutation>;
export type UpdateContractCustomizationMutationOptions = Apollo.BaseMutationOptions<UpdateContractCustomizationMutation, UpdateContractCustomizationMutationVariables>;
 ...
 * });
 */
export function useGetContractCustomizationByIdQuery(baseOptions: Apollo.QueryHookOptions<GetContractCustomizationByIdQuery, GetContractCustomizationByIdQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetContractCustomizationByIdQuery, GetContractCustomizationByIdQueryVariables>(GetContractCustomizationByIdDocument, options);
      }
export function useGetContractCustomizationByIdLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetContractCustomizationByIdQuery, GetContractCustomizationByIdQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetContractCustomizationByIdQuery, GetContractCustomizationByIdQueryVariables>(GetContractCustomizationByIdDocument, options);
        }
export type GetContractCustomizationByIdQueryHookResult = ReturnType<typeof useGetContractCustomizationByIdQuery>;
export type GetContractCustomizationByIdLazyQueryHookResult = ReturnType<typeof useGetContractCustomizationByIdLazyQuery>;
export type GetContractCustomizationByIdQueryResult = Apollo.QueryResult<GetContractCustomizationByIdQuery, GetContractCustomizationByIdQueryVariables>;
export const UpdateContractCustomizationByIdDocument = gql`
    mutation updateContractCustomizationById($updateContractId: ID!, $data: ContractInput!) {
  updateContract(id: $updateContractId, data: $data) {
    ...
    `;
export type UpdateContractCustomizationByIdMutationFn = Apollo.MutationFunction<UpdateContractCustomizationByIdMutation, UpdateContractCustomizationByIdMutationVariables>;
 ...
 * });
 */
export function useUpdateContractCustomizationByIdMutation(baseOptions?: Apollo.MutationHookOptions<UpdateContractCustomizationByIdMutation, UpdateContractCustomizationByIdMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateContractCustomizationByIdMutation, UpdateContractCustomizationByIdMutationVariables>(UpdateContractCustomizationByIdDocument, options);
      }
export type UpdateContractCustomizationByIdMutationHookResult = ReturnType<typeof useUpdateContractCustomizationByIdMutation>;
export type UpdateContractCustomizationByIdMutationResult = Apollo.MutationResult<UpdateContractCustomizationByIdMutation>;
export type UpdateContractCustomizationByIdMutationOptions = Apollo.BaseMutationOptions<UpdateContractCustomizationByIdMutation, UpdateContractCustomizationByIdMutationVariables>;
 ...
 * });
 */
export function useGetFooterPageQuery(baseOptions: Apollo.QueryHookOptions<GetFooterPageQuery, GetFooterPageQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetFooterPageQuery, GetFooterPageQueryVariables>(GetFooterPageDocument, options);
      }
export function useGetFooterPageLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetFooterPageQuery, GetFooterPageQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetFooterPageQuery, GetFooterPageQueryVariables>(GetFooterPageDocument, options);
        }
export type GetFooterPageQueryHookResult = ReturnType<typeof useGetFooterPageQuery>;
export type GetFooterPageLazyQueryHookResult = ReturnType<typeof useGetFooterPageLazyQuery>;
...
export const UpdateFooterPageDocument = gql`
    mutation updateFooterPage($updateFooterId: ID!, $updateFooterData: FooterInput!, $updateContactUsSubServiceId: ID!, $updateContactUsSubServiceData: ContactUsSubServiceInput!, $updateAccessibilitySubServiceId: ID!, $updateAccessibilitySubServiceData: AccessibilitySubServiceInput!, $updateCguSubServiceId: ID!, $updateCguSubServiceData: CguSubServiceInput!, $updateCookiesSubServiceId: ID!, $updateCookiesSubServiceData: CookiesSubServiceInput!, $updateConfidentialitySubServiceId: ID!, $updateConfidentialitySubServiceData: ConfidentialitySubServiceInput!) {
  ...
  updateCguSubService(id: $updateCguSubServiceId, data: $updateCguSubServiceData) {
    data {
      attributes {
        link
      }
  ...
  updateCookiesSubService(
    ...
    `;
export type UpdateFooterPageMutationFn = Apollo.MutationFunction<UpdateFooterPageMutation, UpdateFooterPageMutationVariables>;
 ...
 * });
 */
export function useUpdateFooterPageMutation(baseOptions?: Apollo.MutationHookOptions<UpdateFooterPageMutation, UpdateFooterPageMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateFooterPageMutation, UpdateFooterPageMutationVariables>(UpdateFooterPageDocument, options);
      }
export type UpdateFooterPageMutationHookResult = ReturnType<typeof useUpdateFooterPageMutation>;
export type UpdateFooterPageMutationResult = Apollo.MutationResult<UpdateFooterPageMutation>;
export type UpdateFooterPageMutationOptions = Apollo.BaseMutationOptions<UpdateFooterPageMutation, UpdateFooterPageMutationVariables>;
...
export const UpdateMenuPageDocument = gql`
  ...
  updateContractMenu(id: $updateMenuPageId, data: $data) {
    ...
    `;
export type UpdateMenuPageMutationFn = Apollo.MutationFunction<UpdateMenuPageMutation, UpdateMenuPageMutationVariables>;
 ...
 * });
 */
export function useUpdateMenuPageMutation(baseOptions?: Apollo.MutationHookOptions<UpdateMenuPageMutation, UpdateMenuPageMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateMenuPageMutation, UpdateMenuPageMutationVariables>(UpdateMenuPageDocument, options);
      }
export type UpdateMenuPageMutationHookResult = ReturnType<typeof useUpdateMenuPageMutation>;
export type UpdateMenuPageMutationResult = Apollo.MutationResult<UpdateMenuPageMutation>;
export type UpdateMenuPageMutationOptions = Apollo.BaseMutationOptions<UpdateMenuPageMutation, UpdateMenuPageMutationVariables>;
export const CreateSectorizationDocument = gql`
  ...
  createSectorization(data: $data) {
    ...
    `;
export type CreateSectorizationMutationFn = Apollo.MutationFunction<CreateSectorizationMutation, CreateSectorizationMutationVariables>;
 ...
 * });
 */
export function useCreateSectorizationMutation(baseOptions?: Apollo.MutationHookOptions<CreateSectorizationMutation, CreateSectorizationMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<CreateSectorizationMutation, CreateSectorizationMutationVariables>(CreateSectorizationDocument, options);
      }
export type CreateSectorizationMutationHookResult = ReturnType<typeof useCreateSectorizationMutation>;
export type CreateSectorizationMutationResult = Apollo.MutationResult<CreateSectorizationMutation>;
export type CreateSectorizationMutationOptions = Apollo.BaseMutationOptions<CreateSectorizationMutation, CreateSectorizationMutationVariables>;
export const DeleteSectorizationDocument = gql`
  ...
  deleteSectorization(id: $deleteSectorizationId) {
    ...
    `;
export type DeleteSectorizationMutationFn = Apollo.MutationFunction<DeleteSectorizationMutation, DeleteSectorizationMutationVariables>;
 ...
 * });
 */
export function useDeleteSectorizationMutation(baseOptions?: Apollo.MutationHookOptions<DeleteSectorizationMutation, DeleteSectorizationMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<DeleteSectorizationMutation, DeleteSectorizationMutationVariables>(DeleteSectorizationDocument, options);
      }
export type DeleteSectorizationMutationHookResult = ReturnType<typeof useDeleteSectorizationMutation>;
export type DeleteSectorizationMutationResult = Apollo.MutationResult<DeleteSectorizationMutation>;
export type DeleteSectorizationMutationOptions = Apollo.BaseMutationOptions<DeleteSectorizationMutation, DeleteSectorizationMutationVariables>;
 ...
 * });
 */
export function useGetSectorizationByCityQuery(baseOptions: Apollo.QueryHookOptions<GetSectorizationByCityQuery, GetSectorizationByCityQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetSectorizationByCityQuery, GetSectorizationByCityQueryVariables>(GetSectorizationByCityDocument, options);
      }
export function useGetSectorizationByCityLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetSectorizationByCityQuery, GetSectorizationByCityQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetSectorizationByCityQuery, GetSectorizationByCityQueryVariables>(GetSectorizationByCityDocument, options);
        }
export type GetSectorizationByCityQueryHookResult = ReturnType<typeof useGetSectorizationByCityQuery>;
export type GetSectorizationByCityLazyQueryHookResult = ReturnType<typeof useGetSectorizationByCityLazyQuery>;
export type GetSectorizationByCityQueryResult = Apollo.QueryResult<GetSectorizationByCityQuery, GetSectorizationByCityQueryVariables>;
 ...
 * });
 */
export function useGetSectorizationByContractIdQuery(baseOptions?: Apollo.QueryHookOptions<GetSectorizationByContractIdQuery, GetSectorizationByContractIdQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetSectorizationByContractIdQuery, GetSectorizationByContractIdQueryVariables>(GetSectorizationByContractIdDocument, options);
      }
export function useGetSectorizationByContractIdLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetSectorizationByContractIdQuery, GetSectorizationByContractIdQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetSectorizationByContractIdQuery, GetSectorizationByContractIdQueryVariables>(GetSectorizationByContractIdDocument, options);
        }
export type GetSectorizationByContractIdQueryHookResult = ReturnType<typeof useGetSectorizationByContractIdQuery>;
export type GetSectorizationByContractIdLazyQueryHookResult = ReturnType<typeof useGetSectorizationByContractIdLazyQuery>;
export type GetSectorizationByContractIdQueryResult = Apollo.QueryResult<GetSectorizationByContractIdQuery, GetSectorizationByContractIdQueryVariables>;
export const GetSectorizationsByContractIdDocument = gql`
    query getSectorizationsByContractId($contractId: ID!, $pagination: PaginationArg, $sort: [String]) {
  sectorizations(
 ...
 * });
 */
export function useGetSectorizationsByContractIdQuery(baseOptions: Apollo.QueryHookOptions<GetSectorizationsByContractIdQuery, GetSectorizationsByContractIdQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetSectorizationsByContractIdQuery, GetSectorizationsByContractIdQueryVariables>(GetSectorizationsByContractIdDocument, options);
      }
export function useGetSectorizationsByContractIdLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetSectorizationsByContractIdQuery, GetSectorizationsByContractIdQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetSectorizationsByContractIdQuery, GetSectorizationsByContractIdQueryVariables>(GetSectorizationsByContractIdDocument, options);
        }
export type GetSectorizationsByContractIdQueryHookResult = ReturnType<typeof useGetSectorizationsByContractIdQuery>;
export type GetSectorizationsByContractIdLazyQueryHookResult = ReturnType<typeof useGetSectorizationsByContractIdLazyQuery>;
export type GetSectorizationsByContractIdQueryResult = Apollo.QueryResult<GetSectorizationsByContractIdQuery, GetSectorizationsByContractIdQueryVariables>;
export const UpdateSectorizationDocument = gql`
    mutation UpdateSectorization($updateSectorizationId: ID!, $data: SectorizationInput!) {
  updateSectorization(id: $updateSectorizationId, data: $data) {
    ...
    `;
export type UpdateSectorizationMutationFn = Apollo.MutationFunction<UpdateSectorizationMutation, UpdateSectorizationMutationVariables>;
 ...
 * });
 */
export function useUpdateSectorizationMutation(baseOptions?: Apollo.MutationHookOptions<UpdateSectorizationMutation, UpdateSectorizationMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateSectorizationMutation, UpdateSectorizationMutationVariables>(UpdateSectorizationDocument, options);
      }
export type UpdateSectorizationMutationHookResult = ReturnType<typeof useUpdateSectorizationMutation>;
export type UpdateSectorizationMutationResult = Apollo.MutationResult<UpdateSectorizationMutation>;
export type UpdateSectorizationMutationOptions = Apollo.BaseMutationOptions<UpdateSectorizationMutation, UpdateSectorizationMutationVariables>;
export const CreateDropOffMapDocument = gql`
  ...
  createDropOffMap(data: $data) {
    ...
    `;
export type CreateDropOffMapMutationFn = Apollo.MutationFunction<CreateDropOffMapMutation, CreateDropOffMapMutationVariables>;
 ...
 * });
 */
export function useCreateDropOffMapMutation(baseOptions?: Apollo.MutationHookOptions<CreateDropOffMapMutation, CreateDropOffMapMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<CreateDropOffMapMutation, CreateDropOffMapMutationVariables>(CreateDropOffMapDocument, options);
      }
export type CreateDropOffMapMutationHookResult = ReturnType<typeof useCreateDropOffMapMutation>;
export type CreateDropOffMapMutationResult = Apollo.MutationResult<CreateDropOffMapMutation>;
export type CreateDropOffMapMutationOptions = Apollo.BaseMutationOptions<CreateDropOffMapMutation, CreateDropOffMapMutationVariables>;
export const DeleteDropOffMapDocument = gql`
  ...
  deleteDropOffMap(id: $deleteDropOffMapId) {
    ...
    `;
export type DeleteDropOffMapMutationFn = Apollo.MutationFunction<DeleteDropOffMapMutation, DeleteDropOffMapMutationVariables>;
 ...
 * });
 */
export function useDeleteDropOffMapMutation(baseOptions?: Apollo.MutationHookOptions<DeleteDropOffMapMutation, DeleteDropOffMapMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<DeleteDropOffMapMutation, DeleteDropOffMapMutationVariables>(DeleteDropOffMapDocument, options);
      }
export type DeleteDropOffMapMutationHookResult = ReturnType<typeof useDeleteDropOffMapMutation>;
export type DeleteDropOffMapMutationResult = Apollo.MutationResult<DeleteDropOffMapMutation>;
export type DeleteDropOffMapMutationOptions = Apollo.BaseMutationOptions<DeleteDropOffMapMutation, DeleteDropOffMapMutationVariables>;
export const GetDropOffMapByContractIdDocument = gql`
    query getDropOffMapByContractId($contractId: ID!, $pagination: PaginationArg, $sort: [String]) {
  dropOffMaps(
 ...
 * });
 */
export function useGetDropOffMapByContractIdQuery(baseOptions: Apollo.QueryHookOptions<GetDropOffMapByContractIdQuery, GetDropOffMapByContractIdQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetDropOffMapByContractIdQuery, GetDropOffMapByContractIdQueryVariables>(GetDropOffMapByContractIdDocument, options);
      }
export function useGetDropOffMapByContractIdLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetDropOffMapByContractIdQuery, GetDropOffMapByContractIdQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetDropOffMapByContractIdQuery, GetDropOffMapByContractIdQueryVariables>(GetDropOffMapByContractIdDocument, options);
        }
export type GetDropOffMapByContractIdQueryHookResult = ReturnType<typeof useGetDropOffMapByContractIdQuery>;
 ...
 * });
 */
export function useGetDropOffMapByIdQuery(baseOptions?: Apollo.QueryHookOptions<GetDropOffMapByIdQuery, GetDropOffMapByIdQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetDropOffMapByIdQuery, GetDropOffMapByIdQueryVariables>(GetDropOffMapByIdDocument, options);
      }
export function useGetDropOffMapByIdLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetDropOffMapByIdQuery, GetDropOffMapByIdQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetDropOffMapByIdQuery, GetDropOffMapByIdQueryVariables>(GetDropOffMapByIdDocument, options);
        }
export type GetDropOffMapByIdQueryHookResult = ReturnType<typeof useGetDropOffMapByIdQuery>;
 ...
 * });
 */
export function useUpdateDropOffMapMutation(baseOptions?: Apollo.MutationHookOptions<UpdateDropOffMapMutation, UpdateDropOffMapMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateDropOffMapMutation, UpdateDropOffMapMutationVariables>(UpdateDropOffMapDocument, options);
      }
export type UpdateDropOffMapMutationHookResult = ReturnType<typeof useUpdateDropOffMapMutation>;
export type UpdateDropOffMapMutationResult = Apollo.MutationResult<UpdateDropOffMapMutation>;
export type UpdateDropOffMapMutationOptions = Apollo.BaseMutationOptions<UpdateDropOffMapMutation, UpdateDropOffMapMutationVariables>;
 ...
 * });
 */
export function useGetWasteFamiliesQuery(baseOptions?: Apollo.QueryHookOptions<GetWasteFamiliesQuery, GetWasteFamiliesQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetWasteFamiliesQuery, GetWasteFamiliesQueryVariables>(GetWasteFamiliesDocument, options);
      }
export function useGetWasteFamiliesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetWasteFamiliesQuery, GetWasteFamiliesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetWasteFamiliesQuery, GetWasteFamiliesQueryVariables>(GetWasteFamiliesDocument, options);
        }
export type GetWasteFamiliesQueryHookResult = ReturnType<typeof useGetWasteFamiliesQuery>;
export type GetWasteFamiliesLazyQueryHookResult = ReturnType<typeof useGetWasteFamiliesLazyQuery>;
export type GetWasteFamiliesQueryResult = Apollo.QueryResult<GetWasteFamiliesQuery, GetWasteFamiliesQueryVariables>;
 ...
 * });
 */
export function useGetWasteFamiliesByContractIdQuery(baseOptions?: Apollo.QueryHookOptions<GetWasteFamiliesByContractIdQuery, GetWasteFamiliesByContractIdQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetWasteFamiliesByContractIdQuery, GetWasteFamiliesByContractIdQueryVariables>(GetWasteFamiliesByContractIdDocument, options);
      }
export function useGetWasteFamiliesByContractIdLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetWasteFamiliesByContractIdQuery, GetWasteFamiliesByContractIdQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetWasteFamiliesByContractIdQuery, GetWasteFamiliesByContractIdQueryVariables>(GetWasteFamiliesByContractIdDocument, options);
        }
export type GetWasteFamiliesByContractIdQueryHookResult = ReturnType<typeof useGetWasteFamiliesByContractIdQuery>;
export type GetWasteFamiliesByContractIdLazyQueryHookResult = ReturnType<typeof useGetWasteFamiliesByContractIdLazyQuery>;
export type GetWasteFamiliesByContractIdQueryResult = Apollo.QueryResult<GetWasteFamiliesByContractIdQuery, GetWasteFamiliesByContractIdQueryVariables>;
export const UpdateWasteFamilyDocument = gql`
    mutation UpdateWasteFamily($updateWasteFamilyId: ID!, $data: WasteFamilyInput!) {
  updateWasteFamily(id: $updateWasteFamilyId, data: $data) {
    ...
    `;
export type UpdateWasteFamilyMutationFn = Apollo.MutationFunction<UpdateWasteFamilyMutation, UpdateWasteFamilyMutationVariables>;
 ...
 * });
 */
export function useUpdateWasteFamilyMutation(baseOptions?: Apollo.MutationHookOptions<UpdateWasteFamilyMutation, UpdateWasteFamilyMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateWasteFamilyMutation, UpdateWasteFamilyMutationVariables>(UpdateWasteFamilyDocument, options);
      }
export type UpdateWasteFamilyMutationHookResult = ReturnType<typeof useUpdateWasteFamilyMutation>;
export type UpdateWasteFamilyMutationResult = Apollo.MutationResult<UpdateWasteFamilyMutation>;
export type UpdateWasteFamilyMutationOptions = Apollo.BaseMutationOptions<UpdateWasteFamilyMutation, UpdateWasteFamilyMutationVariables>;
export const GetFlowsFilterByContractIdDocument = gql`
    query getFlowsFilterByContractId($contractId: ID!) {
  flows(
    filters: {isActivated: {eq: true}, contract: {id: {eq: $contractId}}}
    sort: "name:asc"
  ) {
    data {
      id
 ...
 * });
 */
export function useGetFlowsFilterByContractIdQuery(baseOptions: Apollo.QueryHookOptions<GetFlowsFilterByContractIdQuery, GetFlowsFilterByContractIdQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetFlowsFilterByContractIdQuery, GetFlowsFilterByContractIdQueryVariables>(GetFlowsFilterByContractIdDocument, options);
      }
export function useGetFlowsFilterByContractIdLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetFlowsFilterByContractIdQuery, GetFlowsFilterByContractIdQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetFlowsFilterByContractIdQuery, GetFlowsFilterByContractIdQueryVariables>(GetFlowsFilterByContractIdDocument, options);
        }
export type GetFlowsFilterByContractIdQueryHookResult = ReturnType<typeof useGetFlowsFilterByContractIdQuery>;
export type GetFlowsFilterByContractIdLazyQueryHookResult = ReturnType<typeof useGetFlowsFilterByContractIdLazyQuery>;
export type GetFlowsFilterByContractIdQueryResult = Apollo.QueryResult<GetFlowsFilterByContractIdQuery, GetFlowsFilterByContractIdQueryVariables>;
 ...
 * });
 */
export function useGetWasteFormByIdQuery(baseOptions?: Apollo.QueryHookOptions<GetWasteFormByIdQuery, GetWasteFormByIdQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetWasteFormByIdQuery, GetWasteFormByIdQueryVariables>(GetWasteFormByIdDocument, options);
      }
export function useGetWasteFormByIdLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetWasteFormByIdQuery, GetWasteFormByIdQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetWasteFormByIdQuery, GetWasteFormByIdQueryVariables>(GetWasteFormByIdDocument, options);
        }
export type GetWasteFormByIdQueryHookResult = ReturnType<typeof useGetWasteFormByIdQuery>;
export type GetWasteFormByIdLazyQueryHookResult = ReturnType<typeof useGetWasteFormByIdLazyQuery>;
export type GetWasteFormByIdQueryResult = Apollo.QueryResult<GetWasteFormByIdQuery, GetWasteFormByIdQueryVariables>;
export const GetWasteFormsByContractIdDocument = gql`
    query getWasteFormsByContractId($contractId: ID, $statusFilter: String, $flowId: ID, $sort: [String], $pagination: PaginationArg) {
  wasteFormsCount: wasteForms(
    filters: {recyclingGuideService: {contract: {id: {eq: $contractId}}}}
  ) {
    meta {
      pagination {
        total
  ...
  wasteFormsDraftCount: wasteForms(
    filters: {recyclingGuideService: {contract: {id: {eq: $contractId}}}, status: {eq: "draft"}}
  ) {
    meta {
      pagination {
        total
  ...
  wasteFormsPublishedCount: wasteForms(
    filters: {recyclingGuideService: {contract: {id: {eq: $contractId}}}, status: {eq: "published"}}
  ) {
    meta {
      pagination {
        total
  ...
  wasteFormsArchivedCount: wasteForms(
    filters: {recyclingGuideService: {contract: {id: {eq: $contractId}}}, status: {eq: "archived"}}
  ) {
    meta {
      pagination {
        total
  ...
  wasteForms(
    filters: {recyclingGuideService: {contract: {id: {eq: $contractId}}}, status: {eq: $statusFilter}, flow: {id: {eq: $flowId}}}
    sort: $sort
    pagination: $pagination
  ) {
    meta {
 ...
 * });
 */
export function useGetWasteFormsByContractIdQuery(baseOptions?: Apollo.QueryHookOptions<GetWasteFormsByContractIdQuery, GetWasteFormsByContractIdQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetWasteFormsByContractIdQuery, GetWasteFormsByContractIdQueryVariables>(GetWasteFormsByContractIdDocument, options);
      }
export function useGetWasteFormsByContractIdLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetWasteFormsByContractIdQuery, GetWasteFormsByContractIdQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetWasteFormsByContractIdQuery, GetWasteFormsByContractIdQueryVariables>(GetWasteFormsByContractIdDocument, options);
        }
export type GetWasteFormsByContractIdQueryHookResult = ReturnType<typeof useGetWasteFormsByContractIdQuery>;
export type GetWasteFormsByContractIdLazyQueryHookResult = ReturnType<typeof useGetWasteFormsByContractIdLazyQuery>;
export type GetWasteFormsByContractIdQueryResult = Apollo.QueryResult<GetWasteFormsByContractIdQuery, GetWasteFormsByContractIdQueryVariables>;
export const UpdateWasteFormDocument = gql`
  ...
  updateWasteForm(id: $updateWasteFormId, data: $data) {
    ...
    `;
export type UpdateWasteFormMutationFn = Apollo.MutationFunction<UpdateWasteFormMutation, UpdateWasteFormMutationVariables>;
 ...
 * });
 */
export function useUpdateWasteFormMutation(baseOptions?: Apollo.MutationHookOptions<UpdateWasteFormMutation, UpdateWasteFormMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateWasteFormMutation, UpdateWasteFormMutationVariables>(UpdateWasteFormDocument, options);
      }
export type UpdateWasteFormMutationHookResult = ReturnType<typeof useUpdateWasteFormMutation>;
export type UpdateWasteFormMutationResult = Apollo.MutationResult<UpdateWasteFormMutation>;
export type UpdateWasteFormMutationOptions = Apollo.BaseMutationOptions<UpdateWasteFormMutation, UpdateWasteFormMutationVariables>;
 ...
 * });
 */
export function useGetRecyclingGuideServiceByContractIdQuery(baseOptions: Apollo.QueryHookOptions<GetRecyclingGuideServiceByContractIdQuery, GetRecyclingGuideServiceByContractIdQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetRecyclingGuideServiceByContractIdQuery, GetRecyclingGuideServiceByContractIdQueryVariables>(GetRecyclingGuideServiceByContractIdDocument, options);
      }
export function useGetRecyclingGuideServiceByContractIdLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetRecyclingGuideServiceByContractIdQuery, GetRecyclingGuideServiceByContractIdQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetRecyclingGuideServiceByContractIdQuery, GetRecyclingGuideServiceByContractIdQueryVariables>(GetRecyclingGuideServiceByContractIdDocument, options);
        }
export type GetRecyclingGuideServiceByContractIdQueryHookResult = ReturnType<typeof useGetRecyclingGuideServiceByContractIdQuery>;
export type GetRecyclingGuideServiceByContractIdLazyQueryHookResult = ReturnType<typeof useGetRecyclingGuideServiceByContractIdLazyQuery>;
export type GetRecyclingGuideServiceByContractIdQueryResult = Apollo.QueryResult<GetRecyclingGuideServiceByContractIdQuery, GetRecyclingGuideServiceByContractIdQueryVariables>;
 ...
 * });
 */
export function useGetRecyclingGuideServiceByIdQuery(baseOptions?: Apollo.QueryHookOptions<GetRecyclingGuideServiceByIdQuery, GetRecyclingGuideServiceByIdQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetRecyclingGuideServiceByIdQuery, GetRecyclingGuideServiceByIdQueryVariables>(GetRecyclingGuideServiceByIdDocument, options);
      }
export function useGetRecyclingGuideServiceByIdLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetRecyclingGuideServiceByIdQuery, GetRecyclingGuideServiceByIdQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetRecyclingGuideServiceByIdQuery, GetRecyclingGuideServiceByIdQueryVariables>(GetRecyclingGuideServiceByIdDocument, options);
        }
export type GetRecyclingGuideServiceByIdQueryHookResult = ReturnType<typeof useGetRecyclingGuideServiceByIdQuery>;
export type GetRecyclingGuideServiceByIdLazyQueryHookResult = ReturnType<typeof useGetRecyclingGuideServiceByIdLazyQuery>;
export type GetRecyclingGuideServiceByIdQueryResult = Apollo.QueryResult<GetRecyclingGuideServiceByIdQuery, GetRecyclingGuideServiceByIdQueryVariables>;
export const UpdateMemoTriDocument = gql`
    mutation updateMemoTri($updateRecyclingGuideServiceId: ID!, $data: RecyclingGuideServiceInput!) {
  updateRecyclingGuideService(id: $updateRecyclingGuideServiceId, data: $data) {
    data {
      id
      attributes {
        name
    ...
    `;
export type UpdateMemoTriMutationFn = Apollo.MutationFunction<UpdateMemoTriMutation, UpdateMemoTriMutationVariables>;
 ...
 * });
 */
export function useUpdateMemoTriMutation(baseOptions?: Apollo.MutationHookOptions<UpdateMemoTriMutation, UpdateMemoTriMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateMemoTriMutation, UpdateMemoTriMutationVariables>(UpdateMemoTriDocument, options);
      }
export type UpdateMemoTriMutationHookResult = ReturnType<typeof useUpdateMemoTriMutation>;
export type UpdateMemoTriMutationResult = Apollo.MutationResult<UpdateMemoTriMutation>;
export type UpdateMemoTriMutationOptions = Apollo.BaseMutationOptions<UpdateMemoTriMutation, UpdateMemoTriMutationVariables>;
export const UpdateRecyclingGuideServiceDocument = gql`
    mutation updateRecyclingGuideService($updateRecyclingGuideServiceId: ID!, $data: RecyclingGuideServiceInput!) {
  updateRecyclingGuideService(id: $updateRecyclingGuideServiceId, data: $data) {
    data {
      id
      attributes {
    ...
    `;
export type UpdateRecyclingGuideServiceMutationFn = Apollo.MutationFunction<UpdateRecyclingGuideServiceMutation, UpdateRecyclingGuideServiceMutationVariables>;
 ...
 * });
 */
export function useUpdateRecyclingGuideServiceMutation(baseOptions?: Apollo.MutationHookOptions<UpdateRecyclingGuideServiceMutation, UpdateRecyclingGuideServiceMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateRecyclingGuideServiceMutation, UpdateRecyclingGuideServiceMutationVariables>(UpdateRecyclingGuideServiceDocument, options);
      }
export type UpdateRecyclingGuideServiceMutationHookResult = ReturnType<typeof useUpdateRecyclingGuideServiceMutation>;
export type UpdateRecyclingGuideServiceMutationResult = Apollo.MutationResult<UpdateRecyclingGuideServiceMutation>;
export type UpdateRecyclingGuideServiceMutationOptions = Apollo.BaseMutationOptions<UpdateRecyclingGuideServiceMutation, UpdateRecyclingGuideServiceMutationVariables>;
export const CreatePickUpDayByIdDocument = gql`
  ...
  createPickUpDay(data: $data) {
    ...
    `;
export type CreatePickUpDayByIdMutationFn = Apollo.MutationFunction<CreatePickUpDayByIdMutation, CreatePickUpDayByIdMutationVariables>;
 ...
 * });
 */
export function useCreatePickUpDayByIdMutation(baseOptions?: Apollo.MutationHookOptions<CreatePickUpDayByIdMutation, CreatePickUpDayByIdMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<CreatePickUpDayByIdMutation, CreatePickUpDayByIdMutationVariables>(CreatePickUpDayByIdDocument, options);
      }
export type CreatePickUpDayByIdMutationHookResult = ReturnType<typeof useCreatePickUpDayByIdMutation>;
export type CreatePickUpDayByIdMutationResult = Apollo.MutationResult<CreatePickUpDayByIdMutation>;
export type CreatePickUpDayByIdMutationOptions = Apollo.BaseMutationOptions<CreatePickUpDayByIdMutation, CreatePickUpDayByIdMutationVariables>;
 ...
 * });
 */
export function useGetPickUpDayByIdQuery(baseOptions?: Apollo.QueryHookOptions<GetPickUpDayByIdQuery, GetPickUpDayByIdQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetPickUpDayByIdQuery, GetPickUpDayByIdQueryVariables>(GetPickUpDayByIdDocument, options);
      }
export function useGetPickUpDayByIdLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetPickUpDayByIdQuery, GetPickUpDayByIdQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetPickUpDayByIdQuery, GetPickUpDayByIdQueryVariables>(GetPickUpDayByIdDocument, options);
        }
export type GetPickUpDayByIdQueryHookResult = ReturnType<typeof useGetPickUpDayByIdQuery>;
export type GetPickUpDayByIdLazyQueryHookResult = ReturnType<typeof useGetPickUpDayByIdLazyQuery>;
export type GetPickUpDayByIdQueryResult = Apollo.QueryResult<GetPickUpDayByIdQuery, GetPickUpDayByIdQueryVariables>;
export const GetPickUpDaysByContractIdDocument = gql`
    query getPickUpDaysByContractId($contractId: ID, $sort: [String], $pagination: PaginationArg) {
  pickUpDays(
 ...
 * });
 */
export function useGetPickUpDaysByContractIdQuery(baseOptions?: Apollo.QueryHookOptions<GetPickUpDaysByContractIdQuery, GetPickUpDaysByContractIdQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetPickUpDaysByContractIdQuery, GetPickUpDaysByContractIdQueryVariables>(GetPickUpDaysByContractIdDocument, options);
      }
export function useGetPickUpDaysByContractIdLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetPickUpDaysByContractIdQuery, GetPickUpDaysByContractIdQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetPickUpDaysByContractIdQuery, GetPickUpDaysByContractIdQueryVariables>(GetPickUpDaysByContractIdDocument, options);
        }
export type GetPickUpDaysByContractIdQueryHookResult = ReturnType<typeof useGetPickUpDaysByContractIdQuery>;
export type GetPickUpDaysByContractIdLazyQueryHookResult = ReturnType<typeof useGetPickUpDaysByContractIdLazyQuery>;
export type GetPickUpDaysByContractIdQueryResult = Apollo.QueryResult<GetPickUpDaysByContractIdQuery, GetPickUpDaysByContractIdQueryVariables>;
export const UpdatePickUpDayDocument = gql`
  ...
  updatePickUpDay(id: $updatePickUpDayId, data: $data) {
    ...
    `;
export type UpdatePickUpDayMutationFn = Apollo.MutationFunction<UpdatePickUpDayMutation, UpdatePickUpDayMutationVariables>;
 ...
 * });
 */
export function useUpdatePickUpDayMutation(baseOptions?: Apollo.MutationHookOptions<UpdatePickUpDayMutation, UpdatePickUpDayMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdatePickUpDayMutation, UpdatePickUpDayMutationVariables>(UpdatePickUpDayDocument, options);
      }
export type UpdatePickUpDayMutationHookResult = ReturnType<typeof useUpdatePickUpDayMutation>;
export type UpdatePickUpDayMutationResult = Apollo.MutationResult<UpdatePickUpDayMutation>;
export type UpdatePickUpDayMutationOptions = Apollo.BaseMutationOptions<UpdatePickUpDayMutation, UpdatePickUpDayMutationVariables>;