...
export type UpdateQuizAndTipsBlockMutationVariables = Exact<{
  quizAndTipsBlockId: Scalars["ID"];
  data: QuizAndTipsBlockInput;
}>;

export type UpdateQuizAndTipsBlockMutation = {
  __typename?: "Mutation";
...
export type UpdateRecyclingGuideBlockMutationVariables = Exact<{
  updateRecyclingGuideBlockId: Scalars["ID"];
  data: RecyclingGuideBlockInput;
}>;

export type UpdateRecyclingGuideBlockMutation = {
  __typename?: "Mutation";
              ...
              editorialServices {
                data {
                  attributes {
                    subServiceInstance {
                      __typename
                      ... on ComponentEditoTipsSubService {
                        isActivated
                        tips {
                          data {
                            id
                      ...
                      ... on ComponentEditoQuizzesSubService {
                        isActivated
                        quizzes {
                          data {
                            id
...
export const GetServicesDocument = gql`
  query GetServices($contractId: ID!) {
    services(filters: { contract: { id: { eq: $contractId } } }) {
      data {
        attributes {
          isActivated
...
export type GetServicesQueryResult = Apollo.QueryResult<
  ...
  GetServicesQueryVariables
>;
export const UpdateQuizAndTipsBlockDocument = gql`
  mutation UpdateQuizAndTipsBlock(
...
`;
export type UpdateQuizAndTipsBlockMutationFn = Apollo.MutationFunction<
  UpdateQuizAndTipsBlockMutation,
  UpdateQuizAndTipsBlockMutationVariables
>;

/**
 * __useUpdateQuizAndTipsBlockMutation__
 *
 * To run a mutation, you first call `useUpdateQuizAndTipsBlockMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useUpdateQuizAndTipsBlockMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [updateQuizAndTipsBlockMutation, { data, loading, error }] = useUpdateQuizAndTipsBlockMutation({
 *   variables: {
 ...
 * });
 */
export function useUpdateQuizAndTipsBlockMutation(
  ...
  return Apollo.useMutation<
    UpdateQuizAndTipsBlockMutation,
    UpdateQuizAndTipsBlockMutationVariables
  >(UpdateQuizAndTipsBlockDocument, options);
}
export type UpdateQuizAndTipsBlockMutationHookResult = ReturnType<
  typeof useUpdateQuizAndTipsBlockMutation
>;
export type UpdateQuizAndTipsBlockMutationResult =
  Apollo.MutationResult<UpdateQuizAndTipsBlockMutation>;
export type UpdateQuizAndTipsBlockMutationOptions = Apollo.BaseMutationOptions<
  UpdateQuizAndTipsBlockMutation,
  UpdateQuizAndTipsBlockMutationVariables
>;
export const UpdateRecyclingGuideBlockDocument = gql`
  mutation UpdateRecyclingGuideBlock(
...
`;
export type UpdateRecyclingGuideBlockMutationFn = Apollo.MutationFunction<
  UpdateRecyclingGuideBlockMutation,
  UpdateRecyclingGuideBlockMutationVariables
>;

/**
 * __useUpdateRecyclingGuideBlockMutation__
 *
 * To run a mutation, you first call `useUpdateRecyclingGuideBlockMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useUpdateRecyclingGuideBlockMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [updateRecyclingGuideBlockMutation, { data, loading, error }] = useUpdateRecyclingGuideBlockMutation({
 *   variables: {
 ...
 * });
 */
export function useUpdateRecyclingGuideBlockMutation(
  baseOptions?: Apollo.MutationHookOptions<
    UpdateRecyclingGuideBlockMutation,
    UpdateRecyclingGuideBlockMutationVariables
  >,
  ...
  return Apollo.useMutation<
    UpdateRecyclingGuideBlockMutation,
    UpdateRecyclingGuideBlockMutationVariables
  >(UpdateRecyclingGuideBlockDocument, options);
}
export type UpdateRecyclingGuideBlockMutationHookResult = ReturnType<
  typeof useUpdateRecyclingGuideBlockMutation
>;
export type UpdateRecyclingGuideBlockMutationResult =
  Apollo.MutationResult<UpdateRecyclingGuideBlockMutation>;
export type UpdateRecyclingGuideBlockMutationOptions =
